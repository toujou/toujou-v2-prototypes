import{T as o}from"./badgeCustomConfig-e7a687d5.js";import{M as p}from"./form.docs-cb9e85c7.js";import"./jsx-runtime-ccada58e.js";import"./index-f1f749bf.js";import"./_commonjsHelpers-042e6b4d.js";import"./index-4fb8b842.js";const g={title:"COMPONENTS/Forms",parameters:{badges:[o.DONE],docs:{page:p}},argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},defaultValue:["default"],required:!0}},tags:["autodocs"]},u=e=>{const t=e.state==="disabled"?"disabled":"";return`
        <style>
            body {
    ...
    `},s=u.bind({});s.args={state:"default"};var r,a,i;s.parameters={...s.parameters,docs:{...(r=s.parameters)==null?void 0:r.docs,source:{originalSource:`(args: ToujouAllInputsStoryProps) => {
  ...
  return \`
    ...
    \`;
}`,...(i=(a=s.parameters)==null?void 0:a.docs)==null?void 0:i.source}}};const f=["AllInputs"];export{s as AllInputs,f as __namedExportsOrder,g as default};
//# sourceMappingURL=60.all.stories-6bff6e9d.js.map
