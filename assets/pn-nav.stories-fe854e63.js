import{T as c}from"./badgeCustomConfig-e7a687d5.js";import{j as e}from"./jsx-runtime-ccada58e.js";import{u}from"./index-4fb8b842.js";import"./index-f1f749bf.js";import"./_commonjsHelpers-042e6b4d.js";function n(o){const t=Object.assign({h1:"h1",p:"p",h2:"h2",pre:"pre",code:"code",a:"a",h3:"h3"},u(),o.components);return e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"pn-navigation",children:"PN Navigation"}),`
...
`,e.jsxs(t.p,{children:["The toujou library has a link with some information about this content element ",e.jsx(t.a,{href:"https://www.toujou.de/service/elementbibliothek/widgets/previous/next-page-navigation/",target:"_blank",rel:"nofollow noopener noreferrer",children:"here"})]}),`
...
`})})]})}function r(o={}){const{wrapper:t}=Object.assign({},u(),o.components);return t?e.jsx(t,Object.assign({},o,{children:e.jsx(n,o)})):n(o)}const h={title:"COMPONENTS/P N Nav",parameters:{badges:[c.DONE],docs:{page:r},layout:"fullscreen"},argTypes:{hideImage:{table:{category:"PN navigation settings",defaultValue:{summary:!1}},name:"Hide image",description:"Hide the link image",control:{type:"boolean"},defaultValue:[!1],required:!0},hideTitle:{table:{category:"PN navigation settings",defaultValue:{summary:!1}},name:"Hide title",description:"Hide the link title",control:{type:"boolean"},defaultValue:[!1],required:!0}},tags:["autodocs"]},d=o=>`
        ...
        <toujou-pn-nav
            ...
            ${o.hideImage===!0?"image-hidden":""}
            ${o.hideTitle===!0?"title-hidden":""}
        >
    ...
    `,i=d.bind({});i.args={hideImage:!1,hideTitle:!1};var a,l,s;i.parameters={...i.parameters,docs:{...(a=i.parameters)==null?void 0:a.docs,source:{originalSource:`(args: PNNavStoryProps) => {
  return \`
        <toujou-breadcrumb role="navigation" aria-label="Breadcrumb" class="breadcrumb">
            <button slot="toggle-buttons" class="breadcrumb__toggle breadcrumb__toggle--open">
                <toujou-icon class="icon breadcrumb__toggle-icon" icon-name="arrow-left"></toujou-icon>
    ...
    \`;
}`,...(s=(l=i.parameters)==null?void 0:l.docs)==null?void 0:s.source}}};const v=["PNNav"];export{i as PNNav,v as __namedExportsOrder,h as default};
//# sourceMappingURL=pn-nav.stories-fe854e63.js.map
