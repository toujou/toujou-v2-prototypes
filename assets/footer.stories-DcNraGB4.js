...
`})}),`
`,o.jsx(s.p,{children:'It is possible to create a custom footer by adding a "Footer" Page to the "Storage Folder" Folder in the BE'})]})}function f(e={}){const{wrapper:s}={...c(),...e.components};return s?o.jsx(s,{...e,children:o.jsx(a,{...e})}):a(e)}const k={title:"COMPONENTS/Footer",parameters:{badges:[r.DONE],docs:{page:f},layout:"fullscreen"}},_=()=>`
        <footer class="footer">
            <footer-content class="footer-content">
                <footer-column class="footer-column" column-name="logo">
