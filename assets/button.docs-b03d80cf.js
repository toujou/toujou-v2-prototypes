import{j as t}from"./jsx-runtime-ac05983f.js";import{u as i}from"./index-a9a8c754.js";function e(o){const n=Object.assign({h1:"h1",p:"p",code:"code",h2:"h2",pre:"pre",h3:"h3"},i(),o.components);return t.jsxs(t.Fragment,{children:[t.jsx(n.h1,{id:"toujou-button",children:"<toujou-button>"}),`
...
`,t.jsxs(n.p,{children:[`| Attribute | Example |
|--|:---:|
| `,t.jsx(n.code,{children:"disabled"}),"  | ",t.jsx(n.code,{children:'<button is="toujou-button" class="button" button-variant="primary" button-type="default" button-size="normal" disabled>Hello world</button>'})," |"]})]})}function r(o={}){const{wrapper:n}=Object.assign({},i(),o.components);return n?t.jsx(n,Object.assign({},o,{children:t.jsx(e,o)})):e(o)}export{r as M};
//# sourceMappingURL=button.docs-b03d80cf.js.map
