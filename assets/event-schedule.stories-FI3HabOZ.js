...
`})})]})}function p(s={}){const{wrapper:a}={...h(),...s.components};return a?e.jsx(a,{...s,children:e.jsx(t,{...s})}):t(s)}const y={title:"COMPONENTS/EventSchedule",parameters:{badges:[r.DONE],docs:{page:p}},tags:["autodocs"]},c=()=>`
    ...
    `,l=_.bind({});var n,i,d;l.parameters={...l.parameters,docs:{...(n=l.parameters)==null?void 0:n.docs,source:{originalSource:`() => {
  return \`
        <main>
    ...
    \`;
}`,...(d=(i=l.parameters)==null?void 0:i.docs)==null?void 0:d.source}}};const f=["EventSchedule"];export{l as EventSchedule,f as __namedExportsOrder,y as default};
