const c={title:"COMPONENTS/Tourism/Trip Description",argTypes:{showDayDate:{table:{category:"Trip Description Settings",defaultValue:{summary:"false"}},name:"Show day date",description:"Show the date for each day",control:{type:"boolean"},required:!0}}},s=e=>`
                            ...
                            <toujou-text-block class="text-block" text-block-media-position="beside-left" column-layout="third">
                                <toujou-text-block-column class="text-block-column">
                                    ...
                                    <div class="text-block__content">
                                        ...
                                        ${n([{iconName:"coffee",text:"Breakfast"}])}
                            ...
                            <toujou-text-block class="text-block" text-block-media-position="beside-left" column-layout="third">
                                <toujou-text-block-column class="text-block-column">
                                    ...
                                    <div class="text-block__content">
                                        ...
                                        ${n([{iconName:"infinity",text:"All inclusive"},{iconName:"coffee",text:"Breakfast"},{iconName:"food",text:"Lunch"},{iconName:"drink",text:"Dinner"},{iconName:"cookie",text:"Snack"}])}
                                        
                                        ${l([{title:"File title",description:"This is a nice file description"},{title:"Our Guide"},{title:"Trip Infos",description:"Detailed information about your trip"}])}
                                    </div>
                                </toujou-text-block-column>
                            </toujou-text-block>
                        </div>
    ...
    `,i=u.bind({});i.args={showDayDate:!1};var a,r,o;i.parameters={...i.parameters,docs:{...(a=i.parameters)==null?void 0:a.docs,source:{originalSource:`(args: TripDescriptionProps) => {
  return \`
        <main>
            <toujou-trip-description class="trip-description">
                <toujou-details-accordion class="details-accordion" is-trip-description>
    ...
    \`;
}`,...(o=(r=i.parameters)==null?void 0:r.docs)==null?void 0:o.source}}};const d=["TripDescription"];export{i as TripDescription,d as __namedExportsOrder,c as default};
