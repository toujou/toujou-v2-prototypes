import{T as l}from"./badgeCustomConfig-e7a687d5.js";import{j as e}from"./jsx-runtime-ac05983f.js";import{u as r}from"./index-a9a8c754.js";import"./index-e0ddb630.js";import"./_commonjsHelpers-87174ba5.js";function s(n){const t=Object.assign({h1:"h1",p:"p",code:"code",ul:"ul",li:"li",h2:"h2",pre:"pre",h4:"h4"},r(),n.components);return e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"toujou-third-party-content",children:"<toujou-third-party-content>"}),`
...
An example if the `,e.jsx(t.code,{children:"iframe position"})," property for video, maps and for html elements."]})]})}function u(n={}){const{wrapper:t}=Object.assign({},r(),n.components);return t?e.jsx(t,Object.assign({},n,{children:e.jsx(s,n)})):s(n)}const y={title:"COMPONENTS/Third Party Content",parameters:{badges:[l.DONE],docs:{page:u}}};window.addEventListener("click",n=>{n.target.getAttribute("id")==="clearConsentsButton"&&(localStorage.removeItem("consentsState"),document.location.reload())});const p=()=>`
    ...
    `,o=p.bind({});var c,i,a;o.parameters={...o.parameters,docs:{...(c=o.parameters)==null?void 0:c.docs,source:{originalSource:`() => {
  return \`
    ...
    \`;
}`,...(a=(i=o.parameters)==null?void 0:i.docs)==null?void 0:a.source}}};const _=["ThirdPartyContent"];export{o as ThirdPartyContent,_ as __namedExportsOrder,y as default};
//# sourceMappingURL=third-party-content.stories-80d18672.js.map
