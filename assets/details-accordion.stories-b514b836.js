import{T as r}from"./badgeCustomConfig-e7a687d5.js";import{M as o}from"./details-accordion.docs-d69f3191.js";import"./jsx-runtime-ccada58e.js";import"./index-f1f749bf.js";import"./_commonjsHelpers-042e6b4d.js";import"./index-4fb8b842.js";const g={title:"COMPONENTS/Accordion",parameters:{badges:[r.DONE],docs:{page:o}},argTypes:{singleExpandMode:{table:{category:"Details accordion Settings",defaultValue:{summary:"false"}},name:"Single expand mode",description:"Allow just one accordion items to be open at a time",control:{type:"boolean"},defaultValue:["false"],required:!0},expandedItem:{table:{category:"Details accordion Settings",defaultValue:{summary:"first"}},name:"Expanded items",description:"Define which accordion items are open when the page loads",options:["none","first","all"],control:{type:"radio"},defaultValue:["first"],required:!0},elementDesign:{table:{category:"Details Settings",defaultValue:{summary:"default"}},name:"Accordion element design",description:"Set the element design for the accordion element",options:["default","primary","secondary","inverted"],control:{type:"radio"},defaultValue:["default"],required:!0}},tags:["autodocs"]},l=e=>`
    ...
    `,t=l.bind({});t.args={singleExpandMode:!1,expandedItem:"first",elementDesign:"default"};var n,i,s;t.parameters={...t.parameters,docs:{...(n=t.parameters)==null?void 0:n.docs,source:{originalSource:`(args: DetailsAccordionStoryProps) => {
  return \`
    ...
    \`;
}`,...(s=(i=t.parameters)==null?void 0:i.docs)==null?void 0:s.source}}};const p=["DetailsAccordion"];export{t as DetailsAccordion,p as __namedExportsOrder,g as default};
//# sourceMappingURL=details-accordion.stories-b514b836.js.map
