const c={title:"COMPONENTS/Forms",argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},required:!0}}},i=t=>{const r=t.state==="disabled"?"disabled":"";return`
        <style>
            body {
    ...
    `},e=i.bind({});e.args={state:"default"};var s,o,a;e.parameters={...e.parameters,docs:{...(s=e.parameters)==null?void 0:s.docs,source:{originalSource:`(args: ToujouSelectStoryProps) => {
  ...
  return \`
    ...
    \`;
}`,...(a=(o=e.parameters)==null?void 0:o.docs)==null?void 0:a.source}}};const l=["SelectInput"];export{e as SelectInput,l as __namedExportsOrder,c as default};
