import{r as t}from"./destinationOneIntroSection-dMoNR17U.js";import{r as i}from"./breadcrumb-example-DMkkXFpu.js";const _={title:"PAGES/DestinationOne",parameters:{layout:"fullwidth"},argTypes:{mapAspectRatio:{table:{category:"D1I Package Page Settings",defaultValue:{summary:"default"}},name:"Map Aspect Ratio",description:"Set the map's aspect ratio",options:["default","3-1"],control:{type:"radio"},required:!0}}},r=()=>`
    ...
    `,m=a=>`
        <main id="main" skippy-links-label="Main content">
            ${i()}
            <div class="fragment" fragment-type="d1i-package" map-aspect-ratio="${a.mapAspectRatio}">
                ${t("PACKAGE")}
                ${r()}
                ${c()}
            </div>
    ...
    `,u=a=>`
       ${m(a)}
    `,e=u.bind({});e.args={mapAspectRatio:"3-1"};var s,n,o;e.parameters={...e.parameters,docs:{...(s=e.parameters)==null?void 0:s.docs,source:{originalSource:`(args: DestinationOnePackageProps) => {
  return \`
       \${renderMain(args)}
    \`;
}`,...(o=(n=e.parameters)==null?void 0:n.docs)==null?void 0:o.source}}};const g=["DestinationOnePackage"];export{e as DestinationOnePackage,g as __namedExportsOrder,_ as default};
