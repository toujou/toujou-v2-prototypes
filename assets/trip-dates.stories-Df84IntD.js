import{T as c}from"./badgeCustomConfig-DUXiHpL4.js";import{j as t}from"./jsx-runtime-CS_Wz6c_.js";import{useMDXComponents as i}from"./index-C8FVCAkB.js";import"./index-Dy2Ak0OH.js";import"./_commonjsHelpers-Cpj98o6Y.js";function u(e){const a={h1:"h1",p:"p",...i(),...e.components};return t.jsxs(t.Fragment,{children:[t.jsx(a.h1,{id:"tripdates",children:"Tripdates"}),`
`,t.jsx(a.p,{children:"Content element: Trip / Tripdates"})]})}function _(e={}){const{wrapper:a}={...i(),...e.components};return a?t.jsx(a,{...e,children:t.jsx(u,{...e})}):u(e)}const R={title:"COMPONENTS/Tourism/Trip Dates",parameters:{badges:[c.TESTING],docs:{page:_}},argTypes:{roomCount:{table:{category:"Topbar settings",defaultValue:{summary:"default"}},name:"Room count",description:"Number of rooms on the table",control:{type:"range",min:1,max:5,step:1},required:!0}},tags:["autodocs"]};function r(e,a){return`
    ...
    `,o=m.bind({});o.args={roomCount:1};var n,p,d;o.parameters={...o.parameters,docs:{...(n=o.parameters)==null?void 0:n.docs,source:{originalSource:`(args: TripDatesStoryProps) => {
  return \`
        <main>
