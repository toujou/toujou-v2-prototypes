...
| --toujou-snackbar-info-button-color | Set `,n.jsx(e.code,{children:"color"})," of the ",n.jsx(e.code,{children:"toujou-snackbar[info] .snackbar__button"})," | white |"]})]})}function l(o={}){const{wrapper:e}={...d(),...o.components};return e?n.jsx(e,{...o,children:n.jsx(s,{...o})}):s(o)}const f={title:"COMPONENTS/Snackbar",parameters:{badges:[u.DONE],docs:{page:l}},argTypes:{snackbarVariant:{table:{category:"Snackbar settings",defaultValue:{summary:"info"}},name:"Snackbar variant",description:"Set the snackbar variant style",options:["info","success","warning","error"],control:{type:"radio"},required:!0},snackbarType:{table:{category:"Snackbar settings",defaultValue:{summary:"auto"}},name:"Snackbar type",description:"Set the snackbar type",options:["auto","action"],control:{type:"radio"},required:!0},snackbarDuration:{table:{category:"Snackbar settings"},name:"Snackbar duration",description:"Set the snackbar visibility duration",control:{type:"number"},required:!0}}};function h(o,e,r){return new CustomEvent("toujou-add-snackbar",{bubbles:!0,composed:!0,detail:{message:"welcome to the bonus page!",type:e,buttonText:"ok",duration:r,variant:o}})}const b=o=>(window.addEventListener("click",e=>{const r=e.target;r.getAttribute("id")==="snackbarTriggerButton"&&r.dispatchEvent(h(o.snackbarVariant,o.snackbarType,o.snackbarDuration))}),`
    ...
    `),t=b.bind({});t.args={snackbarVariant:"info",snackbarType:"auto",snackbarDuration:4e3};var a,c,i;t.parameters={...t.parameters,docs:{...(a=t.parameters)==null?void 0:a.docs,source:{originalSource:`(args: SnackbarStoryProps) => {
