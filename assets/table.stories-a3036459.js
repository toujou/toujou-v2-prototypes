...
`]})]})}function c(n={}){const{wrapper:e}=Object.assign({},o(),n.components);return e?t.jsx(e,Object.assign({},n,{children:t.jsx(d,n)})):d(n)}const g={title:"COMPONENTS/Table",parameters:{badges:[s.DONE],docs:{page:c}},argTypes:{tableAlignment:{table:{category:"Table settings",defaultValue:{summary:"none"}},name:"Table alignment",description:"Set the alignment of the table's text",options:["none","center","left","right"],control:{type:"radio"},defaultValue:["none"],required:!0}}},u=n=>`
...
//# sourceMappingURL=table.stories-a3036459.js.map
