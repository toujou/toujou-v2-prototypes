import{T as d}from"./badgeCustomConfig-DUXiHpL4.js";import{j as e}from"./jsx-runtime-BjG_zV1W.js";import{useMDXComponents as i}from"./index-BcJeOPUZ.js";import"./index-B6tQ6Rz7.js";import"./_commonjsHelpers-Cpj98o6Y.js";const p=""+new URL("main-nav-mobile-09__OMUc.jpg",import.meta.url).href,v=""+new URL("main-nav-desktop-CmyqBTZx.jpg",import.meta.url).href;function s(n){const a={code:"code",h2:"h2",p:"p",pre:"pre",...i(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(a.h2,{id:"main-nav",children:"Main nav"}),`
...
Ex: `,e.jsx(a.code,{children:'<li class="main-nav__list-item" nav-item-level="1" has-subnav="" active>'})]})]})}function h(n={}){const{wrapper:a}={...i(),...n.components};return a?e.jsx(a,{...n,children:e.jsx(s,{...n})}):s(n)}const _=""+new URL("service-nav-mobile-D3QlnV6C.jpg",import.meta.url).href,b=""+new URL("service-nav-desktop-Qjwajety.jpg",import.meta.url).href;function l(n){const a={code:"code",h2:"h2",p:"p",pre:"pre",...i(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(a.h2,{id:"service-nav",children:"Service nav"}),`
...
`,e.jsx("img",{src:_}),`
`,e.jsx(a.p,{children:"The desktop navigation open and closes on hover events"}),`
`,e.jsx("img",{src:b})]})}function g(n={}){const{wrapper:a}={...i(),...n.components};return a?e.jsx(a,{...n,children:e.jsx(l,{...n})}):l(n)}function o(n){const a={code:"code",h2:"h2",h3:"h3",p:"p",pre:"pre",...i(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(a.h2,{id:"burger-button",children:"Burger button"}),`
...
`,e.jsxs(a.p,{children:["The ",e.jsx(a.code,{children:"toujou-topbar-breakpoint-change"})," also carries the information if the new window is mobile on ",e.jsx(a.code,{children:"event.detail.state"}),". ",e.jsx(a.code,{children:"true"})," mean it is mobile"]})]})}function x(n={}){const{wrapper:a}={...i(),...n.components};return a?e.jsx(a,{...n,children:e.jsx(o,{...n})}):o(n)}const j=""+new URL("topbar-mobile-Di9Mhn-b.jpg",import.meta.url).href,f=""+new URL("topbar-desktop-U98wAP54.jpg",import.meta.url).href;function r(n){const a={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",ul:"ul",...i(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(a.h1,{id:"topbar",children:"Topbar"}),`
...
`,e.jsx(x,{})]})}function k(n={}){const{wrapper:a}={...i(),...n.components};return a?e.jsx(a,{...n,children:e.jsx(r,{...n})}):r(n)}const A={title:"COMPONENTS/Topbar",parameters:{badges:[d.DONE],docs:{page:k},layout:"fullscreen"},argTypes:{navigationColor:{table:{category:"Topbar settings",defaultValue:{summary:"default"}},name:"Navigation color",description:"Set the navigation color",options:["default","primary","secondary","font"],control:{type:"radio"},required:!0},titleType:{table:{category:"Topbar settings",defaultValue:{summary:"logo"}},name:"Mobile page title type",description:"Toggle between logo or text for the topbar page title on mobile devices",options:["logo","title"],control:{type:"radio"},required:!0},logoSize:{table:{category:"Topbar settings",defaultValue:{summary:"medium"}},name:"Logo size",description:"Set the logo size",options:["small","medium","large"],control:{type:"radio"},required:!0},noTransitions:{table:{category:"Topbar settings",defaultValue:{summary:"false"}},name:"No transitions",description:"Remove the transition from the topbar elements",control:{type:"boolean"},required:!0},languagePickerType:{table:{category:"Topbar settings"},name:"Language picker type",description:"Choose which type of language picker to show",options:["none","inline","dropdown"],control:{type:"radio"},required:!0},openOnHover:{table:{category:"Topbar settings",defaultValue:{summary:"false"}},name:"Open sub-nav on hover",description:"Choose whether or not a mouseenter/mouseleave event will trigger toggling the sub-nav",control:{type:"boolean"},required:!0}}},w=n=>`
    ...
    `,S=n=>(document.documentElement.setAttribute("navigation-color",n.navigationColor),`
        <toujou-topbar
            id="topbar"
            class="topbar"
        ...
        ${E()}
    `),t=S.bind({});t.args={navigationColor:"default",titleType:"logo",logoSize:"medium",noTransitions:!1,languagePickerType:"inline",openOnHover:!1};var c,u,m;t.parameters={...t.parameters,docs:{...(c=t.parameters)==null?void 0:c.docs,source:{originalSource:`(args: TopbarStoryProps) => {
  ...
  return \`
        ...
        \${renderDummyContent()}
    \`;
}`,...(m=(u=t.parameters)==null?void 0:u.docs)==null?void 0:m.source}}};const O=["Topbar"];export{t as Topbar,O as __namedExportsOrder,A as default};
