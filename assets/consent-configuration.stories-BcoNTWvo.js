import{M as a}from"./consent.docs-BJzA1A9Y.js";import"./jsx-runtime-BjG_zV1W.js";import"./index-kYMsDC90.js";import"./iframe-DILOFI4D.js";import"./preload-helper-C1FmrZbK.js";const d={title:"COMPONENTS/Consent",parameters:{docs:{page:a}},argTypes:{showError:{table:{category:"Consent configuration settings"},name:"Show error",description:"Show the consent configuration error",control:{type:"boolean"},required:!0},design:{table:{category:"Consent Settings",defaultValue:{summary:"default"}},name:"Element design",description:"Set the consent element design",options:["default","primary","secondary","inverted"],control:{type:"select"},required:!0}}},i=e=>(window.addEventListener("click",c=>{c.target.getAttribute("id")==="clearConsentsButton"&&(localStorage.removeItem("consentsState"),document.cookie="consentsState= : expires = Thu, 01 Jan 1970 00:00:00 GMT; path=/;",document.location.reload())}),`
        <main>
