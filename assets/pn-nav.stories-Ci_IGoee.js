const n={title:"COMPONENTS/P N Nav",parameters:{layout:"fullscreen"},argTypes:{hideImage:{table:{category:"PN navigation settings"},name:"Hide image",description:"Hide the link image",control:{type:"boolean"},required:!0},hideTitle:{table:{category:"PN navigation settings"},name:"Hide title",description:"Hide the link title",control:{type:"boolean"},required:!0}}},l=e=>`
        <main>
            ...
            <toujou-pn-nav
                ...
                ${e.hideImage===!0?"image-hidden":""}
                ${e.hideTitle===!0?"title-hidden":""}
            >
    ...
    `,o=l.bind({});o.args={hideImage:!1,hideTitle:!1};var t,i,a;o.parameters={...o.parameters,docs:{...(t=o.parameters)==null?void 0:t.docs,source:{originalSource:`(args: PNNavStoryProps) => {
  return \`
        <main>
            <toujou-breadcrumb role="navigation" aria-label="Breadcrumb" class="breadcrumb">
                <button slot="toggle-buttons" class="breadcrumb__toggle breadcrumb__toggle--open">
    ...
    \`;
}`,...(a=(i=o.parameters)==null?void 0:i.docs)==null?void 0:a.source}}};const s=["PNNav"];export{o as PNNav,s as __namedExportsOrder,n as default};
