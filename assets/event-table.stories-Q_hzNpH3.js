...
`})})]})}function p(t={}){const{wrapper:a}={...r(),...t.components};return a?e.jsx(a,{...t,children:e.jsx(l,{...t})}):l(t)}const b={title:"COMPONENTS/EventTable",parameters:{badges:[d.DONE],docs:{page:p}},tags:["autodocs"]},c=()=>`
    ...
    `,n=m.bind({});var i,s,o;n.parameters={...n.parameters,docs:{...(i=n.parameters)==null?void 0:i.docs,source:{originalSource:`() => {
  return \`
        <main>
            \${eventTableComponent()}
    ...
    \`;
}`,...(o=(s=n.parameters)==null?void 0:s.docs)==null?void 0:o.source}}};const f=["EventTable"];export{n as EventTable,f as __namedExportsOrder,b as default};
