import{r as t,a as i}from"./breadcrumb-example-BHVKmO5b.js";const p={title:"PAGES/DestinationOne",parameters:{layout:"fullwidth"},argTypes:{mapAspectRatio:{table:{category:"D1I Hotel Page Settings",defaultValue:{summary:"default"}},name:"Map Aspect Ratio",description:"Set the map's aspect ratio",options:["default","3-1"],control:{type:"radio"},required:!0}}},r=()=>`
    ...
    `,u=s=>`
       ${m(s)}
    `,e=u.bind({});e.args={mapAspectRatio:"default"};var a,o,n;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`(args: DestinationOneHotelProps) => {
  return \`
       \${renderMain(args)}
    \`;
}`,...(n=(o=e.parameters)==null?void 0:o.docs)==null?void 0:n.source}}};const _=["DestinationOneHotel"];export{e as DestinationOneHotel,_ as __namedExportsOrder,p as default};
