import{T as u}from"./badgeCustomConfig-DUXiHpL4.js";import{M as a}from"./blockquote.docs-0a-aYm6x.js";import"./jsx-runtime-BjG_zV1W.js";import"./index-BcJeOPUZ.js";import"./index-B6tQ6Rz7.js";import"./_commonjsHelpers-Cpj98o6Y.js";const g={title:"COMPONENTS/Blockquote",parameters:{badges:[u.DONE],docs:{page:a}},argTypes:{direction:{table:{category:"Blockquote settings",defaultValue:{summary:"vertical"}},name:"Direction",description:"Set the blockquote's direction",options:["vertical","horizontal"],control:{type:"radio"},required:!0},elementDesign:{table:{category:"Blockquote settings",defaultValue:{summary:"default"}},name:"Element design",description:"Set the blockquote's element design",options:["default","primary","secondary","inverted"],control:{type:"radio"},required:!0}}},t=o=>`
    ...
    `,e=l.bind({});e.args={direction:"vertical",elementDesign:"default"};var r,c,i;e.parameters={...e.parameters,docs:{...(r=e.parameters)==null?void 0:r.docs,source:{originalSource:`(args: BlockquoteStoryProps) => {
  return \`
        <main>
            <toujou-blockquote-grid class="blockquote-grid" blockquote-grid-count="1">
    ...
    \`;
}`,...(i=(c=e.parameters)==null?void 0:c.docs)==null?void 0:i.source}}};const b=["Blockquote"];export{e as Blockquote,b as __namedExportsOrder,g as default};
