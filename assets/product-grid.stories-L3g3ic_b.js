...
`})})]})}function p(r={}){const{wrapper:a}={...u(),...r.components};return a?e.jsx(a,{...r,children:e.jsx(c,{...r})}):c(r)}const E={title:"COMPONENTS/Product Grid",parameters:{badges:[l.DONE],docs:{page:p}},argTypes:{imageFormat:{table:{category:"Product grid card settings",defaultValue:{summary:"16-9"}},name:"Image format",description:"Set the product grid cards image format",options:["16-9","square"],control:{type:"radio"},required:!0},cardVariant:{table:{category:"Product grid card settings",defaultValue:{summary:"default"}},name:"Card variant",description:"Set the product grid cards element design",options:["default","primary","secondary","inverted"],control:{type:"radio"},required:!0}},tags:["autodocs"]};function h(r,a){return`
    ...
    `}const f=r=>{const i=document.createElement("toujou-image-card-grid");i.classList.add("image-card-grid");for(let o=0;o<4;o++){const g=h(r.imageFormat,r.cardVariant);i.insertAdjacentHTML("beforeend",g)}const n=document.createElement("main");return n.appendChild(i),n},t=f.bind({});t.args={imageFormat:"16-9",cardVariant:"default"};var d,s,m;t.parameters={...t.parameters,docs:{...(d=t.parameters)==null?void 0:d.docs,source:{originalSource:`(args: ProductGridStoryProps) => {
  const colNumber = 4;
