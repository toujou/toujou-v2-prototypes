const n={title:"COMPONENTS/Image Card",argTypes:{direction:{table:{category:"Image card settings"},name:"Direction",description:"Set the column where the text will be shown",options:["left","right"],control:{type:"radio"},required:!0}}};function t(){return`
    ...
    `,e=s.bind({});e.args={direction:"left"};var u,o,a;e.parameters={...e.parameters,docs:{...(u=e.parameters)==null?void 0:u.docs,source:{originalSource:`(args: ImageCardWithTextStoryProps) => {
  return \`
        <main>
    ...
    \`;
}`,...(a=(o=e.parameters)==null?void 0:o.docs)==null?void 0:a.source}}};const c=["ImageCardWithText"];export{e as ImageCardWithText,c as __namedExportsOrder,n as default};
