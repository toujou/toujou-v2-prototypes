import{T as l}from"./badgeCustomConfig-e7a687d5.js";import{j as e}from"./jsx-runtime-ac05983f.js";import{u as s}from"./index-a9a8c754.js";import"./index-e0ddb630.js";import"./_commonjsHelpers-87174ba5.js";function r(d){const a=Object.assign({h1:"h1",p:"p",code:"code",h2:"h2",pre:"pre",h3:"h3",ul:"ul",li:"li"},s(),d.components);return e.jsxs(e.Fragment,{children:[e.jsx(a.h1,{id:"media-placeholder",children:"Media placeholder"}),`
...
`]})]})}function c(d={}){const{wrapper:a}=Object.assign({},s(),d.components);return a?e.jsx(a,Object.assign({},d,{children:e.jsx(r,d)})):r(d)}const g={title:"COMPONENTS/MediaPlaceholder",parameters:{badges:[l.DONE],docs:{page:c}},argTypes:{mediaType:{table:{category:"Single media settings",defaultValue:{summary:2}},name:"Media type",description:"Choose media type to display",options:["image","video","audio"],control:{type:"radio"},defaultValue:[2],required:!0}}},m=d=>`
    ...
    `,i=m.bind({});i.args={mediaType:"image"};var o,t,n;i.parameters={...i.parameters,docs:{...(o=i.parameters)==null?void 0:o.docs,source:{originalSource:`(args: MediaPlaceholdderStoryProps) => {
  return \`
        <div class="demo-media-placeholder-container">
            <toujou-media-placeholder media-type="\${args.mediaType}" class="media-placeholder"></toujou-media-placeholder>
        </div>
    \`;
}`,...(n=(t=i.parameters)==null?void 0:t.docs)==null?void 0:n.source}}};const y=["MediaPlaceholder"];export{i as MediaPlaceholder,y as __namedExportsOrder,g as default};
//# sourceMappingURL=media-placeholder.stories-97541ac7.js.map
