...
`,e.jsxs(t.p,{children:["More info about mapbox's access token ",e.jsx(t.a,{href:"https://docs.mapbox.com/help/glossary/access-token/",rel:"nofollow",children:"here"})]})]})}function m(o={}){const{wrapper:t}={...c(),...o.components};return t?e.jsx(t,{...o,children:e.jsx(s,{...o})}):s(o)}const b={title:"COMPONENTS/Mapbox",parameters:{badges:[l.DONE],docs:{page:m}},argTypes:{zoomLevel:{table:{category:"Maxbox settings",defaultValue:{summary:"14"}},name:"Zoom level",description:"Choose the map's initial zoom level",control:{type:"range",min:0,max:22,step:1},required:!0},style:{table:{category:"Maxbox settings",defaultValue:{summary:"light-v10"}},name:"Map style",description:"Choose the map's style",control:{type:"radio"},options:["light-v10","dark-v10","streets-v11","outdoors-v11","satellite-v9","navigation-day-v1"],required:!0},showMarker:{table:{category:"Maxbox settings"},name:"Show marker",description:"Toggle marker's visibility",control:{type:"boolean"},required:!0}}},p=o=>`
    ...
    `,a=p.bind({});a.args={zoomLevel:14,style:"light-v10",showMarker:!0};var n,r,i;a.parameters={...a.parameters,docs:{...(n=a.parameters)==null?void 0:n.docs,source:{originalSource:`(args: mapboxStoryProps) => {
  return \`
        <toujou-map class="map"
            center="[11.0762549, 49.4579779]"
            zoom="\${args.zoomLevel}"
    ...
    \`;
}`,...(i=(r=a.parameters)==null?void 0:r.docs)==null?void 0:i.source}}};const y=["Mapbox"];export{a as Mapbox,y as __namedExportsOrder,b as default};
