...
`})})]})}function l(e={}){const{wrapper:t}={...m(),...e.components};return t?n.jsx(t,{...e,children:n.jsx(a,{...e})}):a(e)}const y={title:"COMPONENTS/Counter",parameters:{badges:[c.DONE],docs:{page:l}},argTypes:{elementDesign:{table:{category:"Counter Settings",defaultValue:{summary:"primary"}},name:"Element design",description:"Set the counter's element design",options:["default","primary","secondary","inverted"],control:{type:"radio"},required:!0},animationDuration:{table:{category:"Counter Settings",defaultValue:{summary:"primary"}},name:"Animation duration",description:"Set the counter's number animation duration",options:["slow","medium","fast"],control:{type:"radio"},required:!0},startValue:{table:{category:"Counter Settings"},name:"animation start value",description:"Set the counter's animation start value",control:{type:"number"},required:!0},endValue:{table:{category:"Counter Settings"},name:"animation end value",description:"Set the counter's animation end value",control:{type:"number"},required:!0},numberOfItems:{table:{category:"Counter Settings"},name:"number of Items",description:"Set the number of counter items visible on the story",control:{type:"number",min:1,max:12},required:!0},showPrefix:{table:{category:"Counter Settings"},name:"Show prefix",description:"Show the value prefix",control:{type:"boolean"},required:!0},showSuffix:{table:{category:"Counter Settings"},name:"Show suffix",description:"Show the value suffix",control:{type:"boolean"},required:!0}}},d=e=>{let t="";for(let o=0;o<e.numberOfItems;o++)t+=`
            <toujou-counter
                class="counter"
