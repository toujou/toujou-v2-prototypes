import{T as o}from"./badgeCustomConfig-oxGPBDYz.js";const r={title:"TESTS/Image Cards",parameters:{badges:[o.DONE]}},c=()=>`
    ...
    `,a=c.bind({});var i,t,e;a.parameters={...a.parameters,docs:{...(i=a.parameters)==null?void 0:i.docs,source:{originalSource:`() => {
  return \`
        <toujou-breadcrumb role="navigation" aria-label="Breadcrumb" class="breadcrumb">
            <button slot="toggle-buttons" class="breadcrumb__toggle breadcrumb__toggle--open">
                <toujou-icon class="icon breadcrumb__toggle-icon" icon-name="arrow-left"></toujou-icon>
    ...
    \`;
}`,...(e=(t=a.parameters)==null?void 0:t.docs)==null?void 0:e.source}}};const l=["ImageCards"];export{a as ImageCards,l as __namedExportsOrder,r as default};
