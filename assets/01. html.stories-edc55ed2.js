...
`]}),`
`,e.jsxs(t.p,{children:["If the users select the fullwidth HTML content element, then it must have the ",e.jsx(t.code,{children:"fullwidth"})," attribute"]})]})}function d(i={}){const{wrapper:t}=Object.assign({},s(),i.components);return t?e.jsx(t,Object.assign({},i,{children:e.jsx(o,i)})):o(i)}const g={title:"COMPONENTS/HTML",parameters:{badges:[u.DONE],docs:{page:d},layout:"fullwidth"},argTypes:{isFullwidth:{table:{category:"html container Settings",defaultValue:{summary:"false"}},name:"Is fullwidth",description:"Toggle between fullwidth and content width",control:{type:"boolean"},defaultValue:["false"],required:!0}}},c=i=>`
  ...
  return \`
    ...
    \`;
}`,...(r=(a=n.parameters)==null?void 0:a.docs)==null?void 0:r.source}}};const j=["HTML"];export{n as HTML,j as __namedExportsOrder,g as default};
//# sourceMappingURL=01. html.stories-edc55ed2.js.map
