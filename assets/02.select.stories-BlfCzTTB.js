import{M as i}from"./form.docs-Cmf6I_pl.js";import"./jsx-runtime-BjG_zV1W.js";import"./index-f5PwCmci.js";import"./iframe-D7yF4ca0.js";import"./preload-helper-C1FmrZbK.js";const m={title:"COMPONENTS/Forms",parameters:{docs:{page:i}},argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},required:!0}}},c=t=>{const r=t.state==="disabled"?"disabled":"";return`
        <style>
            body {
