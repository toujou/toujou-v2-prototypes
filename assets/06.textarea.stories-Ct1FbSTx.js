import{M as i}from"./form.docs-DU1k9d2D.js";import"./jsx-runtime-BjG_zV1W.js";import"./index-B3bKeUOg.js";import"./iframe-CGVrXR_C.js";import"./preload-helper-C1FmrZbK.js";const m={title:"COMPONENTS/Forms",parameters:{docs:{page:i}},argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},required:!0}}},p=t=>{const o=t.state==="disabled"?"disabled":"";return`
        <style>
            body {
