...
`]})]})}function g(r={}){const{wrapper:e}={...l(),...r.components};return e?a.jsx(e,{...r,children:a.jsx(o,{...r})}):o(r)}const _={title:"COMPONENTS/Image Card",parameters:{badges:[u.DONE],docs:{page:g}},argTypes:{imageFormat:{table:{category:"Image card settings",defaultValue:{summary:"16-9"}},name:"Image format",description:"Set the image card's image format",options:["16-9","square"],control:{type:"radio"},required:!0},cardsAreLinks:{table:{category:"Image card settings"},name:"Cards are links",description:"Choose if the cards should be a link or not",control:{type:"boolean"},required:!0},columnCount:{table:{category:"Image card settings"},name:"Column count",description:"Number of columns",options:[1,2,3,4],control:{type:"radio"},required:!0},cardVariant:{table:{category:"Image card settings",defaultValue:{summary:"default"}},name:"Card variant",description:"Set the image card element design",options:["default","primary","secondary","inverted"],control:{type:"radio"},required:!0}}};function h(r,e){return`
    ...
    `}const p=r=>{const e=document.createElement("toujou-image-card-grid");e.classList.add("image-card-grid");for(let n=0;n<r.columnCount;n++){const m=r.cardsAreLinks?h(r.imageFormat,r.cardVariant):j(r.imageFormat,r.cardVariant);e.insertAdjacentHTML("beforeend",m)}const t=document.createElement("main");return t.appendChild(e),t},i=p.bind({});i.args={imageFormat:"16-9",columnCount:4,cardsAreLinks:!0,cardVariant:"default"};var c,d,s;i.parameters={...i.parameters,docs:{...(c=i.parameters)==null?void 0:c.docs,source:{originalSource:`(args: ToujouImageCardStoryProps) => {
