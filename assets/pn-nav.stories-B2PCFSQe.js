...
`})})]})}function r(i={}){const{wrapper:t}={...u(),...i.components};return t?e.jsx(t,{...i,children:e.jsx(n,{...i})}):n(i)}const h={title:"COMPONENTS/P N Nav",parameters:{badges:[c.DONE],docs:{page:r},layout:"fullscreen"},argTypes:{hideImage:{table:{category:"PN navigation settings"},name:"Hide image",description:"Hide the link image",control:{type:"boolean"},defaultValue:[!1],required:!0},hideTitle:{table:{category:"PN navigation settings"},name:"Hide title",description:"Hide the link title",control:{type:"boolean"},defaultValue:[!1],required:!0}},tags:["autodocs"]},d=i=>`
        <main>
