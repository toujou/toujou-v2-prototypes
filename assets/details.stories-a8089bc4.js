...
`})})]})}function u(t={}){const{wrapper:n}={...d(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}const b={title:"COMPONENTS/Accordion",parameters:{badges:[a.DONE],docs:{page:u}},argTypes:{elementDesign:{table:{category:"Details Settings",defaultValue:{summary:"default"}},name:"Accordion element design",description:"Set the element design for the accordion element",options:["default","primary","secondary","inverted"],control:{type:"radio"},defaultValue:["default"],required:!0}},tags:["autodocs"]},c=t=>`
  ...
  return \`
    ...
    \`;
}`,...(o=(l=i.parameters)==null?void 0:l.docs)==null?void 0:o.source}}};const j=["Details"];export{i as Details,j as __namedExportsOrder,b as default};
