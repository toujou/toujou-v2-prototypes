import{M as n}from"./toujou-collection-item.docs-DN50Ayaw.js";import{r as l}from"./_renderCardCategoriChips-D3lhH8UM.js";import"./jsx-runtime-BjG_zV1W.js";import"./index-PJZUo48P.js";import"./iframe-StHTXG2s.js";import"./preload-helper-C1FmrZbK.js";const g={title:"COMPONENTS/CollectionCards",parameters:{docs:{page:n}},argTypes:{elementDesign:{table:{category:"Toujou card settings",defaultValue:{summary:"default"}},name:"Element Design",description:"Choose element design for the cards",options:["default","primary","secondary","inverted"],control:{type:"radio"},required:!0}},tags:["autodocs"]},s=o=>`
        <main>
    ...
    `,e=s.bind({});e.args={elementDesign:"default"};var t,i,c;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`(args: ToujouCardStoryProps) => {
  return \`
        <main>
            <ul class="card-collection">
                <li class="card-collection__item">
    ...
    \`;
}`,...(c=(i=e.parameters)==null?void 0:i.docs)==null?void 0:c.source}}};const p=["DestinationOneGastro"];export{e as DestinationOneGastro,p as __namedExportsOrder,g as default};
