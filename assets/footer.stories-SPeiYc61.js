...
`})}),`
`,o.jsx(e.p,{children:'It is possible to create a custom footer by adding a "Footer" Page to the "Storage Folder" Folder in the BE'})]})}function f(s={}){const{wrapper:e}={...i(),...s.components};return e?o.jsx(e,{...s,children:o.jsx(n,{...s})}):n(s)}const x={title:"COMPONENTS/Footer",parameters:{badges:[c.DONE],docs:{page:f},layout:"fullscreen"},tags:["autodocs"]},_=()=>`
        <footer class="footer">
            <footer-content class="footer-content">
                <footer-column class="footer-column" column-name="logo">
    ...
    `,t=_.bind({});var l,a,r;t.parameters={...t.parameters,docs:{...(l=t.parameters)==null?void 0:l.docs,source:{originalSource:`() => {
  return \`
        <footer class="footer">
            <footer-content class="footer-content">
                <footer-column class="footer-column" column-name="logo">
