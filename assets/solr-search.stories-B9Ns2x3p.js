import{j as o}from"./jsx-runtime-BjG_zV1W.js";import{useMDXComponents as r}from"./index-1qOAq4RQ.js";import{r as t}from"./_renderCardCategoriChips-D3lhH8UM.js";import"./iframe-D18rJm-t.js";import"./preload-helper-C1FmrZbK.js";function s(e){const a={h1:"h1",...r(),...e.components};return o.jsx(a.h1,{id:"solr-search",children:"SOLR search"})}function p(e={}){const{wrapper:a}={...r(),...e.components};return a?o.jsx(a,{...e,children:o.jsx(s,{...e})}):s(e)}const h={title:"COMPONENTS/solr",parameters:{docs:{page:p}},argTypes:{showMobileFilters:{table:{category:"Solr search settings"},name:"Show mobile filters",description:"Toggle visibility of the mobile filters",control:{type:"boolean"},required:!0},showMap:{table:{category:"Solr search settings"},name:"Show map",description:"Toggle visibility of the search map",control:{type:"boolean"},required:!0}}},u=e=>`
        <main>
     ...
     `,i=u.bind({});i.args={showMobileFilters:!1,showMap:!1};var l,c,n;i.parameters={...i.parameters,docs:{...(l=i.parameters)==null?void 0:l.docs,source:{originalSource:`(args: SolrSearchStoryProps) => {
  return \`
        <main>
     ...
     \`;
}`,...(n=(c=i.parameters)==null?void 0:c.docs)==null?void 0:n.source}}};const b=["SolrSearch"];export{i as SolrSearch,b as __namedExportsOrder,h as default};
