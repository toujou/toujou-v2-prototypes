...
| `,t.jsx(e.code,{children:"third-right"})," | define a 66% - 33% grid | ",t.jsx(e.code,{children:'<toujou-grid grid-type="default" number-of-columns="2" column-layout=third-right">'})," |"]})]})}function p(n={}){const{wrapper:e}={...m(),...n.components};return e?t.jsx(e,{...n,children:t.jsx(u,{...n})}):u(n)}const E={title:"COMPONENTS/Grid",parameters:{badges:[h.DONE],docs:{page:p},layout:"fullscreen"},argTypes:{type:{table:{category:"Grid settings",defaultValue:{summary:"default"}},name:"Grid type",description:"Set grid type",options:["default","medium","wide","fullwidth","ignore"],control:{type:"radio"},defaultValue:["normal"],required:!0},numberOfColumns:{table:{category:"Grid settings",defaultValue:{summary:"default"}},name:"Number of columns",description:"Set the number of columns",options:[1,2,3,4],control:{type:"radio"},defaultValue:[1],required:!0},columnsLayout:{table:{category:"Grid settings",defaultValue:{summary:"default"}},name:"Two columns layout",description:"Define layout of the grid columns",options:["default","third-right","third-left"],control:{type:"radio"},defaultValue:["default"],required:!0,if:{arg:"numberOfColumns",eq:2}}}},g=n=>{const e=document.createElement("toujou-grid");e.classList.add("grid","demo-grid"),e.setAttribute("number-of-columns",String(n.numberOfColumns)),e.setAttribute("grid-type",n.type),n.numberOfColumns==2&&e.setAttribute("column-layout",n.columnsLayout);for(let l=0;l<n.numberOfColumns;l++){const r=document.createElement("toujou-grid-column");r.classList.add("grid-column");const d=document.createElement("p");d.textContent=`grid--${n.type}`,d.classList.add("demo-grid__title"),r.appendChild(d),e.appendChild(r)}const o=document.createElement("main");return o.appendChild(e),o},i=g.bind({});i.args={type:"default",numberOfColumns:1,columnsLayout:"default"};var s,c,a;i.parameters={...i.parameters,docs:{...(s=i.parameters)==null?void 0:s.docs,source:{originalSource:`(args: GridStoryProps) => {
