const u={title:"COMPONENTS/Consent",argTypes:{design:{table:{category:"Consent Settings",defaultValue:{summary:"default"}},name:"Element design",description:"Set the consent element design",options:["default","primary","secondary","inverted"],control:{type:"select"},required:!0}}},a=s=>(window.addEventListener("click",c=>{c.target.getAttribute("id")==="clearConsentsButton"&&(localStorage.removeItem("consentsState"),document.location.reload())}),`
        <main>
     ...
     `),t=a.bind({});t.args={design:"default"};var e,n,o;t.parameters={...t.parameters,docs:{...(e=t.parameters)==null?void 0:e.docs,source:{originalSource:`(args: ConsentWidgetProps) => {
  ...
  return \`
     ...
     \`;
}`,...(o=(n=t.parameters)==null?void 0:n.docs)==null?void 0:o.source}}};const l=["ConsentWidget"];export{t as ConsentWidget,l as __namedExportsOrder,u as default};
