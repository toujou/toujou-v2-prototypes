...
`})}),`
`,o.jsx(s.p,{children:'It is possible to create a custom footer by adding a "Footer" Page to the "Storage Folder" Folder in the BE'})]})}function r(e={}){const{wrapper:s}={...c(),...e.components};return s?o.jsx(s,{...e,children:o.jsx(n,{...e})}):n(e)}const p={title:"COMPONENTS/Footer",parameters:{docs:{page:r},layout:"fullscreen"}},f=()=>`
        <footer class="footer">
            <footer-content class="footer-content">
                <footer-column class="footer-column" column-name="logo">
    ...
    `,t=f.bind({});var a,l,i;t.parameters={...t.parameters,docs:{...(a=t.parameters)==null?void 0:a.docs,source:{originalSource:`() => {
  return \`
        <footer class="footer">
            <footer-content class="footer-content">
                <footer-column class="footer-column" column-name="logo">
    ...
    \`;
}`,...(i=(l=t.parameters)==null?void 0:l.docs)==null?void 0:i.source}}};const h=["Footer"];export{t as Footer,h as __namedExportsOrder,p as default};
