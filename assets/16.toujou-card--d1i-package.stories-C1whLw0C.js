import{r as t}from"./_renderCardCategoriChips-D3lhH8UM.js";const l={title:"COMPONENTS/CollectionCards",argTypes:{elementDesign:{table:{category:"Toujou card settings",defaultValue:{summary:"default"}},name:"Element Design",description:"Choose element design for the cards",options:["default","primary","secondary","inverted"],control:{type:"radio"},required:!0}}},s=o=>`
        <main>
                ...
                <li class="card-collection__item">
                    <toujou-collection-item class="collection-item" item-type="organisation" element-design="${o.elementDesign}" item-orientation="vertical" role="article">
                        ...
                        <div class="collection-item__bottom">
                            ...
                            <h3 class="collection-item__title">Package A</h3>
                ...
                <li class="card-collection__item">
                    <toujou-collection-item class="collection-item" item-type="organisation" element-design="${o.elementDesign}" item-orientation="vertical" role="article">
                        ...
                        <div class="collection-item__bottom">
                            ...
                            <h3 class="collection-item__title">Package B</h3>
                ...
                <li class="card-collection__item">
                    <toujou-collection-item class="collection-item" item-type="organisation" element-design="${o.elementDesign}" item-orientation="vertical" role="article">
                        ...
                        <div class="collection-item__bottom">
                            ...
                            <h3 class="collection-item__title">Package C</h3>
                ...
                <li class="card-collection__item">
                    <toujou-collection-item class="collection-item" item-type="organisation" element-design="${o.elementDesign}" item-orientation="vertical" role="article">
                        ...
                        <div class="collection-item__bottom">
                            ...
                            <h3 class="collection-item__title">Package D</h3>
    ...
    `,e=s.bind({});e.args={elementDesign:"default"};var i,c,n;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:`(args: ToujouCardStoryProps) => {
  return \`
        <main>
            <ul class="card-collection">
                <li class="card-collection__item">
    ...
    \`;
}`,...(n=(c=e.parameters)==null?void 0:c.docs)==null?void 0:n.source}}};const r=["CardDestinationOnePackage"];export{e as CardDestinationOnePackage,r as __namedExportsOrder,l as default};
