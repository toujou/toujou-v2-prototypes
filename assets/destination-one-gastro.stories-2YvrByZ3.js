import{r as t}from"./destinationOneIntroSection-dMoNR17U.js";import{r as i}from"./breadcrumb-example-DMkkXFpu.js";const _={title:"PAGES/DestinationOne",parameters:{layout:"fullwidth"},argTypes:{mapAspectRatio:{table:{category:"D1I Gastro Page Settings",defaultValue:{summary:"default"}},name:"Map Aspect Ratio",description:"Set the map's aspect ratio",options:["default","3-1"],control:{type:"radio"},required:!0}}},r=()=>`
    ...
    `,c=()=>`
        ...
        <h2>Section Cuisine Types</h2>
        <p>cuisineTypes</p>
        
        <h2>Section Kitchen Specialities</h2>
        <p>kitchenSpecialities</p>
    ...
    `,m=s=>`
        <main id="main" skippy-links-label="Main content">
            ${i()}
            <div class="fragment" fragment-type="d1i-gastro" map-aspect-ratio="${s.mapAspectRatio}">
                ${t("GASTRO")}
                ${r()}
                ${c()}
            </div>
    ...
    `,u=s=>`
       ${m(s)}
    `,e=u.bind({});e.args={mapAspectRatio:"3-1"};var a,n,o;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`(args: DestinationOneGastroProps) => {
  return \`
       \${renderMain(args)}
    \`;
}`,...(o=(n=e.parameters)==null?void 0:n.docs)==null?void 0:o.source}}};const g=["DestinationOneGastro"];export{e as DestinationOneGastro,g as __namedExportsOrder,_ as default};
