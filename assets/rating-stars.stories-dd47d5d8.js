import{T as c}from"./badgeCustomConfig-e7a687d5.js";import{j as e}from"./jsx-runtime-ac05983f.js";import{u as o}from"./index-a9a8c754.js";import"./index-e0ddb630.js";import"./_commonjsHelpers-87174ba5.js";function s(n){const t=Object.assign({h1:"h1",p:"p",h2:"h2",pre:"pre",code:"code",h3:"h3",ul:"ul",li:"li"},o(),n.components);return e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"rating-stars",children:"Rating-stars"}),`
...
`]})]})}function d(n={}){const{wrapper:t}=Object.assign({},o(),n.components);return t?e.jsx(t,Object.assign({},n,{children:e.jsx(s,n)})):s(n)}const p={title:"COMPONENTS/RatingStars",parameters:{badges:[c.DONE],docs:{page:d}},argTypes:{rating:{table:{category:"Rating stars",defaultValue:{summary:"4.4"}},name:"Rating value",description:"Set a value for the rating",control:{type:"number",min:0,max:5,step:.1},defaultValue:["4.7"],required:!0},size:{table:{category:"Rating stars",defaultValue:{summary:"xl"}},name:"Size",description:"Set the rating stars size",options:["s","normal","m","l","xl","xxl"],control:{type:"radio"},defaultValue:["normal"],required:!0}}},h=n=>`
        <toujou-rating-stars
            class="rating-stars"
            rating-entity="★"
            rating-total="5"
...
//# sourceMappingURL=rating-stars.stories-dd47d5d8.js.map
