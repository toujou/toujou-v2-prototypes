const s={title:"PAGES/BlogPost",argTypes:{hasAvatar:{table:{category:"Blog post Settings",defaultValue:{summary:"true"}},name:"Author has avatar",description:"Toggle between a post page where author avatar is or isn't available",control:{type:"boolean"},required:!0}}},n=t=>(console.log(t),`
        <div class="blog-post">
            <section>
    ...
    `),o=n.bind({});o.args={hasAvatar:!0};var i,e,a;o.parameters={...o.parameters,docs:{...(i=o.parameters)==null?void 0:i.docs,source:{originalSource:`(args: BlogPostStoryProps) => {
  console.log(args);
  return \`
        <div class="blog-post">
            <section>
    ...
    \`;
}`,...(a=(e=o.parameters)==null?void 0:e.docs)==null?void 0:a.source}}};const c=["BlogPost"];export{o as BlogPost,c as __namedExportsOrder,s as default};
