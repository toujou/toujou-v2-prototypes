const u={title:"COMPONENTS/Content Card",argTypes:{columnCount:{table:{category:"Content card settings"},name:"Column count",description:"Number of columns",options:[1,2],control:{type:"radio"},required:!0},cardVariant:{table:{category:"Content card settings",defaultValue:{summary:"default"}},name:"Card variant",description:"Set the content card element design",options:["default","primary","secondary","inverted"],control:{type:"radio"},required:!0},hasLink:{table:{category:"Content card settings",defaultValue:{summary:"default"}},name:"Has link",description:"Set a link for the card",control:{type:"boolean"},required:!0}}},d=e=>{const a=document.createElement("toujou-content-card-grid");a.classList.add("content-card-grid");for(let o=0;o<e.columnCount;o++){const t=document.createElement(e.hasLink?"a":"toujou-content-card");t.classList.add("content-card"),t.setAttribute("card-variant",e.cardVariant),t.setAttribute("card-direction","horizontal"),t.setAttribute("role","article"),e.hasLink&&t.setAttribute("href","#"),t.innerHTML=`
        ...
        `,a.appendChild(t)}const r=document.createElement("main");return r.appendChild(a),r},n=d.bind({});n.args={columnCount:2,cardVariant:"default",hasLink:!1};var c,i,s;n.parameters={...n.parameters,docs:{...(c=n.parameters)==null?void 0:c.docs,source:{originalSource:`(args: ContentCardStoryProps) => {
  ...
  return mainEl;
}`,...(s=(i=n.parameters)==null?void 0:i.docs)==null?void 0:s.source}}};const l=["HorizontalContentCard"];export{n as HorizontalContentCard,l as __namedExportsOrder,u as default};
