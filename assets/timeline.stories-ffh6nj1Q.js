import{j as e}from"./jsx-runtime-BjG_zV1W.js";import{useMDXComponents as m}from"./index-DdPgtLQN.js";import"./iframe-CHg5-sk7.js";import"./preload-helper-C1FmrZbK.js";function l(t){const i={code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...m(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(i.h1,{id:"timeline",children:"Timeline"}),`
...
The "vertical" direction renders the timeline items under each other, the "horizontal" direction renders them next to each other (with horizontal scroll)`]})]})}function r(t={}){const{wrapper:i}={...m(),...t.components};return i?e.jsx(i,{...t,children:e.jsx(l,{...t})}):l(t)}const h={title:"COMPONENTS/Timeline",parameters:{docs:{page:r}},argTypes:{direction:{table:{category:"Timeline Settings",defaultValue:{summary:"vertical"}},name:"Timeline direction",description:"Choose between a vertical or horizontal timeline",options:["vertical","horizontal"],control:{type:"radio"},required:!0},elementDesign:{table:{category:"Timeline Settings",defaultValue:{summary:"default"}},name:"Timeline element design",description:"Set the element design for the timeline element",options:["default","primary","secondary","inverted"],control:{type:"radio"},required:!0},showLegend:{table:{category:"Timeline settings",defaultValue:{summary:"false"}},name:"Show legend",description:"Show the legend element",control:{type:"boolean"},required:!0}}},c=t=>`
        <main>
            <toujou-timeline
                class="timeline"
    ...
    `,n=c.bind({});n.args={direction:"vertical",elementDesign:"default",showLegend:!1};var a,s,o;n.parameters={...n.parameters,docs:{...(a=n.parameters)==null?void 0:a.docs,source:{originalSource:`(args: TimelineStoryProps) => {
  return \`
        <main>
            <toujou-timeline
                class="timeline"
    ...
    \`;
}`,...(o=(s=n.parameters)==null?void 0:s.docs)==null?void 0:o.source}}};const g=["Timeline"];export{n as Timeline,g as __namedExportsOrder,h as default};
