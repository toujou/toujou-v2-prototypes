import"./photoswipe-lightbox-creator-DeSHVBPr.js";const o={title:"COMPONENTS/Lightbox"},l=()=>`
        <h1>Grid 1</h1>
    ...
    `,i=l.bind({});var s,e,t;i.parameters={...i.parameters,docs:{...(s=i.parameters)==null?void 0:s.docs,source:{originalSource:`() => {
  return \`
        <h1>Grid 1</h1>
        <toujou-media-grid class="media-grid" media-grid-column-number="2" lightbox-parent-id="1">
            <toujou-single-media class="single-media">
    ...
    \`;
}`,...(t=(e=i.parameters)==null?void 0:e.docs)==null?void 0:t.source}}};const n=["Lightbox"];export{i as Lightbox,n as __namedExportsOrder,o as default};
