const p={title:"COMPONENTS/Poster Reveal",argTypes:{contentType:{table:{category:"Poster Reveal settings",defaultValue:{summary:"youtube"}},name:"Content type",description:"Define the content type",options:["youtube","vimeo","text"],control:{type:"radio"},required:!0}}};function r(){return`
        <button
    ...
    `}function m(e){switch(e){case"youtube":return`
                ${i()};
                ${u()};
            `;case"vimeo":return`
                ${i()};
    ...
    `,t=d.bind({});t.args={contentType:"youtube"};var o,n,a;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`(args: PosterRevealProps) => {
  return \`
        <main>
            <toujou-media-grid class="media-grid" media-grid-column-number="1">
                <toujou-single-media class="single-media">
    ...
    \`;
}`,...(a=(n=t.parameters)==null?void 0:n.docs)==null?void 0:a.source}}};const c=["PosterReveal"];export{t as PosterReveal,c as __namedExportsOrder,p as default};
