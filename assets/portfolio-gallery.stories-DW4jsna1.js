...
`,i.jsxs(e.p,{children:["The ",i.jsx(e.code,{children:"is-header"})," attribute must be added to the portfolio gallery element when it is displayed inside the header section of the page."]})]})}function c(s={}){const{wrapper:e}={...r(),...s.components};return e?i.jsx(e,{...s,children:i.jsx(t,{...s})}):t(s)}const j={title:"COMPONENTS/Portfolio Gallery",parameters:{badges:[d.DONE],docs:{page:c},layout:"fullscreen"},tags:["autodocs"]},p=()=>`
        <main>
