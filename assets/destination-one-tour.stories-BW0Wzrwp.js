import{r,a as c}from"./breadcrumb-example-BHVKmO5b.js";const s=(a,i="")=>`
        <toujou-rating-stars
            class="rating-stars"
            rating-value="${a}"
            rating-total="5"
        ...
        ></toujou-rating-stars>
    `,g={title:"PAGES/DestinationOne",parameters:{layout:"fullwidth"},argTypes:{mapAspectRatio:{table:{category:"D1I Tour Page Settings",defaultValue:{summary:"default"}},name:"Map Aspect Ratio",description:"Set the map's aspect ratio",options:["default","3-1"],control:{type:"radio"},required:!0}}},l=()=>`
    ...
    `,p=a=>`
       ${d(a)}
    `,e=p.bind({});e.args={mapAspectRatio:"default"};var n,o,t;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`(args: DestinationOneTourProps) => {
  return \`
       \${renderMain(args)}
    \`;
}`,...(t=(o=e.parameters)==null?void 0:o.docs)==null?void 0:t.source}}};const f=["DestinationOneTour"];export{e as DestinationOneTour,f as __namedExportsOrder,g as default};
