import{M as i}from"./form.docs-DrdS62cz.js";import"./jsx-runtime-BjG_zV1W.js";import"./index-C5208tH8.js";import"./iframe-r6akNsGl.js";import"./preload-helper-C1FmrZbK.js";const b={title:"COMPONENTS/Forms",parameters:{docs:{page:i}},argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},required:!0}}},d=r=>{const e=r.state==="disabled"?"disabled":"";return`
        <style>
            body {
