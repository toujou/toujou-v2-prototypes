import{T as l}from"./badgeCustomConfig-DUXiHpL4.js";import{j as e}from"./jsx-runtime-BjG_zV1W.js";import{useMDXComponents as p}from"./index-DpH9cx3q.js";import"./index-DO8khQO4.js";import"./_commonjsHelpers-Cpj98o6Y.js";function o(n){const r={code:"code",p:"p",...p(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(r.p,{children:"#lazy render"}),`
`,e.jsxs(r.p,{children:["User the ",e.jsx(r.code,{children:"toujou-lazy-render"})," web-component"]})]})}function d(n={}){const{wrapper:r}={...p(),...n.components};return r?e.jsx(r,{...n,children:e.jsx(o,{...n})}):o(n)}const z={title:"COMPONENTS/Lazy Render",parameters:{badges:[l.DONE],docs:{page:d},layout:"fullscreen"}},c=()=>`
        <h1>Lazy render</h1>
