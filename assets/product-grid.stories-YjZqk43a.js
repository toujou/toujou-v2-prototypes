...
`})})]})}function p(r={}){const{wrapper:a}={...u(),...r.components};return a?e.jsx(a,{...r,children:e.jsx(c,{...r})}):c(r)}const P={title:"COMPONENTS/Product Grid",parameters:{badges:[l.DONE],docs:{page:p}},argTypes:{imageFormat:{table:{category:"Product grid card settings",defaultValue:{summary:"16-9"}},name:"Image format",description:"Set the product grid cards image format",options:["16-9","square"],control:{type:"radio"},defaultValue:["cinema"],required:!0},cardVariant:{table:{category:"Product grid card settings",defaultValue:{summary:"default"}},name:"Card variant",description:"Set the product grid cards element design",options:["default","primary","secondary","inverted"],control:{type:"radio"},defaultValue:["default"],required:!0}},tags:["autodocs"]};function f(r,a){return`
  ...
  main.appendChild(toujouImageCardGrid);
  return main;
}`,...(m=(s=t.parameters)==null?void 0:s.docs)==null?void 0:m.source}}};const y=["ProductGrid"];export{t as ProductGrid,y as __namedExportsOrder,P as default};
