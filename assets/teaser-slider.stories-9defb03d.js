import{T as d}from"./badgeCustomConfig-e7a687d5.js";import{j as s}from"./jsx-runtime-6a2ad889.js";import{u as l}from"./index-1b6e96e1.js";import"./index-56d4de0b.js";import"./_commonjsHelpers-042e6b4d.js";function r(i){const e={a:"a",code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",...l(),...i.components};return s.jsxs(s.Fragment,{children:[s.jsx(e.h1,{id:"teaser-slider",children:"teaser slider"}),`
...
`})}),`
`,s.jsxs(e.p,{children:["| For more information about the slider element, please refer to the ",s.jsx(e.a,{href:"/docs/components-media--slider",children:"Slider docs"})]})]})}function c(i={}){const{wrapper:e}={...l(),...i.components};return e?s.jsx(e,{...i,children:s.jsx(r,{...i})}):r(i)}const v={title:"COMPONENTS/Teaser",parameters:{badges:[d.DONE],docs:{page:c}},argTypes:{teaserDirection:{table:{category:"Teaser slider settings",defaultValue:{summary:"right"}},name:"Teaser direction",description:"Choose the teaser direction",options:["right","left"],control:{type:"radio"},defaultValue:["right"],required:!0}},tags:["autodocs"]},u=i=>{const e=i.teaserDirection==="right"?"left":"right";return`
        <toujou-slider
            class="slider"
            aria-label="Toujou slider example"
            element-design="primary"
