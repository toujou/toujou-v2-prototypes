import{M as a}from"./consent.docs-B461-gUK.js";import"./jsx-runtime-BjG_zV1W.js";import"./index-BaOfGPA4.js";import"./iframe-By-4hsAT.js";import"./preload-helper-C1FmrZbK.js";const g={title:"COMPONENTS/Consent",parameters:{docs:{page:a}},argTypes:{design:{table:{category:"Consent Settings",defaultValue:{summary:"default"}},name:"Element design",description:"Set the consent element design",options:["default","primary","secondary","inverted"],control:{type:"select"},required:!0}}},i=s=>(window.addEventListener("click",c=>{c.target.getAttribute("id")==="clearConsentsButton"&&(localStorage.removeItem("consentsState"),document.location.reload())}),`
        <main>
