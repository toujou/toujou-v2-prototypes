const u={title:"COMPONENTS/Consent",argTypes:{showError:{table:{category:"Consent configuration settings"},name:"Show error",description:"Show the consent configuration error",control:{type:"boolean"},required:!0},design:{table:{category:"Consent Settings",defaultValue:{summary:"default"}},name:"Element design",description:"Set the consent element design",options:["default","primary","secondary","inverted"],control:{type:"select"},required:!0}}},a=e=>(window.addEventListener("click",c=>{c.target.getAttribute("id")==="clearConsentsButton"&&(localStorage.removeItem("consentsState"),document.cookie="consentsState= : expires = Thu, 01 Jan 1970 00:00:00 GMT; path=/;",document.location.reload())}),`
        <main>
     ...
     `),n=a.bind({});n.args={showError:!0,design:"default"};var t,o,s;n.parameters={...n.parameters,docs:{...(t=n.parameters)==null?void 0:t.docs,source:{originalSource:`(args: ConsentConfigurationStoryProps) => {
  ...
  return \`
     ...
     \`;
}`,...(s=(o=n.parameters)==null?void 0:o.docs)==null?void 0:s.source}}};const l=["ConsentConfiguration"];export{n as ConsentConfiguration,l as __namedExportsOrder,u as default};
