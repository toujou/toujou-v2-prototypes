...
`,s.jsx(a.code,{children:"tt_content.codeblock.20.settings.pathToCssFile"})]})]})}function h(n={}){const{wrapper:a}={...o(),...n.components};return a?s.jsx(a,{...n,children:s.jsx(e,{...n})}):e(n)}const m={title:"COMPONENTS/Code Block",parameters:{badges:[r.DONE],docs:{page:h}},argTypes:{showLanguageTag:{table:{category:"Code block Settings",defaultValue:{summary:"true"}},name:"Show the language tag",description:"Show or hide the language tag",control:{type:"boolean"},required:!0}}},i=n=>`
