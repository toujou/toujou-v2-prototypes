import{T as i}from"./badgeCustomConfig-e7a687d5.js";import{M as c}from"./form.docs-cb9e85c7.js";import"./jsx-runtime-ccada58e.js";import"./index-f1f749bf.js";import"./_commonjsHelpers-042e6b4d.js";import"./index-4fb8b842.js";const g={title:"COMPONENTS/Forms",parameters:{badges:[i.DONE],docs:{page:c}},argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},defaultValue:["default"],required:!0}},tags:["autodocs"]},l=t=>{const r=t.state==="disabled"?"disabled":"";return`
        <style>
            body {
...
//# sourceMappingURL=02.select.stories-b814db43.js.map
