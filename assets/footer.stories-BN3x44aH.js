import{T as r}from"./badgeCustomConfig-DUXiHpL4.js";import{j as o}from"./jsx-runtime-CS_Wz6c_.js";import{useMDXComponents as c}from"./index-C8FVCAkB.js";import"./index-Dy2Ak0OH.js";import"./_commonjsHelpers-Cpj98o6Y.js";function a(e){const s={code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",ul:"ul",...c(),...e.components};return o.jsxs(o.Fragment,{children:[o.jsx(s.h1,{id:"footer",children:"footer"}),`
`,o.jsx(s.p,{children:"The default footer element render 4 columns:"}),`
`,o.jsxs(s.ul,{children:[`
`,o.jsx(s.li,{children:"logo"}),`
`,o.jsx(s.li,{children:"Service navigation"}),`
`,o.jsx(s.li,{children:"Footer navigation"}),`
`,o.jsx(s.li,{children:"Contact"}),`
`]}),`
`,o.jsx(s.h2,{id:"markup-example",children:"Markup example"}),`
`,o.jsx(s.pre,{children:o.jsx(s.code,{className:"language-html",children:`<footer class="footer">
...
`})}),`
`,o.jsx(s.p,{children:'It is possible to create a custom footer by adding a "Footer" Page to the "Storage Folder" Folder in the BE'})]})}function f(e={}){const{wrapper:s}={...c(),...e.components};return s?o.jsx(s,{...e,children:o.jsx(a,{...e})}):a(e)}const k={title:"COMPONENTS/Footer",parameters:{badges:[r.DONE],docs:{page:f},layout:"fullscreen"},tags:["autodocs"]},_=()=>`
        <footer class="footer">
            <footer-content class="footer-content">
                <footer-column class="footer-column" column-name="logo">
    ...
    `,t=_.bind({});var n,l,i;t.parameters={...t.parameters,docs:{...(n=t.parameters)==null?void 0:n.docs,source:{originalSource:`() => {
  return \`
        <footer class="footer">
            <footer-content class="footer-content">
                <footer-column class="footer-column" column-name="logo">
    ...
    \`;
}`,...(i=(l=t.parameters)==null?void 0:l.docs)==null?void 0:i.source}}};const x=["Footer"];export{t as Footer,x as __namedExportsOrder,k as default};
