import{M as o}from"./form.docs-2FiizIVL.js";import"./jsx-runtime-BjG_zV1W.js";import"./index-BaOfGPA4.js";import"./iframe-By-4hsAT.js";import"./preload-helper-C1FmrZbK.js";const m={title:"COMPONENTS/Forms",parameters:{docs:{page:o}},argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},required:!0}}},p=e=>{const t=e.state==="disabled"?"disabled":"";return`
        <style>
            body {
