const l={title:"COMPONENTS/Tourism/Accommodations"};function e(i){return`
        <ul class="separated-list trip-accommodations__options" list-spacing="wide">
            <li class="separated-list__item trip-accommodations__option">
                ...
                <span class="trip-accommodations__option-value">${i.roomCount}</span>
            </li>
            ...
            <li class="separated-list__item trip-accommodations__option">
                ...
                <span class="trip-accommodations__option-value">
                    <a href="#" class="trip-accommodations__option-link">${i.linkText}</a>
                </span>
            </li>
        </ul>
    `}const n=()=>`
                            ...
                            <toujou-text-block class="text-block" text-block-media-position="beside-left" column-layout="third">
                                <toujou-text-block-column class="text-block-column">
                                    ...
                                    <div class="text-block__content">
                                        ...
                                        ${e({roomCount:"12",rating:4,linkText:"Accommodation A"})}
                            ...
                            <toujou-text-block class="text-block" text-block-media-position="beside-left" column-layout="third">
                                <toujou-text-block-column class="text-block-column">
                                    ...
                                    <div class="text-block__content">
                                        ...
                                        ${e({roomCount:"18",rating:3.5,linkText:"Accommodation B"})}
                            ...
                            <toujou-text-block class="text-block" text-block-media-position="beside-left" column-layout="third">
                                <toujou-text-block-column class="text-block-column">
                                    ...
                                    <div class="text-block__content">
                                        ...
                                        ${e({roomCount:"8",rating:4.5,linkText:"Accommodation C"})}
    ...
    `,t=n.bind({});var o,s,a;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`() => {
  return \`
        <main>
            <toujou-trip-accommodations class="trip-accommodations">
                <toujou-details-accordion class="details-accordion" is-trip-accommodations>
    ...
    \`;
}`,...(a=(s=t.parameters)==null?void 0:s.docs)==null?void 0:a.source}}};const c=["Accommodations"];export{t as Accommodations,c as __namedExportsOrder,l as default};
