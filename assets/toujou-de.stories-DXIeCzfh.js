const s={title:"TESTS/toujou.de",parameters:{layout:"fullscreen"}},i=()=>`
        ...
        <footer class="footer">
            <footer-content class="footer-content">
                <footer-column class="footer-column" column-name="logo">
                    <img class="footer__logo" src="https://placehold.co/240x80/cccccc/969696?text=Logo" alt="quote image" />
                </footer-column>
    ...
    `,e=i.bind({});var t,o,n;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`() => {
  return \`
        <header class="header" image-height="default">
            <img class="header__image" src="https://picsum.photos/2000" alt="quote image" />
    ...
    \`;
}`,...(n=(o=e.parameters)==null?void 0:o.docs)==null?void 0:n.source}}};const l=["ToujouHomepage"];export{e as ToujouHomepage,l as __namedExportsOrder,s as default};
