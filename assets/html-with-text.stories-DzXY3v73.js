...
`,o.jsxs(t.p,{children:["When rendered inside a grid, the ",o.jsx(t.code,{children:"toujou-html-container"})," must have the ",o.jsx(t.code,{children:"fullwidth"})," attribute"]})]})}function f(e={}){const{wrapper:t}={...d(),...e.components};return t?o.jsx(t,{...e,children:o.jsx(a,{...e})}):a(e)}const O={title:"COMPONENTS/HTML With Text",parameters:{badges:[h.DONE],docs:{page:f}},argTypes:{layout:{table:{category:"html with text Settings",defaultValue:{summary:"33-left"}},name:"Layout",description:"Choose the HTML with text layout",options:["33-left","33-right","50-left","50-right","66-left","66-right","multicolumn-left","multicolumn-right"],control:{type:"radio"},defaultValue:["33-left"],required:!0}},tags:["autodocs"]};function l(){return`
        <toujou-grid-column class="grid-column">
            <toujou-html-container class="html-container" fullwidth>
