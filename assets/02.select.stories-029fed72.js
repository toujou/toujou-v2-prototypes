import{T as n}from"./badgeCustomConfig-e7a687d5.js";import{M as i}from"./form.docs-d4244716.js";import"./jsx-runtime-87b2c1dd.js";import"./index-afb52020.js";import"./_commonjsHelpers-725317a4.js";import"./index-af127bdc.js";const g={title:"COMPONENTS/Forms",parameters:{badges:[n.DONE],docs:{page:i}},argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},defaultValue:["default"],required:!0}},tags:["autodocs"]},c=t=>{const r=t.state==="disabled"?"disabled":"";return`
        <style>
            body {
