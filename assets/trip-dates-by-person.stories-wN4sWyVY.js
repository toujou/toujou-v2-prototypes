const u={title:"COMPONENTS/Tourism/Trip Dates By Person"};function r(e){return`
        ...
        <main>
            <toujou-departures class="departures departures-by-person" role="table" aria-label="Departure Dates">
                ...
                <div role="rowgroup" class="departures__dates">
                    ${r({tripName:"Trip A",country:{value:"Portugal",label:"Country"},date:{value:"01.02. - 15.02.2025",label:"Date"},status:{text:"Buchbar",type:"success",message:"Garantiert - nur wenig Plätze"},price:{value:"64€",label:"Price"}})}
                    
                    ${r({tripName:"Trip B",country:{value:"Spain",label:"Country"},date:{value:"12.02. - 20.02.2025",label:"Date"},status:{text:"Buchbar",type:"success",message:"Garantiert - nur wenig Plätze"},price:{value:"124€",label:"Price"}})}
                    
                    ${r({tripName:"Trip C",country:{value:"France",label:"Country"},date:{value:"01.03. - 15.03.2025",label:"Date"},status:{text:"Auf Anfrage",type:"warning",message:"Warteliste"},price:{value:"124€",label:"Price"}})}
                </div>
            </toujou-departures>
        </main>
    `,a=d.bind({});var t,s,l;a.parameters={...a.parameters,docs:{...(t=a.parameters)==null?void 0:t.docs,source:{originalSource:`() => {
  return \`
        <main>
            <toujou-departures class="departures departures-by-person" role="table" aria-label="Departure Dates">
                <div class="departures__header-group" role="rowgroup">
    ...
    \`;
}`,...(l=(s=a.parameters)==null?void 0:s.docs)==null?void 0:l.source}}};const i=["TripdatesByPerson"];export{a as TripdatesByPerson,i as __namedExportsOrder,u as default};
