import{j as e}from"./jsx-runtime-ccada58e.js";import{u as n}from"./index-4fb8b842.js";function i(o){const t=Object.assign({h1:"h1",p:"p",code:"code",h2:"h2",pre:"pre",h3:"h3"},n(),o.components);return e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"toujou-text-block",children:"<toujou-text-block>"}),`
...
`,e.jsxs(t.p,{children:[`| Attribute | Possible values | Example |
|---|:---:|:---|
| `,e.jsx(t.code,{children:'text-block-third-direction="left"'}),' | "left", "right" | ',e.jsx(t.code,{children:'<toujou-text-block class="text-block" text-blocks-column-count="2" text-block-third-direction="left">'}),"  |"]})]})}function s(o={}){const{wrapper:t}=Object.assign({},n(),o.components);return t?e.jsx(t,Object.assign({},o,{children:e.jsx(i,o)})):i(o)}export{s as M};
//# sourceMappingURL=text-block.docs-903b31eb.js.map
