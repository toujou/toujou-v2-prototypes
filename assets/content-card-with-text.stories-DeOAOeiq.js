const c={title:"COMPONENTS/Content Card",argTypes:{direction:{table:{category:"Content card settings",defaultValue:{summary:"left"}},name:"Direction",description:"Set the column where the text will be shown",options:["left","right"],control:{type:"radio"},required:!0}}};function i(){return`
    ...
    `}const r=e=>`
        <toujou-grid class="grid" number-of-columns="2" grid-type="default" column-layout="${e.direction==="left"?"third-right":"third-left"}">
             <toujou-grid-column class="grid-column">
                ${e.direction==="left"?i():n()}
            </toujou-grid-column>
            <toujou-grid-column class="grid-column">
                ${e.direction==="left"?n():i()}
            </toujou-grid-column>
        </toujou-grid>
    `,u=e=>`
        <main>
    ...
    `,t=u.bind({});t.args={direction:"left"};var o,a,s;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`(args: ContentCardWithTextStoryProps) => {
  return \`
        <main>
    ...
    \`;
}`,...(s=(a=t.parameters)==null?void 0:a.docs)==null?void 0:s.source}}};const d=["ContentCardWithText"];export{t as ContentCardWithText,d as __namedExportsOrder,c as default};
