import{j as t}from"./jsx-runtime-DPda6Ybg.js";import{useMDXComponents as i}from"./index-4_AlzpT7.js";function e(o){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...i(),...o.components};return t.jsxs(t.Fragment,{children:[t.jsx(n.h1,{id:"toujou-button",children:"<toujou-button>"}),`
...
`,t.jsx(n.pre,{children:t.jsx(n.code,{className:"language-html",children:`<button is="toujou-button" class="button" button-variant="primary" button-type="default" button-size="normal" button-icon-position="left">
    <toujou-icon class="icon button__icon" icon-name="arrow-right"></toujou-icon> Hello world
</button>
`})}),`
...
`,t.jsxs(n.p,{children:[`| Attribute | Example |
|--|:---:|
| `,t.jsx(n.code,{children:"disabled"}),"  | ",t.jsx(n.code,{children:'<button is="toujou-button" class="button" button-variant="primary" button-type="default" button-size="normal" disabled>Hello world</button>'})," |"]})]})}function r(o={}){const{wrapper:n}={...i(),...o.components};return n?t.jsx(n,{...o,children:t.jsx(e,{...o})}):e(o)}export{r as M};
