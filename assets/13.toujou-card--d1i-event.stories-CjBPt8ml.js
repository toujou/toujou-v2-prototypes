import{r as t}from"./_renderCardCategoriChips-D3lhH8UM.js";const l={title:"COMPONENTS/CollectionCards",argTypes:{elementDesign:{table:{category:"Toujou card settings",defaultValue:{summary:"default"}},name:"Element Design",description:"Choose element design for the cards",options:["default","primary","secondary","inverted"],control:{type:"radio"},required:!0}}},s=o=>`
                ...
                <li class="card-collection__item">
                    <toujou-collection-item class="collection-item" item-type="organisation" element-design="${o.elementDesign}" item-orientation="vertical" role="article">
                        ...
                        <div class="collection-item__bottom">
                            ...
                            <h3 class="collection-item__title">Event A</h3>
                ...
                <li class="card-collection__item">
                    <toujou-collection-item class="collection-item" item-type="organisation" element-design="${o.elementDesign}" item-orientation="vertical" role="article">
                        ...
                        <div class="collection-item__bottom">
                            ...
                            <h3 class="collection-item__title">Event B</h3>
                ...
                <li class="card-collection__item">
                    <toujou-collection-item class="collection-item" item-type="organisation" element-design="${o.elementDesign}" item-orientation="vertical" role="article">
                        ...
                        <div class="collection-item__bottom">
                            ...
                            <h3 class="collection-item__title">Event C</h3>
                ...
                <li class="card-collection__item">
                    <toujou-collection-item class="collection-item" item-type="organisation" element-design="${o.elementDesign}" item-orientation="vertical" role="article">
                        ...
                        <div class="collection-item__bottom">
                            ...
                            <h3 class="collection-item__title">Event D</h3>
  ...
  return \`
    ...
    \`;
}`,...(c=(n=e.parameters)==null?void 0:n.docs)==null?void 0:c.source}}};const r=["CardDestinationOneEvent"];export{e as CardDestinationOneEvent,r as __namedExportsOrder,l as default};
