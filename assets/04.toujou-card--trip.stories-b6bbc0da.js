import{T as n}from"./badgeCustomConfig-e7a687d5.js";import{M as l}from"./toujou-collection-item.docs-12476081.js";import"./jsx-runtime-ac05983f.js";import"./index-e0ddb630.js";import"./_commonjsHelpers-87174ba5.js";import"./index-a9a8c754.js";const f={title:"COMPONENTS/Collections",parameters:{badges:[n.DONE],docs:{page:l}},argTypes:{elementDesign:{table:{category:"Toujou card settings",defaultValue:{summary:"default"}},name:"Element Design",description:"Choose element design for the cards",options:["default","primary","secondary","inverted"],control:{type:"radio"},defaultValue:["default"],required:!0}},tags:["autodocs"]},s=e=>`
        <ul class="card-collection">
            <li class="card-collection__item">
                <toujou-collection-item class="collection-item" item-type="trip" element-design="${e.elementDesign}" item-orientation="vertical" role="article">
    ...
    `,i=s.bind({});i.args={elementDesign:"default"};var o,t,c;i.parameters={...i.parameters,docs:{...(o=i.parameters)==null?void 0:o.docs,source:{originalSource:`(args: ToujouCardStoryProps) => {
  return \`
        <ul class="card-collection">
            <li class="card-collection__item">
    ...
    \`;
}`,...(c=(t=i.parameters)==null?void 0:t.docs)==null?void 0:c.source}}};const d=["CardTrip"];export{i as CardTrip,d as __namedExportsOrder,f as default};
//# sourceMappingURL=04.toujou-card--trip.stories-b6bbc0da.js.map
