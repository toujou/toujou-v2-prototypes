import{T as c}from"./badgeCustomConfig-e7a687d5.js";import{M as i}from"./form.docs-97b78f8d.js";import"./jsx-runtime-ac05983f.js";import"./index-e0ddb630.js";import"./_commonjsHelpers-87174ba5.js";import"./index-a9a8c754.js";const d={title:"COMPONENTS/Forms",parameters:{badges:[c.DONE],docs:{page:i}},argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},defaultValue:["default"],required:!0}},tags:["autodocs"]},u=e=>{const t=e.state==="disabled"?"disabled":"";return`
        <style>
            body {
        ...
        <form
            ...
            <toujou-input-group class="input-group input-group--check checkbox-group ${e.state==="error"?"input-group--has-error":""} ${e.state==="success"?"input-group--has-success":""} ${e.state==="disabled"?"input-group--disabled":""}">
            ...
            <toujou-input-group class="input-group input-group--multi-check multi-checkbox-group ${e.state==="error"?"input-group--has-error":""} ${e.state==="success"?"input-group--has-success":""} ${e.state==="disabled"?"input-group--disabled":""}">
    ...
    `},o=u.bind({});o.args={state:"default"};var s,r,a;o.parameters={...o.parameters,docs:{...(s=o.parameters)==null?void 0:s.docs,source:{originalSource:`(args: ToujouCheckboxStoryProps) => {
  ...
  return \`
    ...
    \`;
}`,...(a=(r=o.parameters)==null?void 0:r.docs)==null?void 0:a.source}}};const k=["CheckboxInputs"];export{o as CheckboxInputs,k as __namedExportsOrder,d as default};
//# sourceMappingURL=04.checkbox.stories-0df7ee0b.js.map
