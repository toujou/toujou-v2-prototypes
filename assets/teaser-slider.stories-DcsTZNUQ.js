const o={title:"COMPONENTS/Teaser",argTypes:{teaserDirection:{table:{category:"Teaser slider settings",defaultValue:{summary:"right"}},name:"Teaser direction",description:"Choose the teaser direction",options:["right","left"],control:{type:"radio"},required:!0}}},l=r=>{const e=r.teaserDirection==="right"?"left":"right";return`
        <main>
            <toujou-slider
                class="slider"
    ...
    `},s=l.bind({});s.args={teaserDirection:"right"};var i,t,a;s.parameters={...s.parameters,docs:{...(i=s.parameters)==null?void 0:i.docs,source:{originalSource:`(args: ToujouTeaserSliderProps) => {
  ...
  return \`
    ...
    \`;
}`,...(a=(t=s.parameters)==null?void 0:t.docs)==null?void 0:a.source}}};const n=["TeaserSlider"];export{s as TeaserSlider,n as __namedExportsOrder,o as default};
