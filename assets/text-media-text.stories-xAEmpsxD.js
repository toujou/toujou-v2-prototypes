const o={title:"TESTS/Distance between"},t=()=>`
        <main>
    ...
    `,i=t.bind({});var e,s,l;i.parameters={...i.parameters,docs:{...(e=i.parameters)==null?void 0:e.docs,source:{originalSource:`() => {
  return \`
        <main>
            <toujou-text-block class="text-block" text-block-column-count="1">
                <toujou-text-block-column class="text-block-column">
    ...
    \`;
}`,...(l=(s=i.parameters)==null?void 0:s.docs)==null?void 0:l.source}}};const a=["TextMediaText"];export{i as TextMediaText,a as __namedExportsOrder,o as default};
