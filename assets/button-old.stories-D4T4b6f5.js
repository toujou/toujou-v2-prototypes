import{T as s}from"./badgeCustomConfig-DUXiHpL4.js";import{M as r}from"./button.docs-DABmbBNz.js";import"./jsx-runtime-BjG_zV1W.js";import"./index-BcJeOPUZ.js";import"./index-B6tQ6Rz7.js";import"./_commonjsHelpers-Cpj98o6Y.js";const i={title:"COMPONENTS/Button",parameters:{badges:[s.DONE],docs:{page:r}}},e=()=>`
    ...
    `,t=e.bind({});var o,n,a;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`() => {
  return \`
        <h3>Old (deprecated) button classes</h3>
        <p>To improve backwards compatibility (and compatibility with other extensions) we also support the older button classes, like <code>button--shadow</code></p>
        <br>
        ...
        <p><a href="/" class="button button--expanded button--font button--shadow">Button shadow font 100%</a></p>
    \`;
}`,...(a=(n=t.parameters)==null?void 0:n.docs)==null?void 0:a.source}}};const l=["OldButtons"];export{t as OldButtons,l as __namedExportsOrder,i as default};
