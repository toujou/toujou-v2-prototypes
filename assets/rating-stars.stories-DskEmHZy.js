...
`})})]})}function u(e={}){const{wrapper:a}={...l(),...e.components};return a?t.jsx(a,{...e,children:t.jsx(n,{...e})}):n(e)}const x={title:"COMPONENTS/Rating Stars",parameters:{badges:[c.DONE],docs:{page:u}},argTypes:{rating:{table:{category:"Rating stars",defaultValue:{summary:"4.4"}},name:"Rating value",description:"Set a value for the rating",control:{type:"number",min:0,max:5,step:.1},required:!0},suffix:{table:{category:"Rating stars"},name:"Rating suffix",description:"Set a suffix for the rating"}},tags:["autodocs"]},g=e=>`
        <toujou-rating-stars
            class="rating-stars"
        ...
        ></toujou-rating-stars>
    `,r=g.bind({});r.args={rating:4.4,suffix:""};var s,i,o;r.parameters={...r.parameters,docs:{...(s=r.parameters)==null?void 0:s.docs,source:{originalSource:`(args: RatingStarsStoryProps) => {
  return \`
        <toujou-rating-stars
            class="rating-stars"
        ...
        ></toujou-rating-stars>
    \`;
}`,...(o=(i=r.parameters)==null?void 0:i.docs)==null?void 0:o.source}}};const j=["RatingStars"];export{r as RatingStars,j as __namedExportsOrder,x as default};
