const u={title:"COMPONENTS/Forms",argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},required:!0}}},i=t=>{const o=t.state==="disabled"?"disabled":"";return`
        <style>
            body {
    ...
    `},e=i.bind({});e.args={state:"default"};var r,a,s;e.parameters={...e.parameters,docs:{...(r=e.parameters)==null?void 0:r.docs,source:{originalSource:`(args: ToujouTextareaStoryProps) => {
  ...
  return \`
    ...
    \`;
}`,...(s=(a=e.parameters)==null?void 0:a.docs)==null?void 0:s.source}}};const p=["TextareaInputs"];export{e as TextareaInputs,p as __namedExportsOrder,u as default};
