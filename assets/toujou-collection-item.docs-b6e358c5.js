import{j as e}from"./jsx-runtime-6a2ad889.js";import{u as o}from"./index-1b6e96e1.js";function i(n){const t={code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...o(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"toujou-collection-item",children:"<toujou-collection-item>"}),`
...
`,e.jsxs(t.p,{children:["By setting the ",e.jsx(t.code,{children:'role="article"'})," we define the cards as a section of a page that could easily stand on its own on a page, in a document."]})]})}function s(n={}){const{wrapper:t}={...o(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(i,{...n})}):i(n)}export{s as M};
