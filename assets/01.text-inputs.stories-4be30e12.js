import{T as u}from"./badgeCustomConfig-e7a687d5.js";import{M as o}from"./form.docs-8da5404b.js";import"./jsx-runtime-689cd42e.js";import"./index-ab13a269.js";import"./_commonjsHelpers-725317a4.js";import"./index-8a890fec.js";const f={title:"COMPONENTS/Forms",parameters:{badges:[u.DONE],docs:{page:o}},argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},defaultValue:["default"],required:!0}},tags:["autodocs"]},p=e=>{const r=e.state==="disabled"?"disabled":"";return`
        <style>
            body {
