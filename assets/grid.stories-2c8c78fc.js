import{T as m}from"./badgeCustomConfig-e7a687d5.js";import{j as t}from"./jsx-runtime-ac05983f.js";import{u as a}from"./index-a9a8c754.js";import"./index-e0ddb630.js";import"./_commonjsHelpers-87174ba5.js";function l(n){const e=Object.assign({h1:"h1",p:"p",code:"code",h2:"h2",pre:"pre",h3:"h3"},a(),n.components);return t.jsxs(t.Fragment,{children:[t.jsx(e.h1,{id:"toujou-grid",children:"<toujou-grid>"}),`
...
| `,t.jsx(e.code,{children:"third-right"})," | define a 66% - 33% grid | ",t.jsx(e.code,{children:'<toujou-grid grid-type="default" number-of-columns="2" column-layout=third-right">'})," |"]})]})}function h(n={}){const{wrapper:e}=Object.assign({},a(),n.components);return e?t.jsx(e,Object.assign({},n,{children:t.jsx(l,n)})):l(n)}const b={title:"COMPONENTS/Grid",parameters:{badges:[m.DONE],docs:{page:h},layout:"fullscreen"},argTypes:{type:{table:{category:"Grid settings",defaultValue:{summary:"default"}},name:"Grid type",description:"Set grid type",options:["default","medium","wide","fullwidth","ignore"],control:{type:"radio"},defaultValue:["normal"],required:!0},numberOfColumns:{table:{category:"Grid settings",defaultValue:{summary:"default"}},name:"Number of columns",description:"Set the number of columns",options:[1,2,3,4],control:{type:"radio"},defaultValue:[1],required:!0},columnsLayout:{table:{category:"Grid settings",defaultValue:{summary:"default"}},name:"Two columns layout",description:"Define layout of the grid columns",options:["default","third-right","third-left"],control:{type:"radio"},defaultValue:["default"],required:!0,if:{arg:"numberOfColumns",eq:2}}}},g=n=>{const e=document.createElement("toujou-grid");e.classList.add("grid","demo-grid"),e.setAttribute("number-of-columns",String(n.numberOfColumns)),e.setAttribute("grid-type",n.type),n.numberOfColumns==2&&e.setAttribute("column-layout",n.columnsLayout);for(let o=0;o<n.numberOfColumns;o++){const i=document.createElement("toujou-grid-column");i.classList.add("grid-column");const d=document.createElement("p");d.textContent=`grid--${n.type}`,d.classList.add("demo-grid__title"),i.appendChild(d),e.appendChild(i)}return e},r=g.bind({});r.args={type:"default",numberOfColumns:1,columnsLayout:"default"};var s,u,c;r.parameters={...r.parameters,docs:{...(s=r.parameters)==null?void 0:s.docs,source:{originalSource:`(args: GridStoryProps) => {
  ...
  return gridEl;
}`,...(c=(u=r.parameters)==null?void 0:u.docs)==null?void 0:c.source}}};const w=["Grid"];export{r as Grid,w as __namedExportsOrder,b as default};
//# sourceMappingURL=grid.stories-2c8c78fc.js.map
