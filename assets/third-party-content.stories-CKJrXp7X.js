...
An example if the `,e.jsx(t.code,{children:"iframe position"})," property for video, maps and for html elements."]})]})}function u(n={}){const{wrapper:t}={...r(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(s,{...n})}):s(n)}const _={title:"COMPONENTS/Third Party Content",parameters:{badges:[l.DONE],docs:{page:u}},argTypes:{showPoster:{table:{category:"third party content settings"},name:"Show poster image",description:"Show a poster image as background",control:{type:"boolean"},required:!0},isVideo:{table:{category:"third party content settings"},name:"Video content",description:"Emulate element with video element content",control:{type:"boolean"},required:!0}},tags:["autodocs"]};window.addEventListener("click",n=>{n.target.getAttribute("id")==="clearConsentsButton"&&(localStorage.removeItem("consentsState"),document.location.reload())});const p=()=>`
