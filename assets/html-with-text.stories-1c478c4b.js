import{T as h}from"./badgeCustomConfig-e7a687d5.js";import{j as o}from"./jsx-runtime-ccada58e.js";import{u as d}from"./index-4fb8b842.js";import"./index-f1f749bf.js";import"./_commonjsHelpers-042e6b4d.js";function a(e){const t=Object.assign({h1:"h1",p:"p",h2:"h2",pre:"pre",code:"code",h3:"h3"},d(),e.components);return o.jsxs(o.Fragment,{children:[o.jsx(t.h1,{id:"html-with-text",children:"HTML with text"}),`
...
`,o.jsxs(t.p,{children:["When rendered inside a grid, the ",o.jsx(t.code,{children:"toujou-html-container"})," must have the ",o.jsx(t.code,{children:"fullwidth"})," attribute"]})]})}function f(e={}){const{wrapper:t}=Object.assign({},d(),e.components);return t?o.jsx(t,Object.assign({},e,{children:o.jsx(a,e)})):a(e)}const O={title:"COMPONENTS/HTML With Text",parameters:{badges:[h.DONE],docs:{page:f}},argTypes:{layout:{table:{category:"html with text Settings",defaultValue:{summary:"33-left"}},name:"Layout",description:"Choose the HTML with text layout",options:["33-left","33-right","50-left","50-right","66-left","66-right","multicolumn-left","multicolumn-right"],control:{type:"radio"},defaultValue:["33-left"],required:!0}},tags:["autodocs"]};function l(){return`
        <toujou-grid-column class="grid-column">
            <toujou-html-container class="html-container" fullwidth>
  ...
  return \`
    ...
    \`;
}`,...(c=(m=r.parameters)==null?void 0:m.docs)==null?void 0:c.source}}};const k=["HtmlWithTextStoryProps"];export{r as HtmlWithTextStoryProps,k as __namedExportsOrder,O as default};
//# sourceMappingURL=html-with-text.stories-1c478c4b.js.map
