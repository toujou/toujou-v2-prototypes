const u={title:"COMPONENTS/Forms",argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},required:!0}}},o=e=>{const t=e.state==="disabled"?"disabled":"";return`
        <style>
            body {
    ...
    `},s=o.bind({});s.args={state:"default"};var r,a,i;s.parameters={...s.parameters,docs:{...(r=s.parameters)==null?void 0:r.docs,source:{originalSource:`(args: ToujouAllInputsStoryProps) => {
  ...
  return \`
    ...
    \`;
}`,...(i=(a=s.parameters)==null?void 0:a.docs)==null?void 0:i.source}}};const p=["AllInputs"];export{s as AllInputs,p as __namedExportsOrder,u as default};
