const m={"YYYY.MM.DD":"Y.m.d","YYYY/MM/DD":"Y/m/d","DD.MM.YYYY":"d.m.Y","DD/MM/YYYY":"d/m/Y"},p={single:"single",range:"range"},u={title:"COMPONENTS/Forms",argTypes:{dateFormat:{name:"Date format",description:"Set the date format",options:Object.values(m),control:{type:"radio"},required:!0},minDate:{name:"Earliest date",description:"Earliest selectable date",control:{type:"date"}},maxDate:{name:"Latest date",description:"Latest selectable date",control:{type:"date"}},showTime:{name:"Show time",description:"Show time on the datepicker",control:{type:"boolean"},required:!0},type:{name:"Type",description:"Set the input type",options:Object.values(p),control:{type:"radio"},required:!0}}};function r(e){if(isNaN(e))return"";const t=new Date(e);if(isNaN(t.getTime()))return"";const o=t.getFullYear(),c=(t.getMonth()+1).toString().padStart(2,"0"),d=t.getDate().toString().padStart(2,"0");return`${o}-${c}-${d}`}const l=e=>{console.log("minDate",e.minDate);const t=r(e.minDate);console.log("maxDate",e.maxDate);const o=r(e.maxDate);return`
    ...
    `},a=l.bind({});a.args={dateFormat:m["YYYY.MM.DD"],minDate:Date.now(),maxDate:Date.now()+864e5*365,showTime:!1,type:p.single};var s,i,n;a.parameters={...a.parameters,docs:{...(s=a.parameters)==null?void 0:s.docs,source:{originalSource:`(args: DatepickerProps) => {
  ...
  return \`
    ...
    \`;
}`,...(n=(i=a.parameters)==null?void 0:i.docs)==null?void 0:n.source}}};const D=["DatePicker"];export{a as DatePicker,D as __namedExportsOrder,u as default};
