const r={title:"COMPONENTS/Blog Plugin",argTypes:{hasAvatar:{table:{category:"Author Settings",defaultValue:{summary:"true"}},name:"Has avatar",description:"Toggle between view with and without user avatar",control:{type:"boolean"},required:!0}}},e=o=>`
  ...
  return \`
    ...
    \`;
}`,...(t=(s=a.parameters)==null?void 0:s.docs)==null?void 0:t.source}}};const n=["Authors"];export{a as Authors,n as __namedExportsOrder,r as default};
