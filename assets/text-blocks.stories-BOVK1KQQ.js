const u={title:"TESTS/Distance between"},o=()=>`
    ...
    `,e=o.bind({});var t,i,n;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`() => {
  return \`
        <toujou-text-block class="text-block" text-block-column-count="1">
            <toujou-text-block-column class="text-block-column">
                <div class="text-block__content">
    ...
    \`;
}`,...(n=(i=e.parameters)==null?void 0:i.docs)==null?void 0:n.source}}};const l=["TextBlocks"];export{e as TextBlocks,l as __namedExportsOrder,u as default};
