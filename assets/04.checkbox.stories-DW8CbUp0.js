import{M as c}from"./form.docs-YLEgcb7i.js";import"./jsx-runtime-BjG_zV1W.js";import"./index-BBg64T0F.js";import"./iframe-BVsh7E0O.js";import"./preload-helper-C1FmrZbK.js";const n={title:"COMPONENTS/Forms",parameters:{docs:{page:c}},argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},required:!0}}},i=e=>{const t=e.state==="disabled"?"disabled":"";return`
        <style>
            body {
