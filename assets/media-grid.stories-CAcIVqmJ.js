...
`,i.jsxs(e.p,{children:["Valid values are ",i.jsx(e.code,{children:"1"}),", ",i.jsx(e.code,{children:"2"}),", ",i.jsx(e.code,{children:"3"}),", and ",i.jsx(e.code,{children:"4"})]})]})}function g(t={}){const{wrapper:e}={...l(),...t.components};return e?i.jsx(e,{...t,children:i.jsx(s,{...t})}):s(t)}const y={title:"COMPONENTS/Media",parameters:{badges:[u.DONE],docs:{page:g}},argTypes:{mediaType:{table:{category:"Single media settings"},name:"Media type",description:"Choose media type to display",options:["image","video"],control:{type:"radio"},defaultValue:[2],required:!0},numberOfCols:{table:{category:"Single media settings",defaultValue:{summary:"2"}},name:"Number of columns",description:"Choose the number of columns for the media grid",options:[1,2,3,4],control:{type:"radio"},defaultValue:["image"],required:!0}},tags:["autodocs"]};function p(t){const e=document.createElement("toujou-single-media");if(e.classList.add("single-media"),t==="image"){const o=document.createElement("img");o.classList.add("single-media__image"),o.setAttribute("src","https://picsum.photos/1600/900"),o.setAttribute("alt","Nice image"),e.appendChild(o)}else{const o=document.createElement("video");o.classList.add("single-media__video"),o.setAttribute("type","video/mp4"),o.setAttribute("controls",""),o.setAttribute("src","http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4"),e.appendChild(o)}const n=`
    ...
    `;return e.innerHTML+=n,e}const h=t=>{const e=document.createElement("main"),n=document.createElement("toujou-media-grid");n.classList.add("media-grid"),n.setAttribute("media-grid-column-number",t.numberOfCols.toString());for(let o=0;o<t.numberOfCols;o++){const m=p(t.mediaType);n.appendChild(m)}return e.appendChild(n),e},a=h.bind({});a.args={mediaType:"image",numberOfCols:2};var d,c,r;a.parameters={...a.parameters,docs:{...(d=a.parameters)==null?void 0:d.docs,source:{originalSource:`(args: SingleMediaStoryProps) => {
  ...
  return mainEl;
}`,...(r=(c=a.parameters)==null?void 0:c.docs)==null?void 0:r.source}}};const E=["MediaGrid"];export{a as MediaGrid,E as __namedExportsOrder,y as default};
