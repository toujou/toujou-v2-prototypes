import{T as a}from"./badgeCustomConfig-e7a687d5.js";import{M as s}from"./content-card-with-text.docs-9f7d28f0.js";import"./jsx-runtime-6a2ad889.js";import"./index-56d4de0b.js";import"./_commonjsHelpers-042e6b4d.js";import"./index-1b6e96e1.js";const h={title:"COMPONENTS/Content Card",parameters:{badges:[a.DONE],docs:{page:s}},argTypes:{direction:{table:{category:"Content card settings",defaultValue:{direction:"left"}},name:"Direction",description:"Set the column where the text will be shown",options:["left","right"],control:{type:"radio"},defaultValue:["left"],required:!0}},tags:["autodocs"]};function i(){return`
    ...
    `,e=c.bind({});e.args={direction:"left"};var o,n,u;e.parameters={...e.parameters,docs:{...(o=e.parameters)==null?void 0:o.docs,source:{originalSource:`(args: ContentCardWithTextStoryProps) => {
  return \`
    ...
    \`;
}`,...(u=(n=e.parameters)==null?void 0:n.docs)==null?void 0:u.source}}};const b=["ContentCardWithText"];export{e as ContentCardWithText,b as __namedExportsOrder,h as default};
