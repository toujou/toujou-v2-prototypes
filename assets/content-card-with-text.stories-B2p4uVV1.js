import{T as u}from"./badgeCustomConfig-DUXiHpL4.js";import{M as c}from"./content-card-with-text.docs-E8oD5eV6.js";import"./jsx-runtime-BjG_zV1W.js";import"./index-BcJeOPUZ.js";import"./index-B6tQ6Rz7.js";import"./_commonjsHelpers-Cpj98o6Y.js";const b={title:"COMPONENTS/Content Card",parameters:{badges:[u.DONE],docs:{page:c}},argTypes:{direction:{table:{category:"Content card settings",defaultValue:{summary:"left"}},name:"Direction",description:"Set the column where the text will be shown",options:["left","right"],control:{type:"radio"},defaultValue:["left"],required:!0}},tags:["autodocs"]};function i(){return`
    ...
    `,e=d.bind({});e.args={direction:"left"};var r,a,s;e.parameters={...e.parameters,docs:{...(r=e.parameters)==null?void 0:r.docs,source:{originalSource:`(args: ContentCardWithTextStoryProps) => {
  return \`
        <main>
