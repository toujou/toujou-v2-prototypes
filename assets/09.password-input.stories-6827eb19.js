import{T as r}from"./badgeCustomConfig-e7a687d5.js";import{M as i}from"./form.docs-961221a3.js";import"./jsx-runtime-6a2ad889.js";import"./index-56d4de0b.js";import"./_commonjsHelpers-042e6b4d.js";import"./index-1b6e96e1.js";const m={title:"COMPONENTS/Forms",parameters:{badges:[r.DONE],docs:{page:i}},argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},defaultValue:["default"],required:!0}},tags:["autodocs"]},u=o=>{const s=o.state==="disabled"?"disabled":"";return`
        <style>
            body {
