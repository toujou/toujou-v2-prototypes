import{T as d}from"./badgeCustomConfig-DUXiHpL4.js";import{M as u}from"./content-card.docs-DzE_z25W.js";import"./jsx-runtime-CS_Wz6c_.js";import"./index-Dy2Ak0OH.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-C8FVCAkB.js";const h={title:"COMPONENTS/Content Card",parameters:{badges:[d.DONE],docs:{page:u}},argTypes:{columnCount:{table:{category:"Content card settings"},name:"Column count",description:"Number of columns",options:[1,2,3,4],control:{type:"radio"},defaultValue:[1],required:!0},cardVariant:{table:{category:"Content card settings",defaultValue:{summary:"default"}},name:"Card variant",description:"Set the content  card element design",options:["default","primary","secondary","inverted"],control:{type:"radio"},defaultValue:["default"],required:!0},hasLink:{table:{category:"Content card settings",defaultValue:{summary:"default"}},name:"Has link",description:"Set a link for the card",control:{type:"boolean"},defaultValue:!1,required:!0}},tags:["autodocs"]},l=e=>{const a=document.createElement("toujou-content-card-grid");a.classList.add("content-card-grid");for(let r=0;r<e.columnCount;r++){const t=document.createElement(e.hasLink?"a":"toujou-content-card");t.classList.add("content-card"),t.setAttribute("card-variant",e.cardVariant),t.setAttribute("card-direction","vertical"),t.setAttribute("role","article"),e.hasLink&&t.setAttribute("href","#"),t.innerHTML=`
        ...
        `,a.appendChild(t)}const c=document.createElement("main");return c.appendChild(a),c},n=l.bind({});n.args={columnCount:4,cardVariant:"default",hasLink:!1};var i,o,s;n.parameters={...n.parameters,docs:{...(i=n.parameters)==null?void 0:i.docs,source:{originalSource:`(args: ContentCardStoryProps) => {
