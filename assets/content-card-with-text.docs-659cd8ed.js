import{j as e}from"./jsx-runtime-ccada58e.js";import{u as o}from"./index-4fb8b842.js";function i(t){const n=Object.assign({h1:"h1",p:"p",code:"code",h2:"h2",pre:"pre"},o(),t.components);return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"content-card-with-text",children:"Content card with text"}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"content card with text"}),' (either right or left) can be added on the "Combined elements" tab']}),`
`,e.jsxs(n.p,{children:["This element is a combination of text elements and a ",e.jsx(n.code,{children:"<toujou-content-card-grid>"})]}),`
`,e.jsxs(n.p,{children:["For more information please check the documentation for the ",e.jsx(n.code,{children:"toujou-grid"}),", ",e.jsx(n.code,{children:"toujou-content-card-grid"})," and ",e.jsx(n.code,{children:"toujou-content-card"})," elements"]}),`
`,e.jsx(n.h2,{id:"markup-example",children:"Markup example"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<toujou-grid class="grid" number-of-columns="2" grid-type="default" column-layout="default">
...
`})}),`
`,e.jsxs(n.p,{children:["| ⚠ notice the ",e.jsx(n.code,{children:"fullwidth"})," attribute both on the ",e.jsx(n.code,{children:"toujou-content-card-grid"})," and ",e.jsx(n.code,{children:".content-card"}),` elements |
|--------------------------------------------------------------------------------------------------------|`]})]})}function u(t={}){const{wrapper:n}=Object.assign({},o(),t.components);return n?e.jsx(n,Object.assign({},t,{children:e.jsx(i,t)})):i(t)}export{u as M};
//# sourceMappingURL=content-card-with-text.docs-659cd8ed.js.map
