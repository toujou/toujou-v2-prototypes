import{T as d}from"./badgeCustomConfig-DUXiHpL4.js";import{M as u}from"./content-card.docs-B3Qd9S8E.js";import"./jsx-runtime-BjG_zV1W.js";import"./index-BcJeOPUZ.js";import"./index-B6tQ6Rz7.js";import"./_commonjsHelpers-Cpj98o6Y.js";const h={title:"COMPONENTS/Content Card",parameters:{badges:[d.DONE],docs:{page:u}},argTypes:{columnCount:{table:{category:"Content card settings"},name:"Column count",description:"Number of columns",options:[1,2,3,4],control:{type:"radio"},required:!0},cardVariant:{table:{category:"Content card settings",defaultValue:{summary:"default"}},name:"Card variant",description:"Set the content  card element design",options:["default","primary","secondary","inverted"],control:{type:"radio"},required:!0},hasLink:{table:{category:"Content card settings",defaultValue:{summary:"default"}},name:"Has link",description:"Set a link for the card",control:{type:"boolean"},required:!0}},tags:["autodocs"]},l=e=>{const r=document.createElement("toujou-content-card-grid");r.classList.add("content-card-grid");for(let a=0;a<e.columnCount;a++){const t=document.createElement(e.hasLink?"a":"toujou-content-card");t.classList.add("content-card"),t.setAttribute("card-variant",e.cardVariant),t.setAttribute("card-direction","vertical"),t.setAttribute("role","article"),e.hasLink&&t.setAttribute("href","#"),t.innerHTML=`
        ...
        `,r.appendChild(t)}const c=document.createElement("main");return c.appendChild(r),c},n=l.bind({});n.args={columnCount:4,cardVariant:"default",hasLink:!1};var i,o,s;n.parameters={...n.parameters,docs:{...(i=n.parameters)==null?void 0:i.docs,source:{originalSource:`(args: ContentCardStoryProps) => {
  ...
  return mainEl;
}`,...(s=(o=n.parameters)==null?void 0:o.docs)==null?void 0:s.source}}};const b=["VerticalContentCard"];export{n as VerticalContentCard,b as __namedExportsOrder,h as default};
