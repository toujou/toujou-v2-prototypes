import{r as n}from"./_renderCardCategoriChips-D3lhH8UM.js";const c={title:"COMPONENTS/CollectionCards",argTypes:{elementDesign:{table:{category:"Toujou card settings",defaultValue:{summary:"default"}},name:"Element Design",description:"Choose element design for the cards",options:["default","primary","secondary","inverted"],control:{type:"radio"},required:!0}}},s=e=>`
        <main>
    ...
    `,i=s.bind({});i.args={elementDesign:"default"};var t,l,o;i.parameters={...i.parameters,docs:{...(t=i.parameters)==null?void 0:t.docs,source:{originalSource:`(args: ToujouCardStoryProps) => {
  return \`
        <main>
            <ul class="card-collection">
                <li class="card-collection__item">
    ...
    \`;
}`,...(o=(l=i.parameters)==null?void 0:l.docs)==null?void 0:o.source}}};const r=["CardJob"];export{i as CardJob,r as __namedExportsOrder,c as default};
