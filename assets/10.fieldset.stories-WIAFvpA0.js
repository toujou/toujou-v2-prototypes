const u={title:"COMPONENTS/Forms",argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},required:!0}}},o=e=>{const s=e.state==="disabled"?"disabled":"";return`
        <style>
            body {
    ...
    `},t=o.bind({});t.args={state:"default"};var r,i,a;t.parameters={...t.parameters,docs:{...(r=t.parameters)==null?void 0:r.docs,source:{originalSource:`(args: ToujouFieldsetStoryProps) => {
  ...
  return \`
    ...
    \`;
}`,...(a=(i=t.parameters)==null?void 0:i.docs)==null?void 0:a.source}}};const p=["Fieldset"];export{t as Fieldset,p as __namedExportsOrder,u as default};
