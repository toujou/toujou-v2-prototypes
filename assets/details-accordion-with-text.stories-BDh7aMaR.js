const l={title:"COMPONENTS/Accordion",argTypes:{columnsLayout:{table:{category:"Grid settings",defaultValue:{summary:"third-right"}},name:"Two columns layout",description:"Define layout of the grid columns",options:["third-right","third-left"],control:{type:"radio"},required:!0},elementDesign:{table:{category:"Details Settings",defaultValue:{summary:"default"}},name:"Accordion element design",description:"Set the element design for the accordion element",options:["default","primary","secondary","inverted"],control:{type:"radio"},required:!0}}};function o(i){return`
    ...
    `,e=u.bind({});e.args={columnsLayout:"third-right",elementDesign:"default"};var s,n,a;e.parameters={...e.parameters,docs:{...(s=e.parameters)==null?void 0:s.docs,source:{originalSource:`(args: DetailsAccordionStoryProps) => {
  return \`
        <main>
    ...
    \`;
}`,...(a=(n=e.parameters)==null?void 0:n.docs)==null?void 0:a.source}}};const d=["DetailsAccordionWithText"];export{e as DetailsAccordionWithText,d as __namedExportsOrder,l as default};
