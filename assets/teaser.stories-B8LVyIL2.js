const n={title:"COMPONENTS/Teaser",argTypes:{teaserType:{table:{category:"Teaser settings",defaultValue:{summary:"cinema"}},name:"Teaser type",description:"Choose the teaser type",options:["cinema","media"],control:{type:"radio"},required:!0},imageWidth:{table:{category:"Teaser settings",defaultValue:{summary:"50"}},name:"Image width",description:"Choose the teaser's image width",options:["50","33","66"],control:{type:"radio"},required:!0},imageSide:{table:{category:"Teaser settings",defaultValue:{summary:"left"}},name:"Image side",description:"Choose the teaser's image side",options:["left","right"],control:{type:"radio"},required:!0},elementDesign:{table:{category:"Teaser settings",defaultValue:{summary:"default"}},name:"Element design",description:"Choose the teaser's element design",options:["default","primary","secondary","inverted"],control:{type:"radio"},required:!0}}},s=o=>`
    ...
    `,e=s.bind({});e.args={teaserType:"cinema",imageWidth:"50",imageSide:"left",elementDesign:"default"};var t,i,a;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`(args: ToujouImageCardStoryProps) => {
  return \`
        <main>
    ...
    \`;
}`,...(a=(i=e.parameters)==null?void 0:i.docs)==null?void 0:a.source}}};const r=["Teaser"];export{e as Teaser,r as __namedExportsOrder,n as default};
