import{T as d}from"./badgeCustomConfig-DUXiHpL4.js";import{j as s}from"./jsx-runtime-CS_Wz6c_.js";import{useMDXComponents as o}from"./index-C8FVCAkB.js";import"./index-Dy2Ak0OH.js";import"./_commonjsHelpers-Cpj98o6Y.js";function a(i){const e={a:"a",code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",...o(),...i.components};return s.jsxs(s.Fragment,{children:[s.jsx(e.h1,{id:"teaser-slider",children:"teaser slider"}),`
...
`})}),`
`,s.jsxs(e.p,{children:["| For more information about the slider element, please refer to the ",s.jsx(e.a,{href:"/docs/components-media--slider",children:"Slider docs"})]})]})}function c(i={}){const{wrapper:e}={...o(),...i.components};return e?s.jsx(e,{...i,children:s.jsx(a,{...i})}):a(i)}const v={title:"COMPONENTS/Teaser",parameters:{badges:[d.DONE],docs:{page:c}},argTypes:{teaserDirection:{table:{category:"Teaser slider settings",defaultValue:{summary:"right"}},name:"Teaser direction",description:"Choose the teaser direction",options:["right","left"],control:{type:"radio"},defaultValue:["right"],required:!0}},tags:["autodocs"]},u=i=>{const e=i.teaserDirection==="right"?"left":"right";return`
        <main>
            <toujou-slider
                class="slider"
                aria-label="Toujou slider example"
    ...
    `},t=u.bind({});t.args={teaserDirection:"right"};var r,l,n;t.parameters={...t.parameters,docs:{...(r=t.parameters)==null?void 0:r.docs,source:{originalSource:`(args: ToujouTeaserSliderProps) => {
  ...
  return \`
    ...
    \`;
}`,...(n=(l=t.parameters)==null?void 0:l.docs)==null?void 0:n.source}}};const f=["TeaserSlider"];export{t as TeaserSlider,f as __namedExportsOrder,v as default};
