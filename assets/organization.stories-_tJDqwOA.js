import{j as s}from"./jsx-runtime-BjG_zV1W.js";import{useMDXComponents as r}from"./index-BBg64T0F.js";import"./iframe-BVsh7E0O.js";import"./preload-helper-C1FmrZbK.js";function o(n){const a={h1:"h1",...r(),...n.components};return s.jsx(a.h1,{id:"organization-page",children:"Organization page"})}function l(n={}){const{wrapper:a}={...r(),...n.components};return a?s.jsx(a,{...n,children:s.jsx(o,{...n})}):o(n)}const g={title:"PAGES/Organization",parameters:{docs:{page:l},layout:"fullwidth"}},u=()=>`
        <div class="fragment">
    ...
    `,e=u.bind({});var i,t,c;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:`() => {
  return \`
        <div class="fragment">
            <section class="chapter chapter--background fragment__section">
                <toujou-text-block class="text-block" text-block-column-count="1">
    ...
    \`;
}`,...(c=(t=e.parameters)==null?void 0:t.docs)==null?void 0:c.source}}};const f=["OrganizationNoContent"];export{e as OrganizationNoContent,f as __namedExportsOrder,g as default};
