import{M as i}from"./form.docs-ZpXmT7H-.js";import"./jsx-runtime-BjG_zV1W.js";import"./index-C699k9hs.js";import"./iframe-Cb7BSVq4.js";import"./preload-helper-C1FmrZbK.js";const b={title:"COMPONENTS/Forms",parameters:{docs:{page:i}},argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},required:!0}}},d=r=>{const e=r.state==="disabled"?"disabled":"";return`
        <style>
            body {
