const e={title:"COMPONENTS/Code Block",argTypes:{showLanguageTag:{table:{category:"Code block Settings",defaultValue:{summary:"true"}},name:"Show the language tag",description:"Show or hide the language tag",control:{type:"boolean"},required:!0}}},c=a=>`
...
<span class="hljs-tag">&lt;/<span class="hljs-name">html</span>&gt;</span></code>
    ...
    `,s=c.bind({});s.args={showLanguageTag:!1};var n,l,p;s.parameters={...s.parameters,docs:{...(n=s.parameters)==null?void 0:n.docs,source:{originalSource:`(args: CodeBlockStoryProps) => {
  return \`
        <toujou-code-block class="code-block">
            <pre class="code-block__pre">        <code class="code-block__code hljs javascript"><span class="hljs-comment">/* This is a comment */</span>
<span class="hljs-keyword">const</span> name = <span class="hljs-string">'Luke Skywalker'</span>;
...
<span class="hljs-tag">&lt;/<span class="hljs-name">html</span>&gt;</span></code>
    ...
    \`;
}`,...(p=(l=s.parameters)==null?void 0:l.docs)==null?void 0:p.source}}};const t=["CodeBlock"];export{s as CodeBlock,t as __namedExportsOrder,e as default};
