const u={title:"COMPONENTS/Forms",argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},required:!0}}},c=e=>{const t=e.state==="disabled"?"disabled":"";return`
        <style>
            body {
    ...
    `},o=c.bind({});o.args={state:"default"};var s,r,a;o.parameters={...o.parameters,docs:{...(s=o.parameters)==null?void 0:s.docs,source:{originalSource:`(args: ToujouCheckboxStoryProps) => {
  ...
  return \`
    ...
    \`;
}`,...(a=(r=o.parameters)==null?void 0:r.docs)==null?void 0:a.source}}};const i=["CheckboxInputs"];export{o as CheckboxInputs,i as __namedExportsOrder,u as default};
