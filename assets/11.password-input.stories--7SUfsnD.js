const i={title:"COMPONENTS/Forms",argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},required:!0}}},r=o=>{const s=o.state==="disabled"?"disabled":"";return`
        <style>
            body {
    ...
    `},t=r.bind({});t.args={state:"default"};var a,e,n;t.parameters={...t.parameters,docs:{...(a=t.parameters)==null?void 0:a.docs,source:{originalSource:`(args: ToujouTextInputsStoryProps) => {
  ...
  return \`
    ...
    \`;
}`,...(n=(e=t.parameters)==null?void 0:e.docs)==null?void 0:n.source}}};const u=["PasswordInput"];export{t as PasswordInput,u as __namedExportsOrder,i as default};
