import{T as u}from"./badgeCustomConfig-e7a687d5.js";import{j as t}from"./jsx-runtime-ac05983f.js";import{u as l}from"./index-a9a8c754.js";import"./index-e0ddb630.js";import"./_commonjsHelpers-87174ba5.js";function i(e){const o=Object.assign({h1:"h1",p:"p",ul:"ul",li:"li"},l(),e.components);return t.jsxs(t.Fragment,{children:[t.jsx(o.h1,{id:"blog-post",children:"Blog post"}),`
...
`]})]})}function r(e={}){const{wrapper:o}=Object.assign({},l(),e.components);return o?t.jsx(o,Object.assign({},e,{children:t.jsx(i,e)})):i(e)}const f={title:"PAGES/BlogPost",parameters:{badges:[u.DONE],docs:{page:r}},argTypes:{hasAvatar:{table:{category:"Blog post Settings",defaultValue:{summary:"true"}},name:"Author has avatar",description:"Toggle between a post page where author avatar is or isn't available",control:{type:"boolean"},defaultValue:["true"],required:!0}}},m=e=>(console.log(e),`
        <div class="blog-post">
            <section>
...
//# sourceMappingURL=blog-post.stories-983fdb4a.js.map
