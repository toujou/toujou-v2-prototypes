const r={title:"COMPONENTS/Button"},s=()=>`
    ...
    `,t=s.bind({});var o,n,a;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`() => {
  return \`
        <h3>Old (deprecated) button classes</h3>
        <p>To improve backwards compatibility (and compatibility with other extensions) we also support the older button classes, like <code>button--shadow</code></p>
        <br>
        ...
        <p><a href="/" class="button button--expanded button--font button--shadow">Button shadow font 100%</a></p>
    \`;
}`,...(a=(n=t.parameters)==null?void 0:n.docs)==null?void 0:a.source}}};const u=["OldButtons"];export{t as OldButtons,u as __namedExportsOrder,r as default};
