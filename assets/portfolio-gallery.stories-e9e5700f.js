import{T as d}from"./badgeCustomConfig-e7a687d5.js";import{j as i}from"./jsx-runtime-ccada58e.js";import{u as r}from"./index-4fb8b842.js";import"./photoswipe-lightbox-creator-46720809.js";import"./index-f1f749bf.js";import"./_commonjsHelpers-042e6b4d.js";function t(s){const e=Object.assign({h1:"h1",ul:"ul",li:"li",h2:"h2",pre:"pre",code:"code",h3:"h3",p:"p"},r(),s.components);return i.jsxs(i.Fragment,{children:[i.jsx(e.h1,{id:"portfolio-gallery",children:"Portfolio gallery"}),`
...
`,i.jsxs(e.p,{children:["The ",i.jsx(e.code,{children:"is-header"})," attribute must be added to the portfolio gallery element when it is displayed inside the header section of the page."]})]})}function c(s={}){const{wrapper:e}=Object.assign({},r(),s.components);return e?i.jsx(e,Object.assign({},s,{children:i.jsx(t,s)})):t(s)}const j={title:"COMPONENTS/Portfolio Gallery",parameters:{badges:[d.DONE],docs:{page:c},layout:"fullscreen"},tags:["autodocs"]},p=()=>`
    ...
    `,l=p.bind({});var o,a,n;l.parameters={...l.parameters,docs:{...(o=l.parameters)==null?void 0:o.docs,source:{originalSource:`() => {
  return \`
        <toujou-portfolio-gallery class="portfolio-gallery" id="test-portfolio" number-of-items="max" is-header lightbox-parent-id="1">
            <toujou-slider
                slot="slider"
    ...
    \`;
}`,...(n=(a=l.parameters)==null?void 0:a.docs)==null?void 0:n.source}}};const f=["PortfolioGallery"];export{l as PortfolioGallery,f as __namedExportsOrder,j as default};
//# sourceMappingURL=portfolio-gallery.stories-e9e5700f.js.map
