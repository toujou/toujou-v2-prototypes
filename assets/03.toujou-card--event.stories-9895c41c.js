import{T as n}from"./badgeCustomConfig-e7a687d5.js";import{M as s}from"./toujou-collection-item.docs-70b39a13.js";import"./jsx-runtime-ccada58e.js";import"./index-f1f749bf.js";import"./_commonjsHelpers-042e6b4d.js";import"./index-4fb8b842.js";const p={title:"COMPONENTS/Collections",parameters:{badges:[n.DONE],docs:{page:s}},argTypes:{elementDesign:{table:{category:"Toujou card settings",defaultValue:{summary:"default"}},name:"Element Design",description:"Choose element design for the cards",options:["default","primary","secondary","inverted"],control:{type:"radio"},defaultValue:["default"],required:!0}},tags:["autodocs"]},c=i=>`
    ...
    `,e=c.bind({});e.args={elementDesign:"default"};var t,a,o;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`(args: ToujouCardStoryProps) => {
  return \`
        <ul class="card-collection">
            <li class="card-collection__item">
    ...
    \`;
}`,...(o=(a=e.parameters)==null?void 0:a.docs)==null?void 0:o.source}}};const h=["CardEvent"];export{e as CardEvent,h as __namedExportsOrder,p as default};
//# sourceMappingURL=03.toujou-card--event.stories-9895c41c.js.map
