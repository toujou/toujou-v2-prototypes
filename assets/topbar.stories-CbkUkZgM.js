const p={title:"COMPONENTS/Topbar",parameters:{layout:"fullscreen"},argTypes:{navigationColor:{table:{category:"Topbar settings",defaultValue:{summary:"default"}},name:"Navigation color",description:"Set the navigation color",options:["default","primary","secondary","font"],control:{type:"radio"},required:!0},titleType:{table:{category:"Topbar settings",defaultValue:{summary:"logo"}},name:"Mobile page title type",description:"Toggle between logo or text for the topbar page title on mobile devices",options:["logo","title"],control:{type:"radio"},required:!0},logoSize:{table:{category:"Topbar settings",defaultValue:{summary:"medium"}},name:"Logo size",description:"Set the logo size",options:["small","medium","large"],control:{type:"radio"},required:!0},noTransitions:{table:{category:"Topbar settings",defaultValue:{summary:"false"}},name:"No transitions",description:"Remove the transition from the topbar elements",control:{type:"boolean"},required:!0},languagePickerType:{table:{category:"Topbar settings"},name:"Language picker type",description:"Choose which type of language picker to show",options:["none","inline","dropdown"],control:{type:"radio"},required:!0},openOnHover:{table:{category:"Topbar settings",defaultValue:{summary:"false"}},name:"Open sub-nav on hover",description:"Choose whether or not a mouseenter/mouseleave event will trigger toggling the sub-nav",control:{type:"boolean"},required:!0}}},l=a=>`
    ...
    `,u=a=>`
        <nav id="mainNavigation" class="main-nav" aria-label="Main navigation" ${a?"data-is-open-on-hover":""}>
    ...
    `,_=a=>(document.documentElement.setAttribute("navigation-color",a.navigationColor),`
        <toujou-topbar
            id="topbar"
            class="topbar"
        ...
        ${d()}
    `),e=_.bind({});e.args={navigationColor:"default",titleType:"logo",logoSize:"medium",noTransitions:!1,languagePickerType:"inline",openOnHover:!1};var i,n,t;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:`(args: TopbarStoryProps) => {
  ...
  return \`
        ...
        \${renderDummyContent()}
    \`;
}`,...(t=(n=e.parameters)==null?void 0:n.docs)==null?void 0:t.source}}};const v=["Topbar"];export{e as Topbar,v as __namedExportsOrder,p as default};
