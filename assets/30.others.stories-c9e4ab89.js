import{T as r}from"./badgeCustomConfig-e7a687d5.js";import{M as u}from"./form.docs-97b78f8d.js";import"./jsx-runtime-ac05983f.js";import"./index-e0ddb630.js";import"./_commonjsHelpers-87174ba5.js";import"./index-a9a8c754.js";const f={title:"COMPONENTS/Forms",parameters:{badges:[r.DONE],docs:{page:u}},argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},defaultValue:["default"],required:!0}},tags:["autodocs"]},p=t=>{const s=t.state==="disabled"?"disabled":"";return`
        <style>
            body {
    ...
    `},e=p.bind({});e.args={state:"default"};var o,i,a;e.parameters={...e.parameters,docs:{...(o=e.parameters)==null?void 0:o.docs,source:{originalSource:`(args: ToujouOtherInputStoryProps) => {
  ...
  return \`
    ...
    \`;
}`,...(a=(i=e.parameters)==null?void 0:i.docs)==null?void 0:a.source}}};const b=["OtherInputs"];export{e as OtherInputs,b as __namedExportsOrder,f as default};
//# sourceMappingURL=30.others.stories-c9e4ab89.js.map
