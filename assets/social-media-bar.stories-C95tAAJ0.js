import{T as t}from"./badgeCustomConfig-DUXiHpL4.js";import{j as i}from"./jsx-runtime-CS_Wz6c_.js";import{useMDXComponents as r}from"./index-C8FVCAkB.js";import"./index-Dy2Ak0OH.js";import"./_commonjsHelpers-Cpj98o6Y.js";function o(a){const e={blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...r(),...a.components};return i.jsxs(i.Fragment,{children:[i.jsx(e.h1,{id:"social-media-bar",children:"Social media bar"}),`
...
`})})]})}function d(a={}){const{wrapper:e}={...r(),...a.components};return e?i.jsx(e,{...a,children:i.jsx(o,{...a})}):o(a)}const x={title:"COMPONENTS/Social Media Bar",parameters:{badges:[t.DONE],docs:{page:d}},argTypes:{elementDesign:{table:{category:"Social media bar settings",defaultValue:{summary:"default"}},name:"Element design",description:"Set the social media bar's design color",options:["default","primary","secondary","inverted"],control:{type:"radio"},defaultValue:["default"],required:!0},hideHeadline:{table:{category:"Social media bar settings",defaultValue:{summary:!1}},name:"Hide headline",description:"Hide the social media bar's headline",control:{type:"boolean"},defaultValue:[!1],required:!0},isInline:{table:{category:"Social media bar settings",defaultValue:{summary:!1}},name:'Add the "inline" attribute',description:'Adding the "inline" attribute allows us to place the social-media-bar inside other elements',control:{type:"boolean"},defaultValue:[!1],required:!0}},tags:["autodocs"]},u=a=>{const e=a.isInline?"xl":"xxl";return`
     ...
     `},n=u.bind({});n.args={elementDesign:"default",hideHeadline:!1,isInline:!1};var l,c,s;n.parameters={...n.parameters,docs:{...(l=n.parameters)==null?void 0:l.docs,source:{originalSource:`(args: SliderStoryProps) => {
  ...
  return \`
     ...
     \`;
}`,...(s=(c=n.parameters)==null?void 0:c.docs)==null?void 0:s.source}}};const f=["SocialMediaBar"];export{n as SocialMediaBar,f as __namedExportsOrder,x as default};
