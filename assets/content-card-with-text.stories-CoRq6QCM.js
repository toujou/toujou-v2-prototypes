import{M as u}from"./content-card-with-text.docs-CGfCSPUD.js";import"./jsx-runtime-BjG_zV1W.js";import"./index-v-F0Z1jV.js";import"./iframe-BAfj2k-n.js";import"./preload-helper-C1FmrZbK.js";const h={title:"COMPONENTS/Content Card",parameters:{docs:{page:u}},argTypes:{direction:{table:{category:"Content card settings",defaultValue:{summary:"left"}},name:"Direction",description:"Set the column where the text will be shown",options:["left","right"],control:{type:"radio"},required:!0}},tags:["autodocs"]};function i(){return`
