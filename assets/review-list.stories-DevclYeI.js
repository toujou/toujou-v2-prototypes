...
`,i.jsx(t.p,{children:"Each review card can also show a comment from the website owner."})]})}function u(e={}){const{wrapper:t}={...c(),...e.components};return t?i.jsx(t,{...e,children:i.jsx(n,{...e})}):n(e)}const g={title:"COMPONENTS/Review List",parameters:{docs:{page:u},args:{showPagination:{table:{category:"review List Settings"},name:"Show pagination",description:"Show the review list pagination element",control:{type:"boolean"},required:!0}}}},o=e=>`
        <div class="reviews">
    ...
    `,a=p.bind({});a.args={showPagination:!1};var s,r,l;a.parameters={...a.parameters,docs:{...(s=a.parameters)==null?void 0:s.docs,source:{originalSource:`(args: ReviewListProps) => {
  return \`
        <main>
    ...
    \`;
}`,...(l=(r=a.parameters)==null?void 0:r.docs)==null?void 0:l.source}}};const b=["ReviewList"];export{a as ReviewList,b as __namedExportsOrder,g as default};
