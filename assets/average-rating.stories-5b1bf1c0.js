...
`})})]})}function c(t={}){const{wrapper:e}={...o(),...t.components};return e?a.jsx(e,{...t,children:a.jsx(r,{...t})}):r(t)}const m={title:"COMPONENTS/Reviews/Average Rating",parameters:{badges:[l.DONE],docs:{page:c}},argTypes:{showMaxRating:{table:{category:"Average rating settings",defaultValue:{summary:"false"}},name:"Show rating max value",description:"Show the maximum possible value for the ratings",control:{type:"boolean"},defaultValue:["false"],required:!0}},tags:["autodocs"]},v=t=>`
    ...
    `,n=v.bind({});n.args={showMaxRating:!1};var s,i,g;n.parameters={...n.parameters,docs:{...(s=n.parameters)==null?void 0:s.docs,source:{originalSource:`(args: AverageRatingProps) => {
  return \`
        <div class="average-rating">
            <h3 class="average-rating__title">This is the average rating header</h3>
            <p class="average-rating__text">This is the average rating content element custom text</p>
    ...
    \`;
}`,...(g=(i=n.parameters)==null?void 0:i.docs)==null?void 0:g.source}}};const x=["AverageRating"];export{n as AverageRating,x as __namedExportsOrder,m as default};
