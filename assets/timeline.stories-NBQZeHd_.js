const s={title:"COMPONENTS/Timeline",argTypes:{direction:{table:{category:"Timeline Settings",defaultValue:{summary:"vertical"}},name:"Timeline direction",description:"Choose between a vertical or horizontal timeline",options:["vertical","horizontal"],control:{type:"radio"},required:!0},elementDesign:{table:{category:"Timeline Settings",defaultValue:{summary:"default"}},name:"Timeline element design",description:"Set the element design for the timeline element",options:["default","primary","secondary","inverted"],control:{type:"radio"},required:!0},showLegend:{table:{category:"Timeline settings",defaultValue:{summary:"false"}},name:"Show legend",description:"Show the legend element",control:{type:"boolean"},required:!0}}},a=i=>`
    ...
    `,e=a.bind({});e.args={direction:"vertical",elementDesign:"default",showLegend:!1};var t,l,n;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`(args: TimelineStoryProps) => {
  return \`
        <main>
            <toujou-timeline
                class="timeline"
    ...
    \`;
}`,...(n=(l=e.parameters)==null?void 0:l.docs)==null?void 0:n.source}}};const o=["Timeline"];export{e as Timeline,o as __namedExportsOrder,s as default};
