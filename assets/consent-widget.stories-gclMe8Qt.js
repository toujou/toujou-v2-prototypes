import{T as a}from"./badgeCustomConfig-DUXiHpL4.js";import{M as i}from"./consent.docs-C5VEeCak.js";import"./jsx-runtime-BjG_zV1W.js";import"./index-BcJeOPUZ.js";import"./index-B6tQ6Rz7.js";import"./_commonjsHelpers-Cpj98o6Y.js";const m={title:"COMPONENTS/Consent",parameters:{badges:[a.DONE],docs:{page:i}},argTypes:{design:{table:{category:"Consent Settings",defaultValue:{summary:"default"}},name:"Element design",description:"Set the consent element design",options:["default","primary","secondary","inverted"],control:{type:"select"},defaultValue:["primary"],required:!0}}},u=s=>(window.addEventListener("click",c=>{c.target.getAttribute("id")==="clearConsentsButton"&&(localStorage.removeItem("consentsState"),document.location.reload())}),`
        <main>
