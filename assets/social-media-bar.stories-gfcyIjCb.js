...
`})})]})}function d(a={}){const{wrapper:e}={...r(),...a.components};return e?i.jsx(e,{...a,children:i.jsx(o,{...a})}):o(a)}const x={title:"COMPONENTS/Social Media Bar",parameters:{badges:[t.DONE],docs:{page:d}},argTypes:{elementDesign:{table:{category:"Social media bar settings",defaultValue:{summary:"default"}},name:"Element design",description:"Set the social media bar's design color",options:["default","primary","secondary","inverted"],control:{type:"radio"},required:!0},hideHeadline:{table:{category:"Social media bar settings"},name:"Hide headline",description:"Hide the social media bar's headline",control:{type:"boolean"},required:!0},isInline:{table:{category:"Social media bar settings"},name:'Add the "inline" attribute',description:'Adding the "inline" attribute allows us to place the social-media-bar inside other elements',control:{type:"boolean"},required:!0}},tags:["autodocs"]},u=a=>{const e=a.isInline?"xl":"xxl";return`
  ...
  return \`
     ...
     \`;
}`,...(s=(l=n.parameters)==null?void 0:l.docs)==null?void 0:s.source}}};const g=["SocialMediaBar"];export{n as SocialMediaBar,g as __namedExportsOrder,x as default};
