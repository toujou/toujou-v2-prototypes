import{T as o}from"./badgeCustomConfig-DUXiHpL4.js";import{M as u}from"./form.docs-DkrseQBQ.js";import"./jsx-runtime-BjG_zV1W.js";import"./index-BcJeOPUZ.js";import"./index-B6tQ6Rz7.js";import"./_commonjsHelpers-Cpj98o6Y.js";const f={title:"COMPONENTS/Forms",parameters:{badges:[o.DONE],docs:{page:u}},argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},defaultValue:["default"],required:!0}}},p=e=>{const s=e.state==="disabled"?"disabled":"";return`
        <style>
            body {
    ...
    `},t=p.bind({});t.args={state:"default"};var r,i,a;t.parameters={...t.parameters,docs:{...(r=t.parameters)==null?void 0:r.docs,source:{originalSource:`(args: ToujouFieldsetStoryProps) => {
  ...
  return \`
    ...
    \`;
}`,...(a=(i=t.parameters)==null?void 0:i.docs)==null?void 0:a.source}}};const b=["Fieldset"];export{t as Fieldset,b as __namedExportsOrder,f as default};
