import{T as l}from"./badgeCustomConfig-DUXiHpL4.js";import{M as u}from"./form.docs-Dn0kwJ_D.js";import"./jsx-runtime-BjG_zV1W.js";import"./index-DpH9cx3q.js";import"./index-DO8khQO4.js";import"./_commonjsHelpers-Cpj98o6Y.js";const m={"YYYY.MM.DD":"Y.m.d","YYYY/MM/DD":"Y/m/d","DD.MM.YYYY":"d.m.Y","DD/MM/YYYY":"d/m/Y"},p={single:"single",range:"range"},M={title:"COMPONENTS/Forms",parameters:{badges:[l.DONE],docs:{page:u}},argTypes:{dateFormat:{name:"Date format",description:"Set the date format",options:Object.values(m),control:{type:"radio"},required:!0},minDate:{name:"Earliest date",description:"Earliest selectable date",control:{type:"date"}},maxDate:{name:"Latest date",description:"Latest selectable date",control:{type:"date"}},showTime:{name:"Show time",description:"Show time on the datepicker",control:{type:"boolean"},required:!0},type:{name:"Type",description:"Set the input type",options:Object.values(p),control:{type:"radio"},required:!0}}};function r(e){if(isNaN(e))return"";const t=new Date(e);if(isNaN(t.getTime()))return"";const o=t.getFullYear(),c=(t.getMonth()+1).toString().padStart(2,"0"),d=t.getDate().toString().padStart(2,"0");return`${o}-${c}-${d}`}const D=e=>{console.log("minDate",e.minDate);const t=r(e.minDate);console.log("maxDate",e.maxDate);const o=r(e.maxDate);return`
