...
`})})]})}function _(s={}){const{wrapper:a}={...h(),...s.components};return a?e.jsx(a,{...s,children:e.jsx(t,{...s})}):t(s)}const y={title:"COMPONENTS/EventSchedule",parameters:{badges:[r.DONE],docs:{page:_}},tags:["autodocs"]},c=()=>`
    ...
    `,l=p.bind({});var n,d,i;l.parameters={...l.parameters,docs:{...(n=l.parameters)==null?void 0:n.docs,source:{originalSource:`() => {
  return \`
    ...
    \`;
}`,...(i=(d=l.parameters)==null?void 0:d.docs)==null?void 0:i.source}}};const f=["EventSchedule"];export{l as EventSchedule,f as __namedExportsOrder,y as default};
