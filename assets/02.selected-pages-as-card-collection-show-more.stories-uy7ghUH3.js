import{r as c}from"./_renderCardCategoriChips-D3lhH8UM.js";const n={title:"COMPONENTS/SelectedPages",argTypes:{isLoading:{table:{category:"Load more button settings"},name:"Is Loading",description:"Fake the 'isLoading' state on the button",control:{type:"boolean"},required:!0}}},s=l=>`
        <main>
    ...
    `,e=s.bind({});e.args={isLoading:!1};var t,i,o;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`(args: SelectedPagesAsCardCollectionShowMoreProps) => {
  return \`
        <main>
            <h1>Selected Pages as card collection - "show more" button</h1>
            <ul class="card-collection">
    ...
    \`;
}`,...(o=(i=e.parameters)==null?void 0:i.docs)==null?void 0:o.source}}};const r=["SelectedPagesAsCardCollectionShowMore"];export{e as SelectedPagesAsCardCollectionShowMore,r as __namedExportsOrder,n as default};
