const n={title:"COMPONENTS/Header",parameters:{layout:"fullscreen"},argTypes:{imageHeight:{table:{category:"Header Settings",defaultValue:{summary:"default"}},name:"Header image height",description:"Set the header image height",options:["default","full","half","quarter","3-1"],control:{type:"select"},required:!0},headerVerticalPos:{table:{category:"Header Settings",defaultValue:{summary:"default"}},name:"Header vertical position",description:"Set the header's vertical position",options:["top","mid","bottom"],control:{type:"select"},required:!0},headerHorizontalPos:{table:{category:"Header Settings",defaultValue:{summary:"default"}},name:"Header horizontal position",description:"Set the header's horizontal position",options:["left","center","right"],control:{type:"select"},required:!0},headerContentSize:{table:{category:"Header Settings",defaultValue:{summary:"default"}},name:"Header content size",description:"Set the header's content width",options:["full","half","third","quarter"],control:{type:"select"},required:!0},accentColor:{table:{category:"Header Settings",defaultValue:{summary:"default"}},name:"Accent color",description:"Set the header's accent color",options:["default","primary","secondary","font"],control:{type:"select"},required:!0},contentAlignment:{table:{category:"Header Settings",defaultValue:{summary:"default"}},name:"Content alignment",description:"Set the header's content alignment",options:["default","left","center","right"],control:{type:"select"},required:!0}}},l=e=>`
        <header class="header" image-height="${e.imageHeight}" header-type="slider">
                                ...
                                <div class="slider__item" slot="slider-item">
                                    ...
                                    <div class="header__content">
                                        <div class="header-content"
                                            ...
                                            text-alignment="${e.contentAlignment}">
                                            <h3>Slide 1.</h3>
                                            ...
                                            <button is="toujou-button" class="button" button-variant="${e.accentColor}" button-type="default" button-size="normal">Hello world</button>
                                        </div>
                                    </div>
                                </div>
                            </li>
    ...
    `,t=l.bind({});t.args={imageHeight:"default",headerVerticalPos:"mid",headerHorizontalPos:"center",headerContentSize:"half",accentColor:"default",contentAlignment:"default"};var i,s,o;t.parameters={...t.parameters,docs:{...(i=t.parameters)==null?void 0:i.docs,source:{originalSource:`(args: HeaderSliderStoryProps) => {
  return \`
    ...
    \`;
}`,...(o=(s=t.parameters)==null?void 0:s.docs)==null?void 0:o.source}}};const a=["HeaderSlider"];export{t as HeaderSlider,a as __namedExportsOrder,n as default};
