import{M as d}from"./content-card.docs-CdUV_WYc.js";import"./jsx-runtime-BjG_zV1W.js";import"./index-DUOVsmoo.js";import"./iframe-BcYeAK1P.js";import"./preload-helper-C1FmrZbK.js";const f={title:"COMPONENTS/Content Card",parameters:{docs:{page:d}},argTypes:{columnCount:{table:{category:"Content card settings"},name:"Column count",description:"Number of columns",options:[1,2,3,4],control:{type:"radio"},required:!0},cardVariant:{table:{category:"Content card settings",defaultValue:{summary:"default"}},name:"Card variant",description:"Set the content  card element design",options:["default","primary","secondary","inverted"],control:{type:"radio"},required:!0},hasLink:{table:{category:"Content card settings",defaultValue:{summary:"default"}},name:"Has link",description:"Set a link for the card",control:{type:"boolean"},required:!0}},tags:["autodocs"]},u=e=>{const r=document.createElement("toujou-content-card-grid");r.classList.add("content-card-grid");for(let a=0;a<e.columnCount;a++){const t=document.createElement(e.hasLink?"a":"toujou-content-card");t.classList.add("content-card"),t.setAttribute("card-variant",e.cardVariant),t.setAttribute("card-direction","vertical"),t.setAttribute("role","article"),e.hasLink&&t.setAttribute("href","#"),t.innerHTML=`
