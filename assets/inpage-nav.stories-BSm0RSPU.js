...
`]})]})}function m(t={}){const{wrapper:e}={...r(),...t.components};return e?i.jsx(e,{...t,children:i.jsx(s,{...t})}):s(t)}const j={title:"COMPONENTS/Inpage Nav",parameters:{badges:[u.DONE],docs:{page:m}},argTypes:{width:{table:{category:"Inpage nav width",defaultValue:{summary:"text"}},name:"Width",description:"Set the element's width",options:["text","wide","fullwidth"],control:{type:"radio"},required:!0},alignment:{table:{category:"Inpage nav settings",defaultValue:{summary:"left"}},name:"Alignment",description:"Set the Inpage nav alignment",options:["left","center"],control:{type:"radio"},required:!0},showLabel:{table:{category:"Inpage nav settings"},name:"Show label",description:"Toggle the label's visibility",control:{type:"boolean"},required:!0},showCTA:{table:{category:"Inpage nav settings"},name:"Show CTA",description:"Toggle the CTA button visibility",control:{type:"boolean"},required:!0},isSticky:{table:{category:"Inpage nav settings"},name:"Is sticky",description:"Should the inpage nav scroll with the content or stay sticky. PLease test on a page with a topbar and content",control:{type:"boolean"},required:!0},elementDesign:{table:{category:"Inpage nav settings",defaultValue:{summary:"default"}},name:"Element design",description:"set the element design",options:["default","primary","secondary","inverted"],control:{type:"radio"},required:!0}}},d=[{id:"one",label:"Section One",bgColor:"primary-light"},{id:"two",label:"Section Two",bgColor:"secondary-light"},{id:"three",label:"Section three",bgColor:"font-light"}],c=t=>`
        <toujou-inpage-nav
            class="inpage-nav"
    ...
    `,n=h.bind({});n.args={width:"text",alignment:"left",showLabel:!0,showCTA:!0,isSticky:!1,elementDesign:"default"};var o,a,l;n.parameters={...n.parameters,docs:{...(o=n.parameters)==null?void 0:o.docs,source:{originalSource:`(args: InpageNavStoryProps) => {
  return \`
        <main>
    ...
    \`;
}`,...(l=(a=n.parameters)==null?void 0:a.docs)==null?void 0:l.source}}};const w=["InpageNav"];export{n as InpageNav,w as __namedExportsOrder,j as default};
