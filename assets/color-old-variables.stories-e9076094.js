const d={title:"TOKENS/Color",argTypes:{}},l=()=>`
    ...
    `,o=l.bind({});var r,s,e;o.parameters={...o.parameters,docs:{...(r=o.parameters)==null?void 0:r.docs,source:{originalSource:`() => {
  return \`
        <h1 class="tokens-demo__title">Old color variables (old themes)</h1>
        <p>We still need these variables because they are still used on some templates / extensions</p>
        <h2 class="tokens-demo__subtitle">Old color variables</h2>
    ...
    \`;
}`,...(e=(s=o.parameters)==null?void 0:s.docs)==null?void 0:e.source}}};const i=["ColorOldVariables"];export{o as ColorOldVariables,i as __namedExportsOrder,d as default};
//# sourceMappingURL=color-old-variables.stories-e9076094.js.map
