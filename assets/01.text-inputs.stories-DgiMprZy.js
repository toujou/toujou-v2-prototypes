const o={title:"COMPONENTS/Forms",argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},required:!0}}},u=e=>{const r=e.state==="disabled"?"disabled":"";return`
        <style>
            body {
    ...
    `},s=u.bind({});s.args={state:"default"};var t,i,a;s.parameters={...s.parameters,docs:{...(t=s.parameters)==null?void 0:t.docs,source:{originalSource:`(args: ToujouTextInputsStoryProps) => {
  ...
  return \`
    ...
    \`;
}`,...(a=(i=s.parameters)==null?void 0:i.docs)==null?void 0:a.source}}};const p=["TextInputs"];export{s as TextInputs,p as __namedExportsOrder,o as default};
