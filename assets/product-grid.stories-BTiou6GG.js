import{j as e}from"./jsx-runtime-BjG_zV1W.js";import{useMDXComponents as u}from"./index-C8UMMqGO.js";import"./iframe-DKUsPnHS.js";import"./preload-helper-C1FmrZbK.js";function c(r){const a={a:"a",code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",...u(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(a.h1,{id:"product-grid",children:"Product grid"}),`
...
`})})]})}function l(r={}){const{wrapper:a}={...u(),...r.components};return a?e.jsx(a,{...r,children:e.jsx(c,{...r})}):c(r)}const C={title:"COMPONENTS/Product Grid",parameters:{docs:{page:l}},argTypes:{imageFormat:{table:{category:"Product grid card settings",defaultValue:{summary:"16-9"}},name:"Image format",description:"Set the product grid cards image format",options:["16-9","square"],control:{type:"radio"},required:!0},cardVariant:{table:{category:"Product grid card settings",defaultValue:{summary:"default"}},name:"Card variant",description:"Set the product grid cards element design",options:["default","primary","secondary","inverted"],control:{type:"radio"},required:!0}},tags:["autodocs"]};function p(r,a){return`
  ...
  return mainEl;
}`,...(m=(s=t.parameters)==null?void 0:s.docs)==null?void 0:m.source}}};const b=["ProductGrid"];export{t as ProductGrid,b as __namedExportsOrder,C as default};
