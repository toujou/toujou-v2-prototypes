import{T as m}from"./badgeCustomConfig-DUXiHpL4.js";import{j as n}from"./jsx-runtime-CS_Wz6c_.js";import{useMDXComponents as d}from"./index-C8FVCAkB.js";import"./index-Dy2Ak0OH.js";import"./_commonjsHelpers-Cpj98o6Y.js";function l(e){const t={h1:"h1",...d(),...e.components};return n.jsx(t.h1,{id:"tourism-trip-description",children:"Tourism trip description"})}function p(e={}){const{wrapper:t}={...d(),...e.components};return t?n.jsx(t,{...e,children:n.jsx(l,{...e})}):l(e)}const v={title:"COMPONENTS/Tourism/Trip Description",parameters:{badges:[m.TESTING],docs:{page:p}},argTypes:{showDayDate:{table:{category:"Trip Description Settings",defaultValue:{summary:"false"}},name:"Show day date",description:"Show the date for each day",control:{type:"boolean"},required:!0}},tags:["autodocs"]},s=e=>`
    ...
    `,i=h.bind({});i.args={showDayDate:!1};var o,u,c;i.parameters={...i.parameters,docs:{...(o=i.parameters)==null?void 0:o.docs,source:{originalSource:`(args: TripDescriptionProps) => {
  return \`
        <main>
            <toujou-trip-description class="trip-description">
                <toujou-details-accordion class="details-accordion" is-trip-description>
