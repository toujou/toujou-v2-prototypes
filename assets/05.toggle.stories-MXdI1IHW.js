const i={title:"COMPONENTS/Forms",argTypes:{isDisabled:{table:{category:"Toggle settings",defaultValue:{summary:"false"}},name:"disabled",description:'Toggle the "disabled" attribute',control:{type:"boolean"},required:!0}}},a=o=>`
        <style>
            body {
    ...
    `,e=a.bind({});e.args={isDisabled:!1};var t,r,s;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`(args: ToujouToggleStoryProps) => {
  return \`
        <style>
            body {
                background-color: var(--color-bg);
    ...
    \`;
}`,...(s=(r=e.parameters)==null?void 0:r.docs)==null?void 0:s.source}}};const l=["ToggleInputs"];export{e as ToggleInputs,l as __namedExportsOrder,i as default};
