import{T as n}from"./badgeCustomConfig-e7a687d5.js";import{M as i}from"./form.docs-bd6a64bc.js";import"./jsx-runtime-2d96f316.js";import"./index-b6937ee2.js";import"./_commonjsHelpers-725317a4.js";import"./index-9d38a655.js";const g={title:"COMPONENTS/Forms",parameters:{badges:[n.DONE],docs:{page:i}},argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},defaultValue:["default"],required:!0}},tags:["autodocs"]},c=t=>{const r=t.state==="disabled"?"disabled":"";return`
        <style>
            body {
