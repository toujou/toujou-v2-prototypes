const l={title:"COMPONENTS/Accordion",argTypes:{elementDesign:{table:{category:"Details Settings",defaultValue:{summary:"default"}},name:"Accordion element design",description:"Set the element design for the accordion element",options:["default","primary","secondary","inverted"],control:{type:"radio"},required:!0}}},s=n=>`
        <toujou-details id="details-0" class="details" is-open="" element-design="${n.elementDesign}">
        ...
        <toujou-details id="details-1" class="details" element-design="${n.elementDesign}">
    ...
    `,e=s.bind({});e.args={elementDesign:"default"};var t,i,r;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`(args: DetailsStoryProps) => {
  return \`
    ...
    \`;
}`,...(r=(i=e.parameters)==null?void 0:i.docs)==null?void 0:r.source}}};const u=["Details"];export{e as Details,u as __namedExportsOrder,l as default};
