import{T as i}from"./badgeCustomConfig-DUXiHpL4.js";import{M as c}from"./form.docs-C5nnpWkB.js";import"./jsx-runtime-CS_Wz6c_.js";import"./index-Dy2Ak0OH.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-C8FVCAkB.js";const g={title:"COMPONENTS/Forms",parameters:{badges:[i.DONE],docs:{page:c}},argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},defaultValue:["default"],required:!0}},tags:["autodocs"]},l=t=>{const r=t.state==="disabled"?"disabled":"";return`
        <style>
            body {
