...
`]})]})}function p(n={}){const{wrapper:a}={...l(),...n.components};return a?e.jsx(a,{...n,children:e.jsx(o,{...n})}):o(n)}const _={title:"COMPONENTS/Map",parameters:{badges:[d.DONE],docs:{page:p}},argTypes:{direction:{table:{category:"Map Contact Settings",defaultValue:{summary:"normal"}},name:"Direction",description:"Set the element's direction",options:["normal","reverse"],control:{type:"radio"},defaultValue:["normal"],required:!0},mapAspectRatio:{table:{category:"Map Contact Settings",defaultValue:{summary:"1-1"}},name:"Map aspect ratio",description:"Set the map's aspect ration",options:["1-1","16-9"],control:{type:"radio"},defaultValue:["normal"],required:!0},elementDesign:{table:{category:"Map Contact Settings",defaultValue:{summary:"default"}},name:"Element design",description:"Set the design for the element",options:["default","primary","secondary","inverted"],control:{type:"radio"},defaultValue:["default"],required:!0}},tags:["autodocs"]},t=n=>`
  ...
  return \`
    ...
    \`;
}`,...(r=(s=c.parameters)==null?void 0:s.docs)==null?void 0:r.source}}};const g=["Map"];export{c as Map,g as __namedExportsOrder,_ as default};
