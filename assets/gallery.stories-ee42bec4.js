...
`]})]})}function r(i={}){const{wrapper:e}={...n(),...i.components};return e?t.jsx(e,{...i,children:t.jsx(a,{...i})}):a(i)}const x={title:"COMPONENTS/Media",parameters:{badges:[p.DONE],docs:{page:r}},argTypes:{},tags:["autodocs"]},c=()=>`
    ...
    `,s=c.bind({});var l,o,h;s.parameters={...s.parameters,docs:{...(l=s.parameters)==null?void 0:l.docs,source:{originalSource:`() => {
  return \`
        <toujou-gallery id="test-gallery" class="gallery" lightbox-parent-id="1">
            <a href="https://cdn.photoswipe.com/photoswipe-demo-images/photos/1/img-2500.jpg"
                data-pswp-width="1669"
    ...
    \`;
}`,...(h=(o=s.parameters)==null?void 0:o.docs)==null?void 0:h.source}}};const j=["Gallery"];export{s as Gallery,j as __namedExportsOrder,x as default};
