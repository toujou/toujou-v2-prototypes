import{r as t,a as i}from"./breadcrumb-example-BHVKmO5b.js";const p={title:"PAGES/DestinationOne",parameters:{layout:"fullwidth"},argTypes:{mapAspectRatio:{table:{category:"D1I POI Page Settings",defaultValue:{summary:"default"}},name:"Map Aspect Ratio",description:"Set the map's aspect ratio",options:["default","3-1"],control:{type:"radio"},required:!0}}},r=()=>`
    ...
    `,u=a=>`
       ${m(a)}
    `,e=u.bind({});e.args={mapAspectRatio:"default"};var s,n,o;e.parameters={...e.parameters,docs:{...(s=e.parameters)==null?void 0:s.docs,source:{originalSource:`(args: DestinationOnePoiProps) => {
  return \`
       \${renderMain(args)}
    \`;
}`,...(o=(n=e.parameters)==null?void 0:n.docs)==null?void 0:o.source}}};const _=["DestinationOnePoi"];export{e as DestinationOnePoi,_ as __namedExportsOrder,p as default};
