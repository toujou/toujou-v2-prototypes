import{T as u}from"./badgeCustomConfig-DUXiHpL4.js";import{j as n}from"./jsx-runtime-CS_Wz6c_.js";import{useMDXComponents as d}from"./index-C8FVCAkB.js";import"./index-Dy2Ak0OH.js";import"./_commonjsHelpers-Cpj98o6Y.js";function a(o){const e={code:"code",h1:"h1",h2:"h2",h4:"h4",hr:"hr",p:"p",pre:"pre",...d(),...o.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h1,{id:"snackbar",children:"snackbar"}),`
...
| --toujou-snackbar-info-button-color | Set `,n.jsx(e.code,{children:"color"})," of the ",n.jsx(e.code,{children:"toujou-snackbar[info] .snackbar__button"})," | white |"]})]})}function l(o={}){const{wrapper:e}={...d(),...o.components};return e?n.jsx(e,{...o,children:n.jsx(a,{...o})}):a(o)}const f={title:"COMPONENTS/Snackbar",parameters:{badges:[u.DONE],docs:{page:l}},argTypes:{snackbarVariant:{table:{category:"Snackbar settings",defaultValue:{summary:"info"}},name:"Snackbar variant",description:"Set the snackbar variant style",options:["info","success","warning","error"],control:{type:"radio"},defaultValue:["info"],required:!0},snackbarType:{table:{category:"Snackbar settings",defaultValue:{summary:"auto"}},name:"Snackbar type",description:"Set the snackbar type",options:["auto","action"],control:{type:"radio"},defaultValue:["auto"],required:!0},snackbarDuration:{table:{category:"Snackbar settings",defaultValue:{summary:4e3}},name:"Snackbar duration",description:"Set the snackbar visibility duration",control:{type:"number"},defaultValue:4e3,required:!0}},tags:["autodocs"]};function h(o,e,r){return new CustomEvent("toujou-add-snackbar",{bubbles:!0,composed:!0,detail:{message:"welcome to the bonus page!",type:e,buttonText:"ok",duration:r,variant:o}})}const b=o=>(window.addEventListener("click",e=>{const r=e.target;r.getAttribute("id")==="snackbarTriggerButton"&&r.dispatchEvent(h(o.snackbarVariant,o.snackbarType,o.snackbarDuration))}),`
    ...
    `),t=b.bind({});t.args={snackbarVariant:"info",snackbarType:"auto",snackbarDuration:4e3};var s,c,i;t.parameters={...t.parameters,docs:{...(s=t.parameters)==null?void 0:s.docs,source:{originalSource:`(args: SnackbarStoryProps) => {
  ...
  return \`
        ...
        <toujou-snackbar class="snackbar" visible aria-live="assertive" tabindex="-1"></toujou-snackbar>
    \`;
}`,...(i=(c=t.parameters)==null?void 0:c.docs)==null?void 0:i.source}}};const g=["Snackbar"];export{t as Snackbar,g as __namedExportsOrder,f as default};
