const s={title:"COMPONENTS/Header",parameters:{layout:"fullscreen"},argTypes:{headerSize:{table:{category:"Hero Media settings",defaultValue:{summary:"default"}},name:"Header size",description:"Choose header size",options:["default","alpha","beta","gamma","delta","epsilon","omega"],control:{type:"radio"},required:!0},headerAlignment:{table:{category:"Hero Media settings",defaultValue:{summary:"default"}},name:"Header alignment",description:"Choose header alignment",options:["default","center","right","left"],control:{type:"radio"},required:!0}}},n=o=>`
    ...
    `,e=n.bind({});e.args={headerSize:"default",headerAlignment:"default"};var a,i,t;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`(args: HeaderThreeToOneStoryProps) => {
  return \`
        <header class="header" image-height="3-1">
    ...
    \`;
}`,...(t=(i=e.parameters)==null?void 0:i.docs)==null?void 0:t.source}}};const r=["HeaderThreeToOne"];export{e as HeaderThreeToOne,r as __namedExportsOrder,s as default};
