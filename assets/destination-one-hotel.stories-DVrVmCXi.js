import{r as t}from"./destinationOneIntroSection-dMoNR17U.js";import{r as i}from"./breadcrumb-example-DMkkXFpu.js";const _={title:"PAGES/DestinationOne",parameters:{layout:"fullwidth"},argTypes:{mapAspectRatio:{table:{category:"D1I Hotel Page Settings",defaultValue:{summary:"default"}},name:"Map Aspect Ratio",description:"Set the map's aspect ratio",options:["default","3-1"],control:{type:"radio"},required:!0}}},r=()=>`
    ...
    `,m=s=>`
        <main id="main" skippy-links-label="Main content">
            ${i()}
            <div class="fragment" fragment-type="d1i-hotel" map-aspect-ratio="${s.mapAspectRatio}">
                ${t("HOTEL")}
                ${r()}
                ${c()}
            </div>
    ...
    `,u=s=>`
       ${m(s)}
    `,e=u.bind({});e.args={mapAspectRatio:"3-1"};var a,o,n;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`(args: DestinationOneHotelProps) => {
  return \`
       \${renderMain(args)}
    \`;
}`,...(n=(o=e.parameters)==null?void 0:o.docs)==null?void 0:n.source}}};const g=["DestinationOneHotel"];export{e as DestinationOneHotel,g as __namedExportsOrder,_ as default};
