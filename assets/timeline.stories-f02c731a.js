import{T as r}from"./badgeCustomConfig-e7a687d5.js";import{j as l}from"./jsx-runtime-ac05983f.js";import{u as m}from"./index-a9a8c754.js";import"./index-e0ddb630.js";import"./_commonjsHelpers-87174ba5.js";function n(e){const t=Object.assign({h1:"h1"},m(),e.components);return l.jsx(t.h1,{id:"timeline",children:"Timeline"})}function c(e={}){const{wrapper:t}=Object.assign({},m(),e.components);return t?l.jsx(t,Object.assign({},e,{children:l.jsx(n,e)})):n(e)}const f={title:"COMPONENTS/Timeline",parameters:{badges:[r.TESTING],docs:{page:c}},argTypes:{direction:{table:{category:"Timeline Settings",defaultValue:{summary:"vertical"}},name:"Timeline direction",description:"Choose between a vertical or horizontal timeline",options:["vertical","horizontal"],control:{type:"radio"},defaultValue:["default"],required:!0},elementDesign:{table:{category:"Timeline Settings",defaultValue:{summary:"default"}},name:"Timeline element design",description:"Set the element design for the timeline element",options:["default","primary","secondary","inverted"],control:{type:"radio"},defaultValue:["default"],required:!0},showLegend:{table:{category:"Timeline settings",defaultValue:{summary:"false"}},name:"Show legend",description:"Show the legend element",control:{type:"boolean"},defaultValue:"false",required:!0}},tags:["autodocs"]},u=e=>`
    ...
    `,i=u.bind({});i.args={direction:"horizontal",elementDesign:"default",showLegend:!1};var a,s,o;i.parameters={...i.parameters,docs:{...(a=i.parameters)==null?void 0:a.docs,source:{originalSource:`(args: TimelineStoryProps) => {
  return \`
        <toujou-timeline
            class="timeline"
...
//# sourceMappingURL=timeline.stories-f02c731a.js.map
