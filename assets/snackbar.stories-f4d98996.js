import{T as u}from"./badgeCustomConfig-e7a687d5.js";import{j as n}from"./jsx-runtime-ccada58e.js";import{u as d}from"./index-4fb8b842.js";import"./index-f1f749bf.js";import"./_commonjsHelpers-042e6b4d.js";function a(t){const e=Object.assign({h1:"h1",p:"p",code:"code",hr:"hr",h2:"h2",h4:"h4",pre:"pre"},d(),t.components);return n.jsxs(n.Fragment,{children:[n.jsx(e.h1,{id:"snackbar",children:"snackbar"}),`
...
| --toujou-snackbar-info-button-color | Set `,n.jsx(e.code,{children:"color"})," of the ",n.jsx(e.code,{children:"toujou-snackbar[info] .snackbar__button"})," | white |"]})]})}function l(t={}){const{wrapper:e}=Object.assign({},d(),t.components);return e?n.jsx(e,Object.assign({},t,{children:n.jsx(a,t)})):a(t)}const f={title:"COMPONENTS/Snackbar",parameters:{badges:[u.DONE],docs:{page:l}},argTypes:{snackbarVariant:{table:{category:"Snackbar settings",defaultValue:{summary:"info"}},name:"Snackbar variant",description:"Set the snackbar variant style",options:["info","success","warning","error"],control:{type:"radio"},defaultValue:["info"],required:!0},snackbarType:{table:{category:"Snackbar settings",defaultValue:{summary:"auto"}},name:"Snackbar type",description:"Set the snackbar type",options:["auto","action"],control:{type:"radio"},defaultValue:["auto"],required:!0},snackbarDuration:{table:{category:"Snackbar settings",defaultValue:{summary:4e3}},name:"Snackbar duration",description:"Set the snackbar visibility duration",control:{type:"number"},defaultValue:4e3,required:!0}},tags:["autodocs"]};function h(t,e,r){return new CustomEvent("toujou-add-snackbar",{bubbles:!0,composed:!0,detail:{message:"welcome to the bonus page!",type:e,buttonText:"ok",duration:r,variant:t}})}const b=t=>(window.addEventListener("click",e=>{const r=e.target;r.getAttribute("id")==="snackbarTriggerButton"&&r.dispatchEvent(h(t.snackbarVariant,t.snackbarType,t.snackbarDuration))}),`
    ...
    `),o=b.bind({});o.args={snackbarVariant:"info",snackbarType:"auto",snackbarDuration:4e3};var s,c,i;o.parameters={...o.parameters,docs:{...(s=o.parameters)==null?void 0:s.docs,source:{originalSource:`(args: SnackbarStoryProps) => {
  ...
  return \`
        ...
        <toujou-snackbar class="snackbar" visible aria-live="assertive" tabindex="-1"></toujou-snackbar>
    \`;
}`,...(i=(c=o.parameters)==null?void 0:c.docs)==null?void 0:i.source}}};const g=["Snackbar"];export{o as Snackbar,g as __namedExportsOrder,f as default};
//# sourceMappingURL=snackbar.stories-f4d98996.js.map
