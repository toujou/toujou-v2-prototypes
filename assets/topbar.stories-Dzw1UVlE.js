import{T as t}from"./badgeCustomConfig-oxGPBDYz.js";import{M as s}from"./topbar.docs-BOX7uLUy.js";import"./jsx-runtime-DPda6Ybg.js";import"./index-DhrokLn_.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-4_AlzpT7.js";const p={title:"COMPONENTS/Topbar",parameters:{badges:[t.DONE],docs:{page:s},layout:"fullscreen"},argTypes:{navigationTheme:{table:{category:"Topbar settings",defaultValue:{summary:"light"}},name:"Navigation theme",description:"Set the navigation theme",options:["light","dark"],control:{type:"radio"},defaultValue:["light"],required:!0},titleType:{table:{category:"Topbar settings",defaultValue:{summary:"logo"}},name:"Mobile page title type",description:"Toggle between logo or text for the topbar page title on mobile devices",options:["logo","title"],control:{type:"radio"},defaultValue:["logo"],required:!0},logoSize:{table:{category:"Topbar settings",defaultValue:{summary:"medium"}},name:"Logo size",description:"Set the logo size",options:["small","medium","large"],control:{type:"radio"},defaultValue:["medium"],required:!0},noTransitions:{table:{category:"Topbar settings",defaultValue:{summary:"false"}},name:"No transitions",description:"Remove the transition from the topbar elements",control:{type:"boolean"},defaultValue:[!1],required:!0},showLanguagePicker:{table:{category:"Topbar settings",defaultValue:{summary:"false"}},name:"Show language picker",description:"Show the language picker element",control:{type:"boolean"},defaultValue:[!0],required:!0}},tags:["autodocs"]},o=a=>`
        <toujou-topbar
            id="topbar"
            class="topbar"
            navigation-theme="${a.navigationTheme}"
    ...
    `,n=o.bind({});n.args={navigationTheme:"light",titleType:"logo",logoSize:"medium",noTransitions:!1,showLanguagePicker:!0};var i,e,l;n.parameters={...n.parameters,docs:{...(i=n.parameters)==null?void 0:i.docs,source:{originalSource:`(args: TopbarStoryProps) => {
  // @ts-ignore
  ...
  return \`
    ...
    \`;
}`,...(l=(e=n.parameters)==null?void 0:e.docs)==null?void 0:l.source}}};const d=["Topbar"];export{n as Topbar,d as __namedExportsOrder,p as default};
