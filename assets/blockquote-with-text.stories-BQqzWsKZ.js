const n={title:"COMPONENTS/Blockquote",argTypes:{columnsLayout:{table:{category:"Grid settings",defaultValue:{summary:"third-right"}},name:"Two columns layout",description:"Define layout of the grid columns",options:["third-right","third-left"],control:{type:"radio"},required:!0}}};function e(){return`
    ...
    `}const i=o=>`
        <toujou-grid class="grid" number-of-columns="2" grid-type="default" column-layout="${o.columnsLayout}" fullwidth>
            <toujou-grid-column class="grid-column">
                ${o.columnsLayout==="third-left"?e():u()}
            </toujou-grid-column>
            <toujou-grid-column class="grid-column">
                ${o.columnsLayout==="third-left"?u():e()}
            </toujou-grid-column>
        </toujou-grid>
    `,l=o=>`
        <main>
    ...
    `,t=l.bind({});t.args={columnsLayout:"third-right"};var r,a,c;t.parameters={...t.parameters,docs:{...(r=t.parameters)==null?void 0:r.docs,source:{originalSource:`(args: BlockquoteWithTextStoryProps) => {
  return \`
        <main>
    ...
    \`;
}`,...(c=(a=t.parameters)==null?void 0:a.docs)==null?void 0:c.source}}};const s=["BlockquoteWithText"];export{t as BlockquoteWithText,s as __namedExportsOrder,n as default};
