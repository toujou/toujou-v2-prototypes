import{T as l}from"./badgeCustomConfig-e7a687d5.js";import{j as e}from"./jsx-runtime-ccada58e.js";import{u as c}from"./index-4fb8b842.js";import"./index-f1f749bf.js";import"./_commonjsHelpers-042e6b4d.js";function r(o){const t=Object.assign({h1:"h1",p:"p",code:"code",a:"a",h2:"h2",pre:"pre",h3:"h3"},c(),o.components);return e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"mapbox",children:"Mapbox"}),`
`,e.jsxs(t.p,{children:["We have created a ",e.jsx(t.code,{children:"toujou-map"})," element, which is a wrapper for a ",e.jsx(t.a,{href:"https://www.mapbox.com/",target:"_blank",rel:"nofollow noopener noreferrer",children:"mapbox"}),' map. This element is used whenever we need to display a map, for instance on the "map with contact" content element']}),`
...
`,e.jsxs(t.p,{children:["We can find the mapbox parameters documentation ",e.jsx(t.a,{href:"https://docs.mapbox.com/mapbox-gl-js/api/map/#map-parameters",target:"_blank",rel:"nofollow noopener noreferrer",children:"here"})]}),`
...
`,e.jsxs(t.p,{children:["More info about mapbox's access token ",e.jsx(t.a,{href:"https://docs.mapbox.com/help/glossary/access-token/",target:"_blank",rel:"nofollow noopener noreferrer",children:"here"})]})]})}function d(o={}){const{wrapper:t}=Object.assign({},c(),o.components);return t?e.jsx(t,Object.assign({},o,{children:e.jsx(r,o)})):r(o)}const b={title:"COMPONENTS/Mapbox",parameters:{badges:[l.DONE],docs:{page:d}},argTypes:{zoomLevel:{table:{category:"Maxbox settings",defaultValue:{summary:"14"}},name:"Zoom level",description:"Choose the map's initial zoom level",control:{type:"range",min:0,max:22,step:1},defaultValue:["14"],required:!0},style:{table:{category:"Maxbox settings",defaultValue:{summary:"light-v10"}},name:"Map style",description:"Choose the map's style",control:{type:"radio"},options:["light-v10","dark-v10","streets-v11","outdoors-v11","satellite-v9","navigation-day-v1"],defaultValue:["light-v10"],required:!0},showMarker:{table:{category:"Maxbox settings",defaultValue:{summary:!0}},name:"Show marker",description:"Toggle marker's visibility",control:{type:"boolean"},defaultValue:[!0],required:!0}},tags:["autodocs"]},m=o=>`
    ...
    `,a=m.bind({});a.args={zoomLevel:14,style:"light-v10",showMarker:!0};var n,s,i;a.parameters={...a.parameters,docs:{...(n=a.parameters)==null?void 0:n.docs,source:{originalSource:`(args: mapboxStoryProps) => {
  return \`
        <toujou-map class="map"
            center="[11.0762549, 49.4579779]"
            zoom="\${args.zoomLevel}"
    ...
    \`;
}`,...(i=(s=a.parameters)==null?void 0:s.docs)==null?void 0:i.source}}};const g=["Mapbox"];export{a as Mapbox,g as __namedExportsOrder,b as default};
//# sourceMappingURL=mapbox.stories-bbf562a3.js.map
