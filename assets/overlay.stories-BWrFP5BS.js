...
`,e.jsxs(i.p,{children:["The attribute ",e.jsx(i.code,{children:'state="open"'})," is added automatically to the element"]})]})}function c(t={}){const{wrapper:i}={...l(),...t.components};return i?e.jsx(i,{...t,children:e.jsx(a,{...t})}):a(t)}const h={title:"COMPONENTS/Overlay",parameters:{badges:[s.DONE],docs:{page:c},layout:"fullscreen"},argTypes:{overlayTheme:{table:{category:"Overlay settings",defaultValue:{summary:"light"}},name:"Overlay theme",description:"Choose theme for the overlay",options:["light","dark"],control:{type:"radio"},required:!0},showLogo:{table:{category:"Overlay settings"},name:"Show logo",description:"Toggle the logo visibility",control:{type:"boolean"},required:!0},showCloseButton:{table:{category:"Overlay settings"},name:"Show close button",description:"Toggle close button visibility",control:{type:"boolean"},required:!0},showConclusionText:{table:{category:"Overlay settings"},name:"Show conclusion text",description:"Toggle conclusion text visibility",control:{type:"boolean"},required:!0},showBackgroundImage:{table:{category:"Overlay settings"},name:"Show background image",description:"Toggle background image visibility",control:{type:"boolean"},required:!0}}};function d(){document.cookie.match(new RegExp("toujou-overlay-super-overlay"))&&(document.cookie="toujou-overlay-super-overlay= ; expires = Thu, 01 Jan 1970 00:00:00 GMT")}const m=t=>(d(),`
  ...
  return \`
    ...
    \`;
}`,...(r=(u=o.parameters)==null?void 0:u.docs)==null?void 0:r.source}}};const x=["Overlay"];export{o as Overlay,x as __namedExportsOrder,h as default};
