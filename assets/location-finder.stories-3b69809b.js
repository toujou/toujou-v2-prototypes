import{T as Ye}from"./badgeCustomConfig-e7a687d5.js";import{j as M}from"./jsx-runtime-87b2c1dd.js";import{u as he}from"./index-af127bdc.js";import{b as J,x as Qe,s as ge,y as P,i as z}from"./lit-element-6fe74b4f.js";import{b as et,c as tt,d as ot,a as nt,l as q}from"./redux-e4401261.js";import{c as A}from"./_commonjsHelpers-725317a4.js";import"./index-afb52020.js";function Z(e){const t={code:"code",h1:"h1",h2:"h2",pre:"pre",...he(),...e.components};return M.jsxs(M.Fragment,{children:[M.jsx(t.h1,{id:"location-finder",children:"Location finder"}),`
...
`])));const wo=Pe(e=>e,e=>e.data.isLoading||e.locator.isLoading||e.search.isLoading||e.popup.isLoading),xo=Pe(e=>e.data.geojson,e=>e.features.highlightedFeature,(e,t)=>e&&Object.prototype.hasOwnProperty.call(e,"features")?{...e,features:e.features.map(o=>({type:o.type,geometry:o.geometry,properties:{...o.properties,isHighlighted:t===o.properties.uid}}))}:e);class le extends ge{static get is(){return"toujou-location-finder"}static get styles(){return[bo,_o,yo,jo]}static get properties(){return{isLoading:{type:Boolean,reflect:!0},reducedMotion:{type:Boolean,attribute:"reduced-motion"},_geoJsonData:{type:Object},_geoJsonPoints:{type:Object},_geoJsonPolygons:{type:Object},_geoJsonLines:{type:Object},_map:{type:Object},_teasersData:{type:String},hasPagination:{type:Boolean,reflect:!0},_currentPage:{type:Number},bounds:{type:Array},geoJsonUrl:{type:String},filterParams:{type:String},teaserUrl:{type:String},_popupFeature:{type:Object},_popupCoordinates:{type:Array},isMobile:{type:Boolean,reflect:!0},accessToken:{type:String,attribute:"access-token"},mapStyle:{type:String,attribute:"map-style"},maxZoom:{type:Number},fitBoundsMaxZoom:{type:Number,attribute:"fit-bounds-max-zoom"},minZoom:{type:Number},_hideMap:{type:Boolean,attribute:"map-is-hidden",reflect:!0},locatorButtonLabel:{type:String,attribute:"locator-button-label"}}}get _geoJsonEndpointFull(){return this._bounds=this._map.getBounds(),`${this.geoJsonUrl}?north=${this._bounds._ne.lat}&south=${this._bounds._sw.lat}&east=${this._bounds._ne.lng}&west=${this._bounds._sw.lng}${this.filterParams}`}render(){const t=this.querySelectorAll('[slot="layers"]').length>0;return P`
      ...
      <toujou-map class="location-finder__map" @toujou-map-ready="${this._onToujouMapReady}"
          ...
          ${t?P`<slot name="layers"></slot>`:this.renderLayers()}
    ...
    `}_renderPopupContent(){return P`
        <div class="location-finder-popup">
          ${ee(this._popupFeature)}
        </div>
    `}_initGeocoder(){const t={forwardGeocode:async n=>{let i=[];try{const r=`https://nominatim.openstreetmap.org/search?q=${n.query}&format=geojson&polygon_geojson=1&addressdetails=1`;i=(await(await fetch(r)).json()).features.map(s=>{const l=[s.bbox[0]+(s.bbox[2]-s.bbox[0])/2,s.bbox[1]+(s.bbox[3]-s.bbox[1])/2];return{type:"Feature",geometry:{type:"Point",coordinates:l},place_name:s.properties.display_name,properties:s.properties,text:s.properties.display_name,place_type:["place"],bbox:s.bbox,center:l}})}catch(r){console.error(`Failed to forwardGeocode with error: ${r}`)}return{features:i}}};this._geocoder=new Zt(t,{maplibregl:q,showResultsWhileTyping:!0,showResultMarkers:!1,marker:!1}),this.shadowRoot.querySelector(".geocoder-container").appendChild(this._geocoder.onAdd(this._map)),this._geocoder.on("loading",()=>{this.store.dispatch({type:Ge})}),this._geocoder.on("results",()=>{this.store.dispatch({type:Ve})});const o=document.documentElement.lang==="en"?"Search location":"Standort suchen";this._geocoder.setPlaceholder(o)}_initFullscreenControl(){this._map.addControl(new q.FullscreenControl({container:this}))}_initMatchMedia(){this._mql=window.matchMedia(`(max-width: ${this._breakpoint})`),this.isMobile=this._mql.matches,this._mql.addListener(t=>{this.isMobile=t.matches,this._updateMapPadding()})}_updateMapPadding(){this._map&&this._map.setPadding(this.isMobile?this._mapPaddingMobile:this._mapPaddingDesktop)}_handleMapToggleClick(){this._hideMap=!this._hideMap}}customElements.define(le.is,le);const ko={type:"FeatureCollection",features:[{type:"Feature",geometry:{type:"Point",coordinates:["8.666475","50.107672"]},properties:{uid:9,name:"dkd Internet Service GmbH",search_boost:1,categories:[0],distance:195927.05143468693}},{type:"Feature",geometry:{type:"Point",coordinates:["8.56679","48.92848"]},properties:{uid:6,name:"G.K.M.B. GmbH",search_boost:1,categories:[0],distance:176281.53005033717}},{type:"Feature",geometry:{type:"Point",coordinates:["9.206144","48.676871"]},properties:{uid:5,name:"jweiland.net",search_boost:1,categories:[0],distance:229457.30072080903}},{type:"Feature",geometry:{type:"Point",coordinates:["8.383444","49.010315"]},properties:{uid:4,name:"punkt.de GmbH",search_boost:1,categories:[0],distance:161022.2575388874}}]},Eo='<toujou-location-finder-teaser feature-uid="28"><a href="/partner/pluswerk/" target="" class="teaser" teaserHasImage><div class="teaser__details">                            <h4 class="teaser__title">                    <span class="teaser__name">+Pluswerk                                             </span>                </h4>                                                                <address class="teaser__address">                                                                <span class="teaser__address-meta teaser__address-meta--telephone">Tel: +49 89 4132580-0</span>                                                                            </address>                                            </div>                                        <figure class="teaser__logo-container">                        <img class="teaser__image teaser__image--logo" loading="lazy" src="https://fakeimg.pl/100x100/049bd6/ffffff?text=Logo" width="100" height="22" alt="" />                    </figure>                            </a></toujou-location-finder-teaser><toujou-location-finder-teaser feature-uid="10">    <a href="/partner/da-kapo-communication-experts-gmbh/" target="" class="teaser"     teaserHasImage>        <div class="teaser__details">                            <h4 class="teaser__title">                    <span class="teaser__name">da kapo. Communication Experts GmbH                                             </span>                </h4>                                                                <address class="teaser__address">                                                                <span class="teaser__address-meta teaser__address-meta--telephone">Tel: +49 911 97075-0</span>                                                                            </address>                                            </div>                                        <figure class="teaser__logo-container">                        <img class="teaser__image teaser__image--logo" loading="lazy" src="https://fakeimg.pl/100x100/0da367/ffffff?text=Logo" width="99" height="100" alt="" />                    </figure>                            </a></toujou-location-finder-teaser><toujou-location-finder-teaser feature-uid="3">    <a href="/partner/dfau-gmbh/" target="" class="teaser"     teaserHasImage>        <div class="teaser__details">                            <h4 class="teaser__title">                    <span class="teaser__name">DFAU GmbH                                                      <span class="teaser__branch">TYPO3-Software</span>                                             </span>                </h4>                                                                <address class="teaser__address">                                                                <span class="teaser__address-meta teaser__address-meta--telephone">Tel: +49 911 23980-870</span>                                                                            </address>                                            </div>                                        <figure class="teaser__logo-container">                        <img class="teaser__image teaser__image--logo" loading="lazy" src="https://fakeimg.pl/100x100/a30c4d/ffffff?text=Logo" width="100" height="86" alt="" />                    </figure>                            </a></toujou-location-finder-teaser><toujou-location-finder-teaser feature-uid="9">    <a href="/partner/dkd-internet-service-gmbh/" target="" class="teaser"     teaserHasImage>        <div class="teaser__details">                            <h4 class="teaser__title">                    <span class="teaser__name">dkd Internet Service GmbH                                             </span>                </h4>                                                                <address class="teaser__address">                                                                <span class="teaser__address-meta teaser__address-meta--telephone">Tel: +49 69 2475218-0</span>                                                                            </address>                                            </div>                                        <figure class="teaser__logo-container">                        <img class="teaser__image teaser__image--logo" loading="lazy" src="https://fakeimg.pl/100x100/7b0ca3/ffffff?text=Logo" width="100" height="100" alt="" />                    </figure>                            </a></toujou-location-finder-teaser><toujou-location-finder-teaser feature-uid="7">    <a href="/partner/elmografico-gmbh/" target="" class="teaser"     teaserHasImage>        <div class="teaser__details">                            <h4 class="teaser__title">                    <span class="teaser__name">Elmografico GmbH                                             </span>                </h4>                                                                <address class="teaser__address">                                                                <span class="teaser__address-meta teaser__address-meta--telephone">Tel: +49 911 40089900</span>                                                                            </address>                                            </div>                                        <figure class="teaser__logo-container">                        <img class="teaser__image teaser__image--logo" loading="lazy" src="https://fakeimg.pl/100x100/0ca38c/ffffff?text=Logo" width="100" height="100" alt="" />                    </figure>                            </a></toujou-location-finder-teaser><toujou-location-finder-teaser feature-uid="6">    <a href="/partner/gkmb-gmbh/" target="" class="teaser"     teaserHasImage>        <div class="teaser__details">                            <h4 class="teaser__title">                    <span class="teaser__name">G.K.M.B. GmbH                                             </span>                </h4>                                                                <address class="teaser__address">                                                                <span class="teaser__address-meta teaser__address-meta--telephone">Tel: +49 7232 37 23 55</span>                                                                            </address>                                            </div>                                        <figure class="teaser__logo-container">                        <img class="teaser__image teaser__image--logo" loading="lazy" src="/fileadmin/_processed_/0/2/csm_gkmb_Logo_c4783b955c.png" width="100" height="75" alt="" />                    </figure>                            </a></toujou-location-finder-teaser><toujou-location-finder-teaser feature-uid="21">    <a href="/partner/gigatec/" target="" class="teaser"     teaserHasImage>        <div class="teaser__details">                            <h4 class="teaser__title">                    <span class="teaser__name">Gigatec GmbH                                             </span>                </h4>                                                                <address class="teaser__address">                                                                <span class="teaser__address-meta teaser__address-meta--telephone">Tel: +49 911 495 2791-0</span>                                                                            </address>                                            </div>                                        <figure class="teaser__logo-container">                        <img class="teaser__image teaser__image--logo" loading="lazy" src="/fileadmin/_processed_/c/2/csm_GIGATEC_ea9c3ec783.png" width="100" height="21" alt="" />                    </figure>                            </a></toujou-location-finder-teaser><toujou-location-finder-teaser feature-uid="11">    <a href="/partner/goldwild/" target="" class="teaser"     teaserHasImage>        <div class="teaser__details">                            <h4 class="teaser__title">                    <span class="teaser__name">Goldwild GmbH                                             </span>                </h4>                                                                <address class="teaser__address">                                                                <span class="teaser__address-meta teaser__address-meta--telephone">Tel: +49 911 777087</span>                                                                            </address>                                            </div>                                        <figure class="teaser__logo-container">                        <img class="teaser__image teaser__image--logo" loading="lazy" src="/fileadmin/_processed_/7/c/csm_Goldwild_Logo_Schwarz_c1f876b007.png" width="100" height="80" alt="" />                    </figure>                            </a></toujou-location-finder-teaser>',Io={title:"COMPONENTS/LocationFinder",parameters:{badges:[Ye.DONE],docs:{page:it},layout:"fullscreen",fetchMock:{mocks:[{matcher:{name:"placesGeo",url:"begin:/placesgeo.json"},response:(e,t,o)=>(ce("placesGeo",e,t,o),ko)},{matcher:{name:"placesTeaser",url:"begin:/placesteaser.html"},response:(e,t,o)=>(ce("placesTeaser",e,t,o),Eo)}]}},tags:["autodocs"]};function ce(e,t,o,n){console.groupCollapsed(`%c====== MOCK REQUEST: ${e} ======`,"color: #4DB6AC; font-weight: bold;"),console.log(`%cURL: %c${t}`,"color: #E57373; font-weight: bold;","color: #4DB6AC"),console.log(`%cOptions %c${o}`,"color: #E57373; font-weight: bold;","color: #4DB6AC"),console.log(`%cRequest %c${n}`,"color: #E57373; font-weight: bold;","color: #4DB6AC"),console.groupEnd()}const Lo=()=>`
        <toujou-location-finder
            class="location-finder"
    ...
    `,O=Lo.bind({});var ue,de,pe;O.parameters={...O.parameters,docs:{...(ue=O.parameters)==null?void 0:ue.docs,source:{originalSource:`() => {
  // testMocks();
  ...
  return \`
    ...
    \`;
}`,...(pe=(de=O.parameters)==null?void 0:de.docs)==null?void 0:pe.source}}};const Ro=["LocationFinder"];export{O as LocationFinder,Ro as __namedExportsOrder,Io as default};
