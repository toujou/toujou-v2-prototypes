const a={title:"COMPONENTS/EstimatedReadingTime"},o=()=>`
    ...
    `,e=o.bind({});var i,t,u;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:`() => {
  return \`
        <toujou-text-block class="text-block" text-block-column-count="1">
            <toujou-estimated-reading-time class="estimated-reading-time" target-selector="body">
                <span slot="label" class="estimated-reading-time__label">
    ...
    \`;
}`,...(u=(t=e.parameters)==null?void 0:t.docs)==null?void 0:u.source}}};const l=["EstimatedReadingTime"];export{e as EstimatedReadingTime,l as __namedExportsOrder,a as default};
