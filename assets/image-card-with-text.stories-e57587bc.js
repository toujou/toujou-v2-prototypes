import{T as s}from"./badgeCustomConfig-e7a687d5.js";import{M as n}from"./content-card-with-text.docs-2f939317.js";import"./jsx-runtime-ac05983f.js";import"./index-e0ddb630.js";import"./_commonjsHelpers-87174ba5.js";import"./index-a9a8c754.js";const h={title:"COMPONENTS/Image Card",parameters:{badges:[s.DONE],docs:{page:n}},argTypes:{direction:{table:{category:"Image card settings",defaultValue:{direction:"left"}},name:"Direction",description:"Set the column where the text will be shown",options:["left","right"],control:{type:"radio"},defaultValue:["left"],required:!0}}};function t(){return`
    ...
    `,e=l.bind({});e.args={direction:"left"};var u,o,a;e.parameters={...e.parameters,docs:{...(u=e.parameters)==null?void 0:u.docs,source:{originalSource:`(args: ImageCardWithTextStoryProps) => {
  return \`
...
//# sourceMappingURL=image-card-with-text.stories-e57587bc.js.map
