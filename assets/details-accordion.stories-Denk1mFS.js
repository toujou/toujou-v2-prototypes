const o={title:"COMPONENTS/Accordion",argTypes:{singleExpandMode:{table:{category:"Details accordion Settings",defaultValue:{summary:"false"}},name:"Single expand mode",description:"Allow just one accordion items to be open at a time",control:{type:"boolean"},required:!0},expandedItem:{table:{category:"Details accordion Settings",defaultValue:{summary:"first"}},name:"Expanded items",description:"Define which accordion items are open when the page loads",options:["none","first","all"],control:{type:"radio"},required:!0},elementDesign:{table:{category:"Details Settings",defaultValue:{summary:"default"}},name:"Accordion element design",description:"Set the element design for the accordion element",options:["default","primary","secondary","inverted"],control:{type:"radio"},required:!0}}},l=e=>`
        <main>
    ...
    `,i=l.bind({});i.args={singleExpandMode:!1,expandedItem:"first",elementDesign:"default"};var t,s,n;i.parameters={...i.parameters,docs:{...(t=i.parameters)==null?void 0:t.docs,source:{originalSource:`(args: DetailsAccordionStoryProps) => {
  return \`
        <main>
    ...
    \`;
}`,...(n=(s=i.parameters)==null?void 0:s.docs)==null?void 0:n.source}}};const a=["DetailsAccordion"];export{i as DetailsAccordion,a as __namedExportsOrder,o as default};
