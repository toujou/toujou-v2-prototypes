...
`]})]})}function r(i={}){const{wrapper:e}=Object.assign({},h(),i.components);return e?t.jsx(e,Object.assign({},i,{children:t.jsx(a,i)})):a(i)}const j={title:"COMPONENTS/Media",parameters:{badges:[p.DONE],docs:{page:r}},argTypes:{},tags:["autodocs"]},c=()=>`
    ...
    `,s=c.bind({});var o,l,n;s.parameters={...s.parameters,docs:{...(o=s.parameters)==null?void 0:o.docs,source:{originalSource:`() => {
  return \`
        <toujou-gallery id="test-gallery" class="gallery" lightbox-parent-id="1">
            <a href="https://cdn.photoswipe.com/photoswipe-demo-images/photos/1/img-2500.jpg" 
                data-pswp-width="1669" 
    ...
    \`;
}`,...(n=(l=s.parameters)==null?void 0:l.docs)==null?void 0:n.source}}};const x=["Gallery"];export{s as Gallery,x as __namedExportsOrder,j as default};
//# sourceMappingURL=gallery.stories-feb929f8.js.map
