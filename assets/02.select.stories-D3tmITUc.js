import{T as i}from"./badgeCustomConfig-DUXiHpL4.js";import{M as c}from"./form.docs-Dn0kwJ_D.js";import"./jsx-runtime-BjG_zV1W.js";import"./index-DpH9cx3q.js";import"./index-DO8khQO4.js";import"./_commonjsHelpers-Cpj98o6Y.js";const g={title:"COMPONENTS/Forms",parameters:{badges:[i.DONE],docs:{page:c}},argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},required:!0}}},l=t=>{const r=t.state==="disabled"?"disabled":"";return`
        <style>
            body {
