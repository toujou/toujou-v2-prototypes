import{r,a as c}from"./breadcrumb-example-BHVKmO5b.js";const s=(a,i="")=>`
    ...
    `,p=a=>`
       ${d(a)}
    `,e=p.bind({});e.args={mapAspectRatio:"3-1"};var n,o,t;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`(args: DestinationOneTourProps) => {
  return \`
       \${renderMain(args)}
    \`;
