...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function _unsupportedIterableToArray$d(j,te){if(!!j){if(typeof j=="string")return _arrayLikeToArray$d(j,te);var re=Object.prototype.toString.call(j).slice(8,-1);if(re==="Object"&&j.constructor&&(re=j.constructor.name),re==="Map"||re==="Set")return Array.from(j);if(re==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(re))return _arrayLikeToArray$d(j,te)}}function _arrayLikeToArray$d(j,te){(te==null||te>j.length)&&(te=j.length);for(var re=0,oe=new Array(te);re<te;re++)oe[re]=j[re];return oe}function _iterableToArrayLimit$a(j,te){var re=j==null?null:typeof Symbol!="undefined"&&j[Symbol.iterator]||j["@@iterator"];if(re!=null){var oe=[],ae=!0,se=!1,ie,ce;try{for(re=re.call(j);!(ae=(ie=re.next()).done)&&(oe.push(ie.value),!(te&&oe.length===te));ae=!0);}catch(ue){se=!0,ce=ue}finally{try{!ae&&re.return!=null&&re.return()}finally{if(se)throw ce}}return oe}}function _arrayWithHoles$a(j){if(Array.isArray(j))return j}function _classCallCheck$a(j,te){if(!(j instanceof te))throw new TypeError("Cannot call a class as a function")}function _defineProperties$a(j,te){for(var re=0;re<te.length;re++){var oe=te[re];oe.enumerable=oe.enumerable||!1,oe.configurable=!0,"value"in oe&&(oe.writable=!0),Object.defineProperty(j,oe.key,oe)}}function _createClass$a(j,te,re){return te&&_defineProperties$a(j.prototype,te),re&&_defineProperties$a(j,re),Object.defineProperty(j,"prototype",{writable:!1}),j}var StoryStoreFacade=function(){function j(){_classCallCheck$a(this,j),this.projectAnnotations=void 0,this.stories=void 0,this.csfExports=void 0,this.projectAnnotations={loaders:[],decorators:[],parameters:{},argsEnhancers:[],argTypesEnhancers:[],args:{},argTypes:{}},this.stories={},this.csfExports={}}return _createClass$a(j,[{key:"importFn",value:function(re){var oe=this;return synchronousPromise.SynchronousPromise.resolve().then(function(){var ae=oe.csfExports[re];if(!ae)throw new Error("Unknown path: ".concat(re));return ae})}},{key:"getStoryIndex",value:function(re){var oe,ae,se=this,ie=Object.keys(this.csfExports),ce=(oe=this.projectAnnotations.parameters)===null||oe===void 0||(ae=oe.options)===null||ae===void 0?void 0:ae.storySort,ue=Object.entries(this.stories),de=ue.map(function(me){var ve=_slicedToArray$a(me,2),he=ve[0],ye=ve[1].importPath,be=se.csfExports[ye],Te=re.processCSFFileWithCache(be,ye,be.default.title);return[he,re.storyFromCSFFile({storyId:he,csfFile:Te}),Te.meta.parameters,se.projectAnnotations.parameters]}),pe;try{pe=sortStoriesV6(de,ce,ie)}catch(me){throw typeof ce=="function"?new Error(dedent(_templateObject$a||(_templateObject$a=_taggedTemplateLiteral$a([`
        ...
        `])),ce,me.message)):me}var fe=pe.reduce(function(me,ve){return me[ve.id]=se.stories[ve.id],me},{});return{v:3,stories:fe}}},{key:"clearFilenameExports",value:function(re){var oe=this;!this.csfExports[re]||(Object.entries(this.stories).forEach(function(ae){var se=_slicedToArray$a(ae,2),ie=se[0],ce=se[1].importPath;ce===re&&delete oe.stories[ie]}),this.csfExports[re]={})}},{key:"addStoriesFromExports",value:function(re,oe){var ae=this;if(this.csfExports[re]!==oe){this.clearFilenameExports(re);var se=oe.default,ie=oe.__namedExportsOrder,ce=_objectWithoutProperties$2(oe,_excluded$2),ue=se||{},de=ue.id,pe=ue.title,fe=(window_1.STORIES||[]).map(function(ve){return Object.assign({},ve,{importPathMatcher:new RegExp(ve.importPathMatcher)})});if(pe=userOrAutoTitle(re,fe,pe),!pe){logger.info("Unexpected default export without title in '".concat(re,"': ").concat(JSON.stringify(oe.default)));return}this.csfExports[re]=Object.assign({},oe,{default:Object.assign({},se,{title:pe})});var me=ce;Array.isArray(ie)&&(me={},ie.forEach(function(ve){var he=ce[ve];he&&(me[ve]=he)})),Object.entries(me).filter(function(ve){var he=_slicedToArray$a(ve,1),ye=he[0];return dist.isExportStory(ye,se)}).forEach(function(ve){var he,ye,be=_slicedToArray$a(ve,2),Te=be[0],Ae=be[1],$e=dist.storyNameFromExport(Te),we=((he=Ae.parameters)===null||he===void 0?void 0:he.__id)||dist.toId(de||pe,$e),Se=typeof Ae!="function"&&Ae.name||Ae.storyName||((ye=Ae.story)===null||ye===void 0?void 0:ye.name)||$e;ae.stories[we]={id:we,name:Se,title:pe,importPath:re}})}}}]),j}(),_excluded$1=["globals","globalTypes"],_excluded2=["decorators","loaders","component","args","argTypes"],_excluded3=["component","args","argTypes"],_templateObject$9,_templateObject2$2,_templateObject3$1,_templateObject4$1;function _slicedToArray$9(j,te){return _arrayWithHoles$9(j)||_iterableToArrayLimit$9(j,te)||_unsupportedIterableToArray$c(j,te)||_nonIterableRest$9()}function _nonIterableRest$9(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
...
`,locationsMap:{accordion:{startLoc:{col:17,line:14},endLoc:{col:1,line:132},startBody:{col:17,line:14},endBody:{col:1,line:132}}}},design:{artboardUrl:"https://xd.adobe.com/view/c5b5ae33-8b35-4536-be9f-a39f5a3c447f-90e6/screen/154e8bfd-4e6a-48d2-914c-5bafe3af7289/Desktop"}}};const Template$4=()=>`       
        <toujou-accordion class="accordion accordion--design-default">
            <div class="accordion__item">
                <div id="accordion-panel-4-0"
                     class="accordion__panel"
    ...
    `,Accordion=Template$4.bind({}),__namedExportsOrder$h=["Accordion"];var story_0=Object.freeze(Object.defineProperty({__proto__:null,default:accordion_stories,Accordion,__namedExportsOrder:__namedExportsOrder$h},Symbol.toStringTag,{value:"Module"}));const DEFAULT_BUTTON_TEXT="Hello";var button_stories={title:"COMPONENTS/Button",decorators:[withXD],parameters:{storySource:{source:`import { Meta } from '@storybook/web-components';
// @ts-ignore
import { withXD } from "storybook-addon-xd-designs";
...
Button.args = {
    ...
    size: 'normal',
    isExpanded: false,
}`,locationsMap:{button:{startLoc:{col:17,line:97},endLoc:{col:1,line:130},startBody:{col:17,line:97},endBody:{col:1,line:130}}}},design:{artboardUrl:"https://xd.adobe.com/view/c5b5ae33-8b35-4536-be9f-a39f5a3c447f-90e6/screen/94662024-4698-4543-9535-08e86b001d5d/Desktop"}},argTypes:{buttonVariant:{table:{category:"Button Settings",defaultValue:{summary:"primary"}},name:"Button variant",description:"Set the button's variant",options:["primary","secondary","font"],control:{type:"radio"},defaultValue:["primary"],required:!0},buttonType:{table:{category:"Button Settings",defaultValue:{summary:"default"}},name:"Button type",description:"Set the button's type",options:["default","border","ghost"],control:{type:"radio"},defaultValue:["default"],required:!0},isDisabled:{table:{category:"Button Settings",defaultValue:{summary:"false"}},name:"Disabled",description:"Toggle the button disabled attribute",control:{type:"boolean"},required:!0},hasIcon:{table:{category:"Button Settings",defaultValue:{summary:"false"}},name:"Icon",description:"Toggle visibility of the button's icon",control:{type:"boolean"},required:!0},iconPosition:{table:{category:"Button Settings",defaultValue:{summary:"left"}},name:"Icon position",description:"Set the button's icon position",options:["left","right"],control:{type:"radio"},defaultValue:["left"],required:!0},size:{table:{category:"Button Settings",defaultValue:{summary:"normal"}},name:"Size",description:"Set the button text size",options:["tiny","small","normal","large"],control:{type:"radio"},defaultValue:["normal"],required:!0},isExpanded:{table:{category:"Button Settings",defaultValue:{summary:"false"}},name:"Expanded",description:"Toggle the button's width",control:{type:"boolean"},required:!0}}};const Template$3=j=>{let te=document.createElement("button"),re=`button button--${j.buttonVariant} button--size-${j.size}`;return te.setAttribute("class",re),(j.isExpanded==="true"||j.isExpanded===!0)&&te.classList.add("button--expanded"),j.buttonType==="border"&&te.classList.add("button--border"),j.buttonType==="ghost"&&te.classList.add("button--ghost"),te.disabled=j.isDisabled==="true"||j.isDisabled===!0,j.hasIcon==="true"||j.hasIcon===!0?(te.innerHTML=`<i class="button__icon icon icon--arrow-right"></i> ${DEFAULT_BUTTON_TEXT}`,te.classList.add(`button--icon-${j.iconPosition}`)):te.textContent=DEFAULT_BUTTON_TEXT,te},Button=Template$3.bind({});Button.args={buttonVariant:"primary",buttonType:"default",isDisabled:!1,hasIcon:!1,iconPosition:"left",size:"normal",isExpanded:!1};const __namedExportsOrder$g=["Button"];var story_1=Object.freeze(Object.defineProperty({__proto__:null,default:button_stories,Button,__namedExportsOrder:__namedExportsOrder$g},Symbol.toStringTag,{value:"Module"})),icons_stories={title:"COMPONENTS/Icons",decorators:[withXD],parameters:{storySource:{source:`import {Meta} from '@storybook/web-components';
import { withXD } from "storybook-addon-xd-designs";
...
`,locationsMap:{icon:{startLoc:{col:29,line:95},endLoc:{col:120,line:95},startBody:{col:37,line:95},endBody:{col:66,line:95}}}},design:{artboardUrl:"https://xd.adobe.com/view/c5b5ae33-8b35-4536-be9f-a39f5a3c447f-90e6/screen/8273eb7a-a8b4-4953-be35-18a8929d90c5/Desktop"}},argTypes:{iconColor:{table:{category:"Icon Settings",defaultValue:{summary:"font"}},name:"Icon color",description:"Set the icon's color. If this class isn't set it defaults to 'currentColor'",options:["font","primary","secondary"],control:{type:"radio"},defaultValue:["font"],required:!0},iconSize:{table:{category:"Icon Settings",defaultValue:{summary:"ms"}},name:"Icon size",description:"Set the icon's size. If the class isn't set it defaults to `ms`",options:["xxxl","xxl","xl","l","m","ms","normal","s","xs","xxs"],control:{type:"radio"},defaultValue:["ms"],required:!0}}};const iconNames=["arrow-drop-down","arrow-right","blockquote","blockquote-round","bookmark","bookmark-filled","breakfast","calendar","cancel-circle-filled","check","chevron-down","chevron-filled-down","chevron-left","chevron-right","chevron-up","clock-circle","clock-circle-filled","dinner","euro","ext-people-company","ext-people-person","filter-list","heart","heart-stroke","home","home-smooth","info-circle-filled","location","lunch","map","pending-circle-filled","play-circle","play-circle-filled","rate-star-filled","stop-circle-filled","socialmedia-facebook","socialmedia-instagram","socialmedia-linkedin","socialmedia-pinterest","socialmedia-twitter","socialmedia-xing","socialmedia-youtube"],Template$2=j=>{const te=document.createElement("div");return te.classList.add("icon-grid"),iconNames.forEach(re=>{const oe=document.createElement("div");oe.classList.add("icon-grid__cell");const ae=document.createElement("i");ae.classList.add("icon",`icon--size-${j.iconSize}`,`icon--color-${j.iconColor}`,`icon--${re}`),oe.appendChild(ae);const se=document.createElement("p");se.classList.add("icon-grid__title"),se.textContent=re,oe.appendChild(se),te.appendChild(oe)}),te},Icons=Template$2.bind({});Icons.args={iconColor:"font",iconSize:"ms"};const __namedExportsOrder$f=["Icons"];var story_2=Object.freeze(Object.defineProperty({__proto__:null,default:icons_stories,Icons,__namedExportsOrder:__namedExportsOrder$f},Symbol.toStringTag,{value:"Module"})),toujouBreadcrumb_stories={parameters:{storySource:{source:`import { Meta } from '@storybook/web-components';
...
`,locationsMap:{breadcrumb:{startLoc:{col:17,line:8},endLoc:{col:1,line:45},startBody:{col:17,line:8},endBody:{col:1,line:45}}}}},title:"COMPONENTS/Breadcrumb",argTypes:{}};const Template$1=j=>`       
        <toujou-breadcrumb role="nav" aria-label="Breadcrumb" class="breadcrumb">
            <button slot="toggle-buttons" class="breadcrumb__toggle breadcrumb__toggle--open">
                <i class="icon icon--arrow-left breadcrumb__toggle-icon"></i>
            </button>
    ...
    `,Breadcrumb=Template$1.bind({}),__namedExportsOrder$e=["Breadcrumb"];var story_3=Object.freeze(Object.defineProperty({__proto__:null,default:toujouBreadcrumb_stories,Breadcrumb,__namedExportsOrder:__namedExportsOrder$e},Symbol.toStringTag,{value:"Module"})),logoImage="/assets/logoipsum.c28fcb35.svg",toujouTopbar_stories={title:"COMPONENTS/Topbar",decorators:[withXD],parameters:{storySource:{source:`import { Meta } from '@storybook/web-components';
// @ts-ignore
