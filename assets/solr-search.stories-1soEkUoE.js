import{r as e}from"./_renderCardCategoriChips-D3lhH8UM.js";const n={title:"COMPONENTS/solr",argTypes:{showMobileFilters:{table:{category:"Solr search settings"},name:"Show mobile filters",description:"Toggle visibility of the mobile filters",control:{type:"boolean"},required:!0},showMap:{table:{category:"Solr search settings"},name:"Show map",description:"Toggle visibility of the search map",control:{type:"boolean"},required:!0}}},l=i=>`
        <main>
            <toujou-solr-search class="solr" view-mode="${i.showMap?"map":"grid"}">
                <div id="solr-filters" class="solr-filters" ${i.showMobileFilters?"is-visible":""}>
     ...
     `,t=l.bind({});t.args={showMobileFilters:!1,showMap:!1};var a,o,s;t.parameters={...t.parameters,docs:{...(a=t.parameters)==null?void 0:a.docs,source:{originalSource:`(args: SolrSearchStoryProps) => {
  return \`
        <main>
     ...
     \`;
}`,...(s=(o=t.parameters)==null?void 0:o.docs)==null?void 0:s.source}}};const r=["SolrSearch"];export{t as SolrSearch,r as __namedExportsOrder,n as default};
