const a={title:"COMPONENTS/Cover Slider",parameters:{layout:"fullscreen"},argTypes:{isSlider:{table:{category:"Cover slider settings"},name:"Is Slider",description:"It should only be a slider if it contains more items than it can fit on the page. Otherwise it should show the items centered on the page",control:{type:"boolean"},required:!0}}},d=i=>`
        <main>
    ...
    `,e=d.bind({});e.args={isSlider:!0};var s,l,r;e.parameters={...e.parameters,docs:{...(s=e.parameters)==null?void 0:s.docs,source:{originalSource:`(args: CoverSliderStoryProps) => {
  return \`
        <main>
            <toujou-cover-slider class="cover-slider" aria-label="Toujou cover slider example">
                <div class="splide slider__slider">
    ...
    \`;
}`,...(r=(l=e.parameters)==null?void 0:l.docs)==null?void 0:r.source}}};const o=["CoverSlider"];export{e as CoverSlider,o as __namedExportsOrder,a as default};
