const l={title:"COMPONENTS/Third Party Content",argTypes:{showPoster:{table:{category:"third party content settings"},name:"Show poster image",description:"Show a poster image as background",control:{type:"boolean"},required:!0},isVideo:{table:{category:"third party content settings"},name:"Video content",description:"Emulate element with video element content",control:{type:"boolean"},required:!0}}};window.addEventListener("click",t=>{t.target.getAttribute("id")==="clearConsentsButton"&&(localStorage.removeItem("consentsState"),document.location.reload())});const c=()=>`
    ...
    `,a=t=>`
        <main>
            ...
            <toujou-third-party-content
                ...
                contentType="${t.isVideo?"video":"maps"}"
                ${t.showPoster?`style="${c()}"`:""}
                ${t.showPoster?"has-poster-image":""}
    ...
    `,n=a.bind({});n.args={showPoster:!1,isVideo:!1};var e,o,s;n.parameters={...n.parameters,docs:{...(e=n.parameters)==null?void 0:e.docs,source:{originalSource:`(args: ThirdPartyContentStoryProps) => {
  return \`
        <main>
            <p>With this button you can remove all consents from the local storage. For test purposes only</p>
            <p><button class="button" id="clearConsentsButton">Remove all consents</button></p>
    ...
    \`;
}`,...(s=(o=n.parameters)==null?void 0:o.docs)==null?void 0:s.source}}};const u=["ThirdPartyContent"];export{n as ThirdPartyContent,u as __namedExportsOrder,l as default};
