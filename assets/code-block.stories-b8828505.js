import{T as r}from"./badgeCustomConfig-e7a687d5.js";import{j as s}from"./jsx-runtime-ccada58e.js";import{u as o}from"./index-4fb8b842.js";import"./index-f1f749bf.js";import"./_commonjsHelpers-042e6b4d.js";function e(n){const a=Object.assign({h1:"h1",p:"p",h2:"h2",pre:"pre",code:"code",a:"a"},o(),n.components);return s.jsxs(s.Fragment,{children:[s.jsx(a.h1,{id:"code-block",children:"Code block"}),`
...
`,s.jsxs(a.p,{children:["The highlighting is done with ",s.jsx(a.a,{href:"https://highlightjs.org/",target:"_blank",rel:"nofollow noopener noreferrer",children:"highlight.js"}),", by default using the Dracula theme."]}),`
`,s.jsx(a.h2,{id:"code-block-extension",children:"Code Block extension"}),`
`,s.jsxs(a.p,{children:["There is documentation on how to install and configure it on the ",s.jsx(a.a,{href:"https://code.dfau.de/toujou/codeblock",target:"_blank",rel:"nofollow noopener noreferrer",children:"Code Block extension repo"})]}),`
...
`,s.jsx(a.code,{children:"tt_content.codeblock.20.settings.pathToCssFile"})]})]})}function h(n={}){const{wrapper:a}=Object.assign({},o(),n.components);return a?s.jsx(a,Object.assign({},n,{children:s.jsx(e,n)})):e(n)}const m={title:"COMPONENTS/Code Block",parameters:{badges:[r.DONE],docs:{page:h}},argTypes:{showLanguageTag:{table:{category:"Code block Settings",defaultValue:{summary:"true"}},name:"Show the language tag",description:"Show or hide the language tag",control:{type:"boolean"},defaultValue:["true"],required:!0}},tags:["autodocs"]},i=n=>`
...
<span class="hljs-tag">&lt;/<span class="hljs-name">html</span>&gt;</span></code>
    ...
    \`;
}`,...(p=(t=l.parameters)==null?void 0:t.docs)==null?void 0:p.source}}};const k=["CodeBlock"];export{l as CodeBlock,k as __namedExportsOrder,m as default};
//# sourceMappingURL=code-block.stories-b8828505.js.map
