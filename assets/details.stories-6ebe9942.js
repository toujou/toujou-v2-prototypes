import{T as a}from"./badgeCustomConfig-e7a687d5.js";import{j as e}from"./jsx-runtime-ccada58e.js";import{u as d}from"./index-4fb8b842.js";import"./index-f1f749bf.js";import"./_commonjsHelpers-042e6b4d.js";function s(t){const n=Object.assign({h1:"h1",p:"p",code:"code",h2:"h2",pre:"pre",h3:"h3"},d(),t.components);return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"toujou-details",children:"<toujou-details>"}),`
...
`})})]})}function u(t={}){const{wrapper:n}=Object.assign({},d(),t.components);return n?e.jsx(n,Object.assign({},t,{children:e.jsx(s,t)})):s(t)}const j={title:"COMPONENTS/Accordion",parameters:{badges:[a.DONE],docs:{page:u}},argTypes:{elementDesign:{table:{category:"Details Settings",defaultValue:{summary:"default"}},name:"Accordion element design",description:"Set the element design for the accordion element",options:["default","primary","secondary","inverted"],control:{type:"radio"},defaultValue:["default"],required:!0}},tags:["autodocs"]},c=t=>`
    ...
    `,i=c.bind({});i.args={elementDesign:"default"};var r,l,o;i.parameters={...i.parameters,docs:{...(r=i.parameters)==null?void 0:r.docs,source:{originalSource:`(args: DetailsStoryProps) => {
  return \`
    ...
    \`;
}`,...(o=(l=i.parameters)==null?void 0:l.docs)==null?void 0:o.source}}};const v=["Details"];export{i as Details,v as __namedExportsOrder,j as default};
//# sourceMappingURL=details.stories-6ebe9942.js.map
