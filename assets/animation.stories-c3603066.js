const e={title:"TOKENS/Animation",argTypes:{}},t=()=>`        
    ...
    `,n=t.bind({});var a,o,i;n.parameters={...n.parameters,docs:{...(a=n.parameters)==null?void 0:a.docs,source:{originalSource:`() => {
  return \`        
        <h1 class="tokens-demo__title">Animation tokens</h1>
        ...
        <p>The transition and animation are turned off if the user as set <code>prefers-reduced-motion: reduce</code>. You can try it with the browser reduced-motion emulator</p>
    \`;
}`,...(i=(o=n.parameters)==null?void 0:o.docs)==null?void 0:i.source}}};const s=["Animation"];export{n as Animation,s as __namedExportsOrder,e as default};
//# sourceMappingURL=animation.stories-c3603066.js.map
