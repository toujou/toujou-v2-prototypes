import{M as l}from"./details-accordion.docs-BTOIL_Sr.js";import"./jsx-runtime-BjG_zV1W.js";import"./index-B3bKeUOg.js";import"./iframe-CGVrXR_C.js";import"./preload-helper-C1FmrZbK.js";const m={title:"COMPONENTS/Accordion",parameters:{docs:{page:l}},argTypes:{singleExpandMode:{table:{category:"Details accordion Settings",defaultValue:{summary:"false"}},name:"Single expand mode",description:"Allow just one accordion items to be open at a time",control:{type:"boolean"},required:!0},expandedItem:{table:{category:"Details accordion Settings",defaultValue:{summary:"first"}},name:"Expanded items",description:"Define which accordion items are open when the page loads",options:["none","first","all"],control:{type:"radio"},required:!0},elementDesign:{table:{category:"Details Settings",defaultValue:{summary:"default"}},name:"Accordion element design",description:"Set the element design for the accordion element",options:["default","primary","secondary","inverted"],control:{type:"radio"},required:!0}},tags:["autodocs"]},o=e=>`
        <main>
