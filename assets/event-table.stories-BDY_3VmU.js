...
`})})]})}function p(t={}){const{wrapper:a}={...r(),...t.components};return a?e.jsx(a,{...t,children:e.jsx(n,{...t})}):n(t)}const b={title:"COMPONENTS/EventTable",parameters:{badges:[d.DONE],docs:{page:p}},tags:["autodocs"]},c=()=>`
    ...
    `,l=m.bind({});var i,s,o;l.parameters={...l.parameters,docs:{...(i=l.parameters)==null?void 0:i.docs,source:{originalSource:`() => {
  return \`
        \${eventTableComponent()}
    ...
    \`;
}`,...(o=(s=l.parameters)==null?void 0:s.docs)==null?void 0:o.source}}};const f=["EventTable"];export{l as EventTable,f as __namedExportsOrder,b as default};
