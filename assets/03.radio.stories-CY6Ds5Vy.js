const d={title:"COMPONENTS/Forms",argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},required:!0}}},i=r=>{const e=r.state==="disabled"?"disabled":"";return`
        <style>
            body {
    ...
    `},a=i.bind({});a.args={state:"default"};var o,t,s;a.parameters={...a.parameters,docs:{...(o=a.parameters)==null?void 0:o.docs,source:{originalSource:`(args: ToujouRadioStoryProps) => {
  ...
  return \`
    ...
    \`;
}`,...(s=(t=a.parameters)==null?void 0:t.docs)==null?void 0:s.source}}};const l=["RadioInputs"];export{a as RadioInputs,l as __namedExportsOrder,d as default};
