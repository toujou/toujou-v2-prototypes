import{M as u}from"./form.docs-BZgwSxYd.js";import"./jsx-runtime-BjG_zV1W.js";import"./index-VaNW-EbP.js";import"./iframe-CbV_kBPj.js";import"./preload-helper-C1FmrZbK.js";const m={title:"COMPONENTS/Forms",parameters:{docs:{page:u}},argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},required:!0}}},o=e=>{const r=e.state==="disabled"?"disabled":"";return`
        <style>
            body {
    ...
    `},s=o.bind({});s.args={state:"default"};var t,i,a;s.parameters={...s.parameters,docs:{...(t=s.parameters)==null?void 0:t.docs,source:{originalSource:`(args: ToujouTextInputsStoryProps) => {
  ...
  return \`
    ...
    \`;
}`,...(a=(i=s.parameters)==null?void 0:i.docs)==null?void 0:a.source}}};const g=["TextInputs"];export{s as TextInputs,g as __namedExportsOrder,m as default};
