const u={title:"COMPONENTS/Text Elements",argTypes:{imageAspectRatio:{table:{category:"Image settings",defaultValue:{summary:"4-3"}},name:"Image aspect ratio",description:"Set the image aspect ratio",options:["auto","square","4-3","16-9","golden"],control:{type:"radio"},required:!0}}},n=i=>`
        <main>
    ...
    `,o=n.bind({});o.args={imageAspectRatio:"4-3"};var t,e,a;o.parameters={...o.parameters,docs:{...(t=o.parameters)==null?void 0:t.docs,source:{originalSource:`(args: TextBlockMediaAboveStoryProps) => {
  return \`
        <main>
            <toujou-text-block class="text-block" text-block-column-count="2" text-block-media-position="above">
                <toujou-text-block-column class="text-block-column">
    ...
    \`;
}`,...(a=(e=o.parameters)==null?void 0:e.docs)==null?void 0:a.source}}};const c=["TextBlockMediaAbove"];export{o as TextBlockMediaAbove,c as __namedExportsOrder,u as default};
