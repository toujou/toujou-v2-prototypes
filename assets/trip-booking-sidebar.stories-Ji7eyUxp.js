const l={title:"COMPONENTS/Tourism/Booking Sidebar"},e=()=>`
    ...
    `,o=c.bind({});var s,a,n;o.parameters={...o.parameters,docs:{...(s=o.parameters)==null?void 0:s.docs,source:{originalSource:`() => {
  return \`
        <main>
            <toujou-grid class="grid booking-form-grid" number-of-columns="2" grid-type="default" column-layout="third-right">
                <toujou-grid-column class="grid-column">
    ...
    \`;
}`,...(n=(a=o.parameters)==null?void 0:a.docs)==null?void 0:n.source}}};const m=["BookingSidebar"];export{o as BookingSidebar,m as __namedExportsOrder,l as default};
