import{T as r}from"./badgeCustomConfig-DUXiHpL4.js";import{M as i}from"./form.docs-DkrseQBQ.js";import"./jsx-runtime-BjG_zV1W.js";import"./index-BcJeOPUZ.js";import"./index-B6tQ6Rz7.js";import"./_commonjsHelpers-Cpj98o6Y.js";const m={title:"COMPONENTS/Forms",parameters:{badges:[r.DONE],docs:{page:i}},argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},defaultValue:["default"],required:!0}}},u=o=>{const s=o.state==="disabled"?"disabled":"";return`
        <style>
            body {
    ...
    `},t=u.bind({});t.args={state:"default"};var a,e,n;t.parameters={...t.parameters,docs:{...(a=t.parameters)==null?void 0:a.docs,source:{originalSource:`(args: ToujouTextInputsStoryProps) => {
  ...
  return \`
    ...
    \`;
}`,...(n=(e=t.parameters)==null?void 0:e.docs)==null?void 0:n.source}}};const b=["PasswordInput"];export{t as PasswordInput,b as __namedExportsOrder,m as default};
