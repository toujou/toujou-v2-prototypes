import{r}from"./destinationOneIntroSection-dMoNR17U.js";import{r as c}from"./breadcrumb-example-DMkkXFpu.js";const s=(a,i="")=>`
        <toujou-rating-stars
            class="rating-stars"
            rating-value="${a}"
            rating-total="5"
        ...
        ></toujou-rating-stars>
    `,f={title:"PAGES/DestinationOne",parameters:{layout:"fullwidth"},argTypes:{mapAspectRatio:{table:{category:"D1I Tour Page Settings",defaultValue:{summary:"default"}},name:"Map Aspect Ratio",description:"Set the map's aspect ratio",options:["default","3-1"],control:{type:"radio"},required:!0}}},l=()=>`
    ...
    `,d=a=>`
        <main id="main" skippy-links-label="Main content">
            ${c()}
            <div class="fragment" fragment-type="d1i-tour" map-aspect-ratio="${a.mapAspectRatio}">
                ${r("TOUR")}
                ${l()}
                ${m()}
            </div>
    ...
    `,p=a=>`
       ${d(a)}
    `,e=p.bind({});e.args={mapAspectRatio:"3-1"};var o,n,t;e.parameters={...e.parameters,docs:{...(o=e.parameters)==null?void 0:o.docs,source:{originalSource:`(args: DestinationOneTourProps) => {
  return \`
       \${renderMain(args)}
    \`;
}`,...(t=(n=e.parameters)==null?void 0:n.docs)==null?void 0:t.source}}};const h=["DestinationOneTour"];export{e as DestinationOneTour,h as __namedExportsOrder,f as default};
