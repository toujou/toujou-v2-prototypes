import{T as l}from"./badgeCustomConfig-e7a687d5.js";import{j as e}from"./jsx-runtime-6a2ad889.js";import{u as c}from"./index-1b6e96e1.js";import"./index-56d4de0b.js";import"./_commonjsHelpers-042e6b4d.js";function s(o){const t={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...c(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"mapbox",children:"Mapbox"}),`
...
`,e.jsxs(t.p,{children:["More info about mapbox's access token ",e.jsx(t.a,{href:"https://docs.mapbox.com/help/glossary/access-token/",rel:"nofollow",children:"here"})]})]})}function d(o={}){const{wrapper:t}={...c(),...o.components};return t?e.jsx(t,{...o,children:e.jsx(s,{...o})}):s(o)}const b={title:"COMPONENTS/Mapbox",parameters:{badges:[l.DONE],docs:{page:d}},argTypes:{zoomLevel:{table:{category:"Maxbox settings",defaultValue:{summary:"14"}},name:"Zoom level",description:"Choose the map's initial zoom level",control:{type:"range",min:0,max:22,step:1},defaultValue:["14"],required:!0},style:{table:{category:"Maxbox settings",defaultValue:{summary:"light-v10"}},name:"Map style",description:"Choose the map's style",control:{type:"radio"},options:["light-v10","dark-v10","streets-v11","outdoors-v11","satellite-v9","navigation-day-v1"],defaultValue:["light-v10"],required:!0},showMarker:{table:{category:"Maxbox settings",defaultValue:{summary:!0}},name:"Show marker",description:"Toggle marker's visibility",control:{type:"boolean"},defaultValue:[!0],required:!0}},tags:["autodocs"]},m=o=>`
    ...
    `,a=m.bind({});a.args={zoomLevel:14,style:"light-v10",showMarker:!0};var r,n,i;a.parameters={...a.parameters,docs:{...(r=a.parameters)==null?void 0:r.docs,source:{originalSource:`(args: mapboxStoryProps) => {
  return \`
        <toujou-map class="map"
            center="[11.0762549, 49.4579779]"
            zoom="\${args.zoomLevel}"
    ...
    \`;
}`,...(i=(n=a.parameters)==null?void 0:n.docs)==null?void 0:i.source}}};const g=["Mapbox"];export{a as Mapbox,g as __namedExportsOrder,b as default};
