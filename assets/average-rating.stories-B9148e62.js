...
`})})]})}function p(e={}){const{wrapper:t}={...l(),...e.components};return t?a.jsx(t,{...e,children:a.jsx(s,{...e})}):s(e)}const x={title:"COMPONENTS/Average Rating",parameters:{badges:[c.DONE],docs:{page:p}},argTypes:{showMaxRating:{table:{category:"Average rating settings",defaultValue:{summary:"false"}},name:"Show rating max value",description:"Show the maximum possible value for the ratings",control:{type:"boolean"},defaultValue:["false"],required:!0}}},r=(e,t)=>`
