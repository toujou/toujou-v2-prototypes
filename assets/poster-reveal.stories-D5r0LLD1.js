let u=null,g=0;const l=new WeakMap,E=["autoplay","encrypted-media","picture-in-picture"],c="https://www.youtube.com/iframe_api",w="toujou-poster-reveal-activate",y="toujou-poster-reveal-video-play-requested",b="toujou-poster-reveal-video-playing",f="toujou-poster-reveal-video-error",_=["youtube.com","youtube-nocookie.com","youtu.be"],T=["vimeo.com"],h=5e3;function R(){return u||(u=new Promise((e,o)=>{if(typeof YT<"u"&&YT.Player){e();return}const t=window.onYouTubeIframeAPIReady;if(window.onYouTubeIframeAPIReady=()=>{t==null||t(),e()},!document.querySelector(`script[src="${c}"]`)){const n=document.createElement("script");n.src=c,n.onerror=()=>{o(new Error("Failed to load YouTube IFrame API."))},document.head.appendChild(n)}}),u)}function P(e){const o=l.get(e);if(o)return o;const t=R().then(()=>new Promise(n=>{e.id||(e.id=`youtube-player-${++g}`),new YT.Player(e.id,{events:{onReady:i=>n(i.target)}})}));return l.set(e,t),t}function A(e){const o=new Set(e.allow.split(";").map(n=>n.trim()).filter(Boolean));let t=!1;for(const n of E)o.has(n)||(o.add(n),t=!0);return t&&(e.allow=Array.from(o).join("; ")),t}function S(e){return new Promise((o,t)=>{let n;const i=()=>{window.clearTimeout(n),e.removeEventListener("load",i),o()};n=window.setTimeout(()=>{e.removeEventListener("load",i),t(new Error("Timed out while reloading iframe."))},h),e.addEventListener("load",i);try{const s=new URL(e.src,window.location.href);s.searchParams.set("_r",Date.now().toString()),e.src=s.toString()}catch(s){window.clearTimeout(n),e.removeEventListener("load",i),t(s)}})}async function V(e,o){try{a(e,y,{provider:"youtube"}),A(o)&&(await S(o),l.delete(o));const t=await P(o);I(t),a(e,b,{provider:"youtube"})}catch(t){a(e,f,{provider:"youtube",error:t}),console.warn("Could not start YouTube video playback.",{src:o.src,error:t})}}function I(e){e.mute(),e.setVolume(30),e.playVideo(),e.unMute()}function q(e,o){var t;a(e,y,{provider:"vimeo"}),(t=o.contentWindow)==null||t.postMessage({method:"play"},"*"),a(e,b,{provider:"vimeo"})}function L(e){try{const{hostname:o}=new URL(e.src,window.location.href);if(_.some(t=>o===t||o.endsWith(`.${t}`)))return"youtube";if(T.some(t=>o===t||o.endsWith(`.${t}`)))return"vimeo"}catch{}return null}function O(e,o){o.forEach(t=>{switch(L(t)){case"youtube":V(e,t);break;case"vimeo":q(e,t);break}})}function a(e,o,t){e.dispatchEvent(new CustomEvent(o,{bubbles:!0,detail:t}))}function j(){window.addEventListener(w,e=>{const o=e.target;if(!o)return;const t=o.querySelectorAll("iframe");O(o,t)})}j();const k={title:"COMPONENTS/Poster Reveal",argTypes:{contentType:{table:{category:"Poster Reveal settings",defaultValue:{summary:"youtube"}},name:"Content type",description:"Define the content type",options:["youtube","vimeo","text"],control:{type:"radio"},required:!0}}};function Y(){return`
        <button
