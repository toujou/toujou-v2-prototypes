import{M as u}from"./form.docs-Brj9MRK6.js";import"./jsx-runtime-BjG_zV1W.js";import"./index-80Dqk9oN.js";import"./iframe-CrgwuxQM.js";import"./preload-helper-C1FmrZbK.js";const m={title:"COMPONENTS/Forms",parameters:{docs:{page:u}},argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},required:!0}}},o=e=>{const r=e.state==="disabled"?"disabled":"";return`
        <style>
            body {
