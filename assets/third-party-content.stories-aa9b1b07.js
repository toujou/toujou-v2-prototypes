...
An example if the `,e.jsx(t.code,{children:"iframe position"})," property for video, maps and for html elements."]})]})}function u(n={}){const{wrapper:t}=Object.assign({},r(),n.components);return t?e.jsx(t,Object.assign({},n,{children:e.jsx(s,n)})):s(n)}const y={title:"COMPONENTS/Third Party Content",parameters:{badges:[l.DONE],docs:{page:u}},tags:["autodocs"]};window.addEventListener("click",n=>{n.target.getAttribute("id")==="clearConsentsButton"&&(localStorage.removeItem("consentsState"),document.location.reload())});const p=()=>`
...
//# sourceMappingURL=third-party-content.stories-aa9b1b07.js.map
