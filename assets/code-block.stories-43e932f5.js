...
`,e.jsx(s.code,{children:"tt_content.codeblock.20.settings.pathToCssFile"})]})]})}function i(a={}){const{wrapper:s}=Object.assign({},r(),a.components);return s?e.jsx(s,Object.assign({},a,{children:e.jsx(o,a)})):o(a)}const k={title:"COMPONENTS/Code Block",parameters:{badges:[d.DONE],docs:{page:i}},argTypes:{showLanguageTag:{table:{category:"Code block Settings",defaultValue:{summary:"true"}},name:"Show the language tag",description:"Show or hide the language tag",control:{type:"boolean"},defaultValue:["true"],required:!0}}},h=a=>`
...
<span class="hljs-keyword">function</span> <span class="hljs-title">add</span>(<span class="hljs-params">a, b</span>) </span>{
    ...
    `,n=h.bind({});var t,c,l;n.parameters={...n.parameters,docs:{...(t=n.parameters)==null?void 0:t.docs,source:{originalSource:`(args: CodeBlockStoryProps) => {
  return \`
        <toujou-code-block class="code-block">
            <pre class="code-block__pre"><code class="code-block__code hljs javascript"><span class="hljs-keyword">const</span> test = <span class="hljs-string">"This is a variable"</span>;<span class="hljs-function">
...
<span class="hljs-keyword">function</span> <span class="hljs-title">add</span>(<span class="hljs-params">a, b</span>) </span>{
    ...
    \`;
}`,...(l=(c=n.parameters)==null?void 0:c.docs)==null?void 0:l.source}}};const m=["CodeBlock"];export{n as CodeBlock,m as __namedExportsOrder,k as default};
//# sourceMappingURL=code-block.stories-43e932f5.js.map
