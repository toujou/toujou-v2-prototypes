...
cookie/index.js:
   ...
   * MIT Licensed
   *)
*/function tt(o){const e=et.parse(o),t={};for(const n in e)typeof e[n]<"u"&&(t[n]=e[n]);return t}function we(){return tt(document.cookie)}function To(o){if(typeof document>"u"||typeof location>"u")return{};switch(o.credentials){case"same-origin":{const e=new URL(o.url);return location.origin===e.origin?we():{}}case"include":return we();default:return{}}}function So(o){const e=o.headers.get("cookie"),t=e?tt(e):{},n=To(o);for(const a in n)o.headers.append("cookie",et.serialize(a,n[a]));const r=zt.getCookiesSync(o.url),i=Object.fromEntries(r.map(a=>[a.key,a.value]));for(const a of r)o.headers.append("cookie",a.toString());return{...n,...i,...t}}var F=(o=>(o.HEAD="HEAD",o.GET="GET",o.POST="POST",o.PUT="PUT",o.PATCH="PATCH",o.OPTIONS="OPTIONS",o.DELETE="DELETE",o))(F||{});class Oo extends Dt{constructor(e,t,n,r){super({info:{header:`${e} ${t}`,path:t,method:e},resolver:n,options:r}),this.checkRedundantQueryParameters()}checkRedundantQueryParameters(){const{method:e,path:t}=this.info;if(t instanceof RegExp||Ye(t)===t)return;fo(t).forEach((i,a)=>{}),ue.warn(`Found a redundant usage of query parameters in the request handler URL for "${e} ${t}". Please match against a path instead and access query parameters using "new URL(request.url).searchParams" instead. Learn more: https://mswjs.io/docs/http/intercepting-requests#querysearch-parameters`)}async parse(e){var i;const t=new URL(e.request.url),n=bo(t,this.info.path,(i=e.resolutionContext)==null?void 0:i.baseUrl),r=So(e.request);return{match:n,cookies:r}}predicate(e){const t=this.matchMethod(e.request.method),n=e.parsedResult.match.matches;return t&&n}matchMethod(e){return this.info.method instanceof RegExp?this.info.method.test(e):Yt(this.info.method,e)}extendResolverArgs(e){var t;return{params:((t=e.parsedResult.match)==null?void 0:t.params)||{},cookies:e.parsedResult.cookies}}async log(e){const t=Nt(e.request.url),n=await Qt(e.request),r=await to(e.response),i=Xt(r.status);console.groupCollapsed(ue.formatMessage(`${Bt()} ${e.request.method} ${t} (%c${r.status} ${r.statusText}%c)`),`color:${i}`,"color:inherit"),console.log("Request",n),console.log("Handler:",this),console.log("Response",r),console.groupEnd()}}function A(o){return(e,t,n={})=>new Oo(o,e,t,n)}const je={all:A(/.+/),head:A(F.HEAD),get:A(F.GET),post:A(F.POST),put:A(F.PUT),delete:A(F.DELETE),patch:A(F.PATCH),options:A(F.OPTIONS)},Mo=Symbol("bodyType");var Ue,He;class M extends(He=pe,Ue=Mo,He){constructor(t,n){const r=B(n);super(t,r);ve(this,Ue,null);$t(this,r)}static error(){return super.error()}static text(t,n){const r=B(n);return r.headers.has("Content-Type")||r.headers.set("Content-Type","text/plain"),r.headers.has("Content-Length")||r.headers.set("Content-Length",t?new Blob([t]).size.toString():"0"),new M(t,r)}static json(t,n){const r=B(n);r.headers.has("Content-Type")||r.headers.set("Content-Type","application/json");const i=JSON.stringify(t);return r.headers.has("Content-Length")||r.headers.set("Content-Length",i?new Blob([i]).size.toString():"0"),new M(i,r)}static xml(t,n){const r=B(n);return r.headers.has("Content-Type")||r.headers.set("Content-Type","text/xml"),new M(t,r)}static html(t,n){const r=B(n);return r.headers.has("Content-Type")||r.headers.set("Content-Type","text/html"),new M(t,r)}static arrayBuffer(t,n){const r=B(n);return r.headers.has("Content-Type")||r.headers.set("Content-Type","application/octet-stream"),t&&!r.headers.has("Content-Length")&&r.headers.set("Content-Length",t.byteLength.toString()),new M(t,r)}static formData(t,n){return new M(t,B(n))}}Kt();function xe(o){const e={code:"code",h1:"h1",h2:"h2",pre:"pre",...Ze(),...o.components};return z.jsxs(z.Fragment,{children:[z.jsx(e.h1,{id:"location-finder",children:"Location finder"}),`
