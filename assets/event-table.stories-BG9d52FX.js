...
`})})]})}function p(t={}){const{wrapper:a}={...r(),...t.components};return a?e.jsx(a,{...t,children:e.jsx(l,{...t})}):l(t)}const b={title:"COMPONENTS/EventTable",parameters:{badges:[d.DONE],docs:{page:p}}},c=()=>`
