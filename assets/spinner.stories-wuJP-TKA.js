...
`})})]})}function d(r={}){const{wrapper:n}={...p(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(s,{...r})}):s(r)}const x={title:"COMPONENTS/Spinner",parameters:{badges:[c.DONE],docs:{page:d}},argTypes:{isCenteredOnPage:{table:{category:"Spinner settings"},name:"Center on page",description:"Center the spinner on the page, on top of all content",control:{type:"boolean"},required:!0}}},l=r=>`<toujou-spinner class="spinner" ${r.isCenteredOnPage?"centered-on-page":""}></toujou-spinner>`,t=l.bind({});t.args={isCenteredOnPage:!1};var o,i,a;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`(args: SpinnerStoryProps) => {
  return \`<toujou-spinner class="spinner" \${args.isCenteredOnPage ? 'centered-on-page' : ''}></toujou-spinner>\`;
}`,...(a=(i=t.parameters)==null?void 0:i.docs)==null?void 0:a.source}}};const f=["Spinner"];export{t as Spinner,f as __namedExportsOrder,x as default};
