const u={title:"COMPONENTS/Text Elements",argTypes:{imageAspectRatio:{table:{category:"Image settings",defaultValue:{summary:"4-3"}},name:"Image aspect ratio",description:"Set the image aspect ratio",options:["auto","square","4-3","16-9","golden"],control:{type:"radio"},required:!0}}},n=i=>`
    ...
    `,t=n.bind({});t.args={imageAspectRatio:"golden"};var o,e,a;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`(args: TextBlocksMediaStoryProps) => {
  return \`
        <main>
            <toujou-text-block class="text-block" text-block-media-position="beside-left">
                <toujou-text-block-column class="text-block-column">
    ...
    \`;
}`,...(a=(e=t.parameters)==null?void 0:e.docs)==null?void 0:a.source}}};const l=["TextBlockMedia"];export{t as TextBlockMedia,l as __namedExportsOrder,u as default};
