...
`})})]})}function u(t={}){const{wrapper:n}=Object.assign({},d(),t.components);return n?e.jsx(n,Object.assign({},t,{children:e.jsx(s,t)})):s(t)}const j={title:"COMPONENTS/Accordion",parameters:{badges:[a.DONE],docs:{page:u}},argTypes:{elementDesign:{table:{category:"Details Settings",defaultValue:{summary:"default"}},name:"Accordion element design",description:"Set the element design for the accordion element",options:["default","primary","secondary","inverted"],control:{type:"radio"},defaultValue:["default"],required:!0}}},c=t=>`
...
//# sourceMappingURL=details.stories-e8f9e6f5.js.map
