import{T as u}from"./badgeCustomConfig-e7a687d5.js";import{M as o}from"./form.docs-97b78f8d.js";import"./jsx-runtime-ac05983f.js";import"./index-e0ddb630.js";import"./_commonjsHelpers-87174ba5.js";import"./index-a9a8c754.js";const f={title:"COMPONENTS/Forms",parameters:{badges:[u.DONE],docs:{page:o}},argTypes:{state:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Input state",description:"Set the visible input state",options:["default","disabled","success","error"],control:{type:"radio"},defaultValue:["default"],required:!0}}},p=e=>{const r=e.state==="disabled"?"disabled":"";return`
        <style>
            body {
...
//# sourceMappingURL=01.text-inputs.stories-74a008d6.js.map
