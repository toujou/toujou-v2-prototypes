const n={title:"COMPONENTS/Forms"},s=()=>`
        <style>
            body {
        ...
        <br>
    `,t=s.bind({});var e,r,p;t.parameters={...t.parameters,docs:{...(e=t.parameters)==null?void 0:e.docs,source:{originalSource:`() => {
  return \`
        <style>
            body {
                background-color: var(--color-bg);
        ...
        <br>
    \`;
}`,...(p=(r=t.parameters)==null?void 0:r.docs)==null?void 0:p.source}}};const i=["FormGrid"];export{t as FormGrid,i as __namedExportsOrder,n as default};
