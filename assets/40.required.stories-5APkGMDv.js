const a={title:"COMPONENTS/Forms",argTypes:{isRequired:{table:{category:"Inputs settings",defaultValue:{summary:"default"}},name:"Required",description:"Toggle the inputs 'required' attribute",control:{type:"boolean"},required:!0}}},o=r=>`
        <style>
            body {
    ...
    `,e=o.bind({});e.args={isRequired:!1};var t,s,i;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`(args: ToujouRequireInputStoryProps) => {
  return \`
        <style>
            body {
                background-color: var(--color-bg);
    ...
    \`;
}`,...(i=(s=e.parameters)==null?void 0:s.docs)==null?void 0:i.source}}};const p=["Required"];export{e as Required,p as __namedExportsOrder,a as default};
