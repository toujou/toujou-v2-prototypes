...
`})})]})}function l(e={}){const{wrapper:t}={...m(),...e.components};return t?n.jsx(t,{...e,children:n.jsx(a,{...e})}):a(e)}const y={title:"COMPONENTS/Counter",parameters:{badges:[c.DONE],docs:{page:l}},argTypes:{numberOfItems:{table:{category:"Counter Settings"},name:"number of Items",description:"Set the number of counter items visible on the story",options:[1,2,3,4],control:{type:"radio"},required:!0},elementDesign:{table:{category:"Counter Settings",defaultValue:{summary:"primary"}},name:"Element design",description:"Set the counter's element design",options:["default","primary","secondary","inverted"],control:{type:"radio"},required:!0},animationDuration:{table:{category:"Counter Settings",defaultValue:{summary:"primary"}},name:"Animation duration",description:"Set the counter's number animation duration",options:["slow","medium","fast"],control:{type:"radio"},required:!0},startValue:{table:{category:"Counter Settings"},name:"animation start value",description:"Set the counter's animation start value",control:{type:"number"},required:!0},endValue:{table:{category:"Counter Settings"},name:"animation end value",description:"Set the counter's animation end value",control:{type:"number"},required:!0},showPrefix:{table:{category:"Counter Settings"},name:"Show prefix",description:"Show the value prefix",control:{type:"boolean"},required:!0},showSuffix:{table:{category:"Counter Settings"},name:"Show suffix",description:"Show the value suffix",control:{type:"boolean"},required:!0}}},d=e=>{let t="";for(let o=0;o<e.numberOfItems;o++)t+=`
    ...
    `,r=p.bind({});r.args={numberOfItems:1,elementDesign:"default",animationDuration:"medium",startValue:1,endValue:123,showPrefix:!1,showSuffix:!0};var u,i,s;r.parameters={...r.parameters,docs:{...(u=r.parameters)==null?void 0:u.docs,source:{originalSource:`(args: counterStoryProps) => {
  return \`
        <main>
    ...
    \`;
}`,...(s=(i=r.parameters)==null?void 0:i.docs)==null?void 0:s.source}}};const S=["Counter"];export{r as Counter,S as __namedExportsOrder,y as default};
