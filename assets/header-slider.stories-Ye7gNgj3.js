...
`,e.jsxs(i.p,{children:["The ",e.jsx(i.code,{children:"header-type"})," must be set to ",e.jsx(i.code,{children:'header-type="slider"'})," so the different element inside the slider have the correct styles"]})]})}function d(t={}){const{wrapper:i}={...a(),...t.components};return i?e.jsx(i,{...t,children:e.jsx(n,{...t})}):n(t)}const _={title:"COMPONENTS/Header",parameters:{docs:{page:d},layout:"fullscreen"},argTypes:{imageHeight:{table:{category:"Header Settings",defaultValue:{summary:"default"}},name:"Header image height",description:"Set the header image height",options:["default","full","half","quarter","3-1"],control:{type:"select"},required:!0},headerVerticalPos:{table:{category:"Header Settings",defaultValue:{summary:"default"}},name:"Header vertical position",description:"Set the header's vertical position",options:["top","mid","bottom"],control:{type:"select"},required:!0},headerHorizontalPos:{table:{category:"Header Settings",defaultValue:{summary:"default"}},name:"Header horizontal position",description:"Set the header's horizontal position",options:["left","center","right"],control:{type:"select"},required:!0},headerContentSize:{table:{category:"Header Settings",defaultValue:{summary:"default"}},name:"Header content size",description:"Set the header's content width",options:["full","half","third","quarter"],control:{type:"select"},required:!0},accentColor:{table:{category:"Header Settings",defaultValue:{summary:"default"}},name:"Accent color",description:"Set the header's accent color",options:["default","primary","secondary","font"],control:{type:"select"},required:!0},contentAlignment:{table:{category:"Header Settings",defaultValue:{summary:"default"}},name:"Content alignment",description:"Set the header's content alignment",options:["default","left","center","right"],control:{type:"select"},required:!0}},tags:["autodocs"]},c=t=>`
    ...
    `,s=c.bind({});s.args={imageHeight:"default",headerVerticalPos:"mid",headerHorizontalPos:"center",headerContentSize:"half",accentColor:"default",contentAlignment:"default"};var o,l,r;s.parameters={...s.parameters,docs:{...(o=s.parameters)==null?void 0:o.docs,source:{originalSource:`(args: HeaderSliderStoryProps) => {
  return \`
    ...
    \`;
}`,...(r=(l=s.parameters)==null?void 0:l.docs)==null?void 0:r.source}}};const g=["HeaderSlider"];export{s as HeaderSlider,g as __namedExportsOrder,_ as default};
