const a={title:"TOKENS/Spacing",argTypes:{}},n=()=>`
    ...
    `,s=n.bind({});var i,e,d;s.parameters={...s.parameters,docs:{...(i=s.parameters)==null?void 0:i.docs,source:{originalSource:`() => {
  return \`
        <h1 class="tokens-demo__title">Spacing tokens</h1>
    ...
    \`;
}`,...(d=(e=s.parameters)==null?void 0:e.docs)==null?void 0:d.source}}};const o=["Spacing"];export{s as Spacing,o as __namedExportsOrder,a as default};
