...
5. [ Inputs examples ](#toujou-input-examples)
    ...
    11. [ submit button ](#toujou-input-example-submit)

## Markup example
```html
<form class="form" id="testform">
    <toujou-input-group class="input-group" input-group-type="text">
...
|--------------------|-----------------------------------------------------------------------------|:--------:|
| `class`            | It must have at least the `input-group` class                               |   yes    |
...
Following attributes were replaced by class names (`input-group`) with modifier due to the due to the need to support pristine

| Modifier           | What is it?                                                                 | Required |
|--------------------|-----------------------------------------------------------------------------|:--------:|
| `has-success`      | Added to the group when validation passes                                   |    no    |
| `has-error`        | Added to the group when validation fails                                    |    no    |


The `input-group` also accepts attributes to be placed inside the `row` element. Each of these attributes takes a value between 1 and 12, for the number of columns it should span inside the row.
...
## 3. &lt;toujou-form-row&gt;
This element can render child `input-group` as a grid. The grid has 12 columns.
...
<fieldset id="testform-1000091-fieldset-1" class="fieldset"}>
    ...
    <toujou-input-group class="input-group">...</toujou-input-group>
    <toujou-input-group class="input-group">...</toujou-input-group>
</fieldset>
```
...
<a name="toujou-input-example-submit"></a>
...
<toujou-input-group class="input-group" input-group-type="submit">
    <button
        ...
        type="submit"
        name="tx_form_formframework[selectWithChips-1000064][__currentPage]"
        value="Submit">
        Submit
    </button>
</toujou-input-group>
