# &lt;toujou-.logo-slider&gt;
The `<toujou-logo-slider>` renders a slider on the page, using the [Glider.js](https://nickpiscitelli.github.io/Glider.js/) library.
...
## Markup example
```html
<toujou-slider class="slider" slider-design="${args.designColor}" ${args.isFullwidth ? 'slider-fullwidth' : ''}>
    ...
    <toujou-bullets class="bullets slider__bullets glider-dots" bullets-design="${args.designColor}">
...
### Slider design <toujou-chip class="chip" chip-bg-color="warning">required</toujou-chip>
