...
export default {
    ...
    argTypes: {
        searchCardPosition: {
            table: {
                category: "Search Card Settings",
            },
            name: 'Search card position',
            description: "Set the header's search card position",
            options: ['left', 'right'],
            control: { type: 'select' },
            required: true,
        },
...
export const HeaderWithSearchcard = Template.bind({});

// @ts-ignore
HeaderWithSearchcard.args = {
    searchCardPosition: 'left',
    isTitleOnly: true,
    imageHeight: 'default',
