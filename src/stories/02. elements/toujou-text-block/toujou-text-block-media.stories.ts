...
interface ToujouTextBlocksMediaProps {
    imageAspectRatio: string;
}

const Template: Story<ToujouTextBlocksMediaProps> = (args: ToujouTextBlocksMediaProps) => {
    return `       
        <toujou-text-block class="toujou-text-block" text-block-media-position="beside-left">
        ...
        <toujou-text-block class="toujou-text-block" text-block-media-position="beside-right">
            <toujou-text-block-column class="toujou-text-block-column">
                <figure class="toujou-text-block__figure">
                    <img src="https://picsum.photos/1200/1200" alt="beautiful image" class="toujou-text-block__image toujou-text-block__image--${args.imageAspectRatio}">
                </figure>
        ...
        <toujou-text-block class="toujou-text-block" text-block-media-position="inside-left">
            <toujou-text-block-column class="toujou-text-block-column">
                <figure class="toujou-text-block__figure">
                    <img src="https://picsum.photos/1200/1200" alt="beautiful image" class="toujou-text-block__image toujou-text-block__image--${args.imageAspectRatio}">
                </figure>
        ...
        <toujou-text-block class="toujou-text-block" text-block-media-position="inside-right">
            <toujou-text-block-column class="toujou-text-block-column">
                <figure class="toujou-text-block__figure">
                    <img src="https://picsum.photos/1200/1200" alt="beautiful image" class="toujou-text-block__image toujou-text-block__image--${args.imageAspectRatio}">
                </figure>
