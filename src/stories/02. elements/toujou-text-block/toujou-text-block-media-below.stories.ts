...
interface ToujouTextBlockMediaBelowProps {
    imageAspectRatio: string;
}

const Template: Story<ToujouTextBlockMediaBelowProps> = (args: ToujouTextBlockMediaBelowProps) => {
    return `       
        <toujou-text-block class="toujou-text-block" text-block-column-count="2" text-block-media-position="below">
        ...
        <toujou-text-block class="toujou-text-block" text-block-column-count="2" text-block-third-direction="left" " text-block-media-position="below">
            <toujou-text-block-column class="toujou-text-block-column">
                <figure class="toujou-text-block__figure">
                    <img src="https://picsum.photos/1200/1200" alt="beautiful image" class="toujou-text-block__image toujou-text-block__image--${args.imageAspectRatio}">
                </figure>
        ...
        <toujou-text-block class="toujou-text-block" text-block-column-count="2" text-block-third-direction="right" text-block-media-position="below">
            <toujou-text-block-column class="toujou-text-block-column">
                <figure class="toujou-text-block__figure">
                    <img src="https://picsum.photos/1200/1200" alt="beautiful image" class="toujou-text-block__image toujou-text-block__image--${args.imageAspectRatio}">
                </figure>
        ...
        <toujou-text-block class="toujou-text-block" text-block-column-count="3" text-block-media-position="below">
            <toujou-text-block-column class="toujou-text-block-column">
                <figure class="toujou-text-block__figure">
                    <img src="https://picsum.photos/1200/1200" alt="beautiful image" class="toujou-text-block__image toujou-text-block__image--${args.imageAspectRatio}">
                </figure>
        ...
        <toujou-text-block class="toujou-text-block" text-block-column-count="4" text-block-media-position="below">
            <toujou-text-block-column class="toujou-text-block-column">
                <figure class="toujou-text-block__figure">
                    <img src="https://picsum.photos/1200/1200" alt="beautiful image" class="toujou-text-block__image toujou-text-block__image--${args.imageAspectRatio}">
                </figure>
