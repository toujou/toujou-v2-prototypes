            ...
            <toujou-text-block class="text-block" text-block-column-count="1">
                <toujou-text-block-column class="text-block-column">
                    <div class="text-block__content">
                        <h1>Topbutton</h1>
                        <h5>Scroll down to see the topbutton</h5>
                        <p>A click on the top button should return focus to the first focusable elemtn on the page (in this case the "fake button" element)</p>
                        <button class="button" button-variant="primary">Fake button</button>
                        <br>
