    ...
    return `
        <div class="post-meta">
            ...
            <div class="post-meta__group" group-type="categories">
                <toujou-chip class="chip" chip-icon-position="left" chip-bg-color="primary-light" chip-border-radius="round" chip-size="extra-small" is-clickable>
            ...
            <div class="post-meta__group" group-type="comments">
                <toujou-icon class="icon" icon-name="article" icon-size="normal" icon-color="font"></toujou-icon>
                <p class="post-meta__text">6 comments</p>
            </div>
            <div class="post-meta__group" group-type="published">
                <toujou-icon class="icon" icon-name="calendar-lines" icon-size="normal" icon-color="font"></toujou-icon>
