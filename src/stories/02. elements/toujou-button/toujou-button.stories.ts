...
// @ts-ignore
import toujouButtonDocs from './toujou-button.docs.mdx';
...
const Template: Story<ToujouButtonProps> = (args: ToujouButtonProps) => {
    ...
    let buttonClasses = `toujou-button`;
    ...
    if (args.hasIcon === 'true' || args.hasIcon === true) {
        buttonEl.innerHTML = `<toujou-icon class="toujou-icon toujou-button__icon" icon-name="arrow-right"></toujou-icon> ${DEFAULT_BUTTON_TEXT}`;
