...
### 4.2. Slider fullwidth <toujou-chip class="chip" chip-bg-color="warning" is-uppercase>Defined via Typoscript</toujou-chip>
...
### 4.4. show-count <toujou-chip class="chip" chip-bg-color="warning" is-uppercase>Defined via Typoscript</toujou-chip>
...
### 4.5 slides to show <toujou-chip class="chip" chip-bg-color="warning" is-uppercase>Defined via Typoscript</toujou-chip>
...
### 4.6 slides to move <toujou-chip class="chip" chip-bg-color="warning" is-uppercase>Defined via Typoscript</toujou-chip>
...
### 4.7 slider type <toujou-chip class="chip" chip-bg-color="warning" is-uppercase>Defined via Typoscript</toujou-chip>
...
### 4.8 slider gap <toujou-chip class="chip" chip-bg-color="warning" is-uppercase>Defined via Typoscript</toujou-chip>
...
### 4.9 slider breakpoints <toujou-chip class="chip" chip-bg-color="warning" is-uppercase>Defined via Typoscript</toujou-chip>
