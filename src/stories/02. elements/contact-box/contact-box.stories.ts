    ...
    return `
        ...
        <toujou-contact-box class="contact-box">        
            <div class="contact-box__card">
                <label class="contact-box__close" for="contact-state" aria-role="button">
                    <toujou-icon class="icon" icon-size="normal" icon-name="close" icon-color="font"></toujou-icon>
                </label>
                ...
                <div class="contact-box__content" slot="content">
                    ...
                    <div class="contact-box__items">
                        <div class="contact-box__item">
                            <toujou-icon class="icon" icon-size="normal" icon-color="font" icon-name="telephone"></toujou-icon>
                            <a class="contact-box__link" href="#">0911 23980870</a>
                        </div>
                        <div class="contact-box__item">
                            <toujou-icon class="icon" icon-size="normal" icon-color="font" icon-name="email"></toujou-icon>
                            <a class="contact-box__link" href="#">info@dfau.de</a>
                        </div>
                        <div class="contact-box__item">
                            <toujou-icon class="icon" icon-size="normal" icon-color="font" icon-name="calendar-day"></toujou-icon>
