...
const Template: StoryFn<SelectedPagesAsCardCollectionShowMoreProps> = (args: SelectedPagesAsCardCollectionShowMoreProps) => {
    return `
        <main>
...
export const SelectedPagesAsCardCollectionShowMore = Template.bind({});

SelectedPagesAsCardCollectionShowMore.args = {
    isLoading: false,
}
