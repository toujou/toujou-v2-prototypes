    ...
    return `
        <ul class="card-collection">
            <li class="card-collection__item">
                <toujou-card class="toujou-card" card-type="blog" card-design="${args.elementDesign}">
                    ...
                    <div class="toujou-card__bottom">
                        ...
                        <p class="toujou-card__subtitles">
                            <span class="toujou-card__subtitle">11.03.2022</span>
                            <span class="toujou-card__subtitle">Jerôme Grad</span>
                        </p>
...
export const ToujouCardBlog = Template.bind({});
