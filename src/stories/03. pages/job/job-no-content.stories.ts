...
interface jobNoContentProps {
    hideImage: Boolean;
}

const Template: StoryFn<jobNoContentProps> = (args: jobNoContentProps) => {
    return `
       <div class="fragment">
...
export const JobNoContent = Template.bind({});
