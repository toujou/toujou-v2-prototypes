...
4. [ Attributes ](#toujou-slider-attributes)
    ...
    4.12. [ Slider slides count ](#toujou-slider-attributes-slider-slides-count)
...
### 4.1. Element design <toujou-chip class="chip" chip-bg-color="warning" is-uppercase>required</toujou-chip>
The `element-design` attribute allows us to change the slider element's styles. It is set by the user on the BE with the "Color" option.

Possible values are: `default`, `primary`, `secondary` and `light-grey`

Example:
```html
<toujou-slider class="slider" aria-label="Toujou slider example" element-design="primary">
...
</toujou-slider>
```
...
### 4.2. Slider fullwidth <toujou-chip class="chip" chip-bg-color="primary" is-uppercase>Defined via Typoscript</toujou-chip>
...
Example:
```html
<toujou-slider class="slider" aria-label="Toujou slider example" element-design="primary" slider-fullwidth>
...
</toujou-slider>
```
...
Example:
```html
<toujou-slider class="slider" aria-label="Toujou slider example" element-design="primary" auto-play>
...
</toujou-slider>
```
...
### 4.4. show-count <toujou-chip class="chip" chip-bg-color="primary" is-uppercase>Defined via Typoscript</toujou-chip>
...
Example:
```html
<toujou-slider class="slider" aria-label="Toujou slider example" element-design="primary" show-count>
...
</toujou-slider>
```
...
### 4.5 slides to show <toujou-chip class="chip" chip-bg-color="primary" is-uppercase>Defined via Typoscript</toujou-chip>
We can define how many slides to show per page with the `slides-to-show` attribute. Default is `1`.

Example:
```html
<toujou-slider class="toujou-slider" element-design="primary" slides-to-show="3">
...
</toujou-slider>
```
...
### 4.6 slides to move <toujou-chip class="chip" chip-bg-color="primary" is-uppercase>Defined via Typoscript</toujou-chip>
We can define how many slides to advance on each move with the `slides-per-move` attribute. Default is `1`.

Example:
```html
<toujou-slider class="toujou-slider" element-design="primary" slides-to-show="2" slides-per-move="2">
...
</toujou-slider>
```
...
### 4.7 slider type <toujou-chip class="chip" chip-bg-color="primary" is-uppercase>Defined via Typoscript</toujou-chip>
...
Example:
```html
<toujou-slider class="toujou-slider" element-design="primary" slider-type="slide">
...
</toujou-slider>
```
...
### 4.8 slider gap <toujou-chip class="chip" chip-bg-color="primary" is-uppercase>Defined via Typoscript</toujou-chip>
Define a gap between the slides. Any valid css gap value is also valid here. Default is `0`

Example:
```html
<toujou-slider class="toujou-slider" element-design="primary" slider-gap="1rem">
...
</toujou-slider>
```
...
### 4.9 slider breakpoints <toujou-chip class="chip" chip-bg-color="primary" is-uppercase>Defined via Typoscript</toujou-chip>
...
### 4.10 slider padding <toujou-chip class="chip" chip-bg-color="primary" is-uppercase>Defined via Typoscript</toujou-chip>
...
### 4.10 slider focus center <toujou-chip class="chip" chip-bg-color="primary" is-uppercase>Defined via Typoscript</toujou-chip>
...
<a name="toujou-slider-attributes-slider-slides-count"></a>

### 4.11 slider slides-count
This attribute is optional.
The `slides-count` should reflect the number of slides inside the slider, for instance `slides-count="12"`.
