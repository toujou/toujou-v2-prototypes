# modal
| This is a copy of the documentation that we can find on the `toujou-modal` component

| ℹ️ The ModalContent page is hidden from the sidebar using css on the `.storybook/manager-head.html` file |
|---------------------------------------------------------------------------------------------------|
...
| Property | Description | Default |
|----------|-------------|---------|
|--toujou-modal---toujou-modal-container-justify-content| Set content element `justify-content` | center |
|--toujou-modal---toujou-modal-container-min-height| Set content element `min-height` | automatically set |
|--toujou-modal---toujou-modal-container-height| Set content element `height` | 100vh |
|--toujou-modal---toujou-modal-container-width| Set content element `width` | 100vw |
