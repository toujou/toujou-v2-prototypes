...
const Template: StoryFn<FooterLayoutsStoryProps> = (args: FooterLayoutsStoryProps) => {
    const columnsData = [
        { name: 'outer-left', title: 'Outer left', id: 'c3907'},
        { name: 'inner-left', title: 'Inner left', id: 'c3908' },
        { name: 'inner-right', title: 'Inner right', id: 'c3909' },
        { name: 'outer-right', title: 'Outer right', id: 'c3910' },
    ];
