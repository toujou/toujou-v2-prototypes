...
// @ts-ignore
import toujouIconDocs from './toujou-icon.docs.mdx';
...
interface ToujouIconProps { iconSize: string; iconColor: string; }

const Template: Story<ToujouIconProps> = (args: ToujouIconProps) => {
