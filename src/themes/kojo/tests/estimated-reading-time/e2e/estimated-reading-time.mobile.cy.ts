...
describe('estimated-reading-time [mobile]', () => {
    beforeEach(() => {
    ...
    it('has correct text content', () => {
        ...
        // @ts-ignore
        cy.get('.estimated-reading-time').shadow().shouldHaveTrimmedText('6 minutes');
    ...
    it('has correct styles', () => {
        ...
        cy.get('.estimated-reading-time').should('have.css', 'gap', '8px');
        ...
        cy.get('.estimated-reading-time .estimated-reading-time__label').should('have.css', 'gap', '8px');
