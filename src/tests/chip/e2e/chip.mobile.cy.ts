...
describe('toujou-chip - background-colors [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
        cy.visit('/iframe.html?viewMode=story&id=components-chip--chip');
        // @ts-ignore
...
describe('toujou-chip - border-radius [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
        cy.visit('/iframe.html?viewMode=story&id=components-chip--chip');
    });
...
describe('toujou-chip - size [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
        cy.visit('/iframe.html?viewMode=story&id=components-chip--chip');
    });
...
describe('toujou-chip - is uppercase [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
        cy.visit('/iframe.html?viewMode=story&id=components-chip--chip');
    });
