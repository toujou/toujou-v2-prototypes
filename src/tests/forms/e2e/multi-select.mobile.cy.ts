...
describe('Forms / multi-select input [mobile]', () => {
    beforeEach(() => {
...
describe('Forms / multi-select input - disabled [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
...
describe('Forms / multi-select - success [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
...
describe('Forms / multi-select - error [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
