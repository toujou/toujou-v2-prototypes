...
describe('Forms / file upload [mobile]', () => {
    beforeEach(() => {
...
describe('Forms / file upload input - disabled [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
...
describe('Forms / file upload input - success [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
...
describe('Forms / file upload input - error [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
