...
describe('Forms / single checkbox input [mobile]', () => {
    beforeEach(() => {
...
describe('Forms / checkbox input - disabled [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
...
describe('Forms / checkbox - success [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
...
describe('Forms / checkbox - error [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
