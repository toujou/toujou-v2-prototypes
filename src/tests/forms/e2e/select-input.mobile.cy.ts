...
describe('Forms / select input [mobile]', () => {
    beforeEach(() => {
...
describe('Forms / select input - disabled [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
...
describe('Forms / select input - success [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
...
describe('Forms / select input - error [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
