...
describe('Forms / input label [mobile]', () => {
    beforeEach(() => {
...
describe('Forms / input label - disabled group [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
...
describe('Forms / input label - success group [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
...
describe('Forms / input label - error group [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
