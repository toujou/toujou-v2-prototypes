...
describe('counter-grid', () => {
    ...
    it('has correct  styles', () => {
        ...
        cy.get('.counter-grid').should('have.css', 'width', '1440px');
...
describe('counter-grid - 1 item', () => {
    ...
    it('has correct  styles', () => {
        ...
        cy.get('.counter-grid').should('have.css', 'width', '1440px');
        cy.get('.counter-grid').should('have.css', 'max-width', '1440px');
        cy.get('.counter-grid .counter').should('have.css', 'width', '1440px');
    });
})
...
describe('counter-grid - 2 item', () => {
    ...
    it('has correct  styles', () => {
        ...
        cy.get('.counter-grid').should('have.css', 'width', '1440px');
        cy.get('.counter-grid').should('have.css', 'max-width', '1440px');
        cy.get('.counter-grid .counter').should('have.css', 'width', '696px');
    });
})
...
describe('counter-grid - 3 item', () => {
    ...
    it('has correct  styles', () => {
        ...
        cy.get('.counter-grid').should('have.css', 'width', '1440px');
        cy.get('.counter-grid').should('have.css', 'max-width', '1440px');
        cy.get('.counter-grid .counter').should('have.css', 'width', '447.9921875px');
    });
})
...
describe('counter-grid - 4 item', () => {
    ...
    it('has correct  styles', () => {
        ...
        cy.get('.counter-grid').should('have.css', 'width', '1440px');
        cy.get('.counter-grid').should('have.css', 'max-width', '1440px');
        cy.get('.counter-grid .counter').should('have.css', 'width', '324px');
    });
})
