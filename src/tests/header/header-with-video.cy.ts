...
describe('header', () => {
    ...
    it('Video has correct styles', () => {
        cy.get('.header').should('have.css', 'width', '1920px');
        cy.get('.header').should('have.css', 'height', '864px');
        cy.get('.header .video').should('have.css', 'width', '1920px');
        cy.get('.header .video').should('have.css', 'height', '864px');
