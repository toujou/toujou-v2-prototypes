...
describe('alert', () => {
    ...
    it('has correct content styles', () => {
        ...
        cy.get(`${cardSelector} .event-table-card__title`).should('have.css', 'font-size', '20px');
        cy.get(`${cardSelector} .event-table-card__title`).should('have.css', 'color', colors.colorFontDark);
        cy.get(`${cardSelector} .event-table-card__title`).should('have.css', 'margin', '0px 0px 4px');
        cy.get(`${cardSelector} .event-table-card__title`).should('have.css', 'font-family', tokens.type.fontFamily.text);
        cy.get(`${cardSelector} .event-table-card__title`).should('have.css', 'font-weight', '800');
        ...
        cy.get(`${cardSelector} .event-table-card__info`).should('have.css', 'gap', '8px');
    ...
    it('has correct button styles', () => {
        ...
        cy.get(`${cardSelector} .event-table-card__button`).should('have.css', 'gap', '8px');
    });
})
