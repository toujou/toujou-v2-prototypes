...
describe('content card - horizontal', () => {
    ...
    it('has correct styles', () => {
        ...
        cy.get('.content-card:first-child').should('have.css', 'align-items', 'flex-start');
        ...
        cy.get('.content-card:first-child').should('have.css', 'flex-direction', 'row');
        ...
        cy.get('.content-card:first-child').should('have.css', 'max-width', 'calc(50% - 24px)');
...
describe('content card - horizontal - primary', () => {
    beforeEach(() => {
...
describe('content card - horizontal - secondary', () => {
    beforeEach(() => {
...
describe('content card - horizontal - inverted', () => {
    beforeEach(() => {
