...
describe('content card - vertical [mobile]', () => {
    beforeEach(() => {
...
describe('content card - vertical - primary [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
...
describe('content card - vertical - secondary [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
...
describe('content card - vertical - inverted [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
