...
describe('social-media-bar [mobile]', () => {
    beforeEach(() => {
    ...
    it('has correct styles', () => {
        ...
        cy.get('.social-media-bar').should('have.css', 'margin', '0px 16px');
...
describe('social-media-bar - inline [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
...
describe('social-media-bar - primary [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
...
describe('social-media-bar - secondary [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
...
describe('social-media-bar - inverted [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
...
describe('social-media-bar - no headline [mobile]', () => {
    beforeEach(() => {
        cy.viewport('iphone-6');
