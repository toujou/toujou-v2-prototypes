...
describe('image-card-grid', () => {
    ...
    it('has correct styles', () => {
        ...
        cy.get('toujou-image-card-grid').should('have.css', 'grid-gap', `${tokens.spacing.xl} ${tokens.spacing.xl}`);
        ...
        cy.get('toujou-image-card-grid').should('have.css', 'width', '1440px');
...
describe('image-card', () => {
    ...
    it('has correct styles', () => {
        ...
        cy.get(`${imageCard}`).should('have.css', 'width', '324px');
    ...
    it('has correct image styles', () => {
        cy.get(`${imageCard} .image-card__image`).should('have.css', 'height', '200.2421875px');
        cy.get(`${imageCard} .image-card__image`).should('have.css', 'width', '324px');
    ...
    it('has correct title styles', () => {
        ...
        cy.get(`${imageCard} .image-card__title`).should('have.css', 'width', '324px');
