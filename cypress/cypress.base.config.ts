...
export const mobileViewportWidth = 375;
export const mobileViewportHeight = 667;

/**
 * Shared Cypress configuration inherited by all theme configs.
 * Theme-specific overrides (specPattern, colors, etc.) go in cypress.<theme>.config.ts
 */
export const baseConfig = {
    e2e: {
        ...
        // Prevents Cypress from rewriting app code — important for Storybook compatibility
        modifyObstructiveCode: false,
    },
    env: {
        // Color values must match the resolved CSS variable values for the active theme
        colors: {
