...
`,ro={reserveScrollBarGap:!0},Pe=[];function ao(s){Pe.forEach(e=>e.close()),Pe.push(s)}function so(s){if(s===Pe[Pe.length-1]){Pe.pop();const e=Pe.pop();e&&e.open()}}class ht extends it{static get is(){return"toujou-modal"}render(){return xe`
