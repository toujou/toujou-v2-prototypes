import{_ as t}from"./tslib.es6-Br7-PHSQ.js";import{s,y as r}from"./lit-element-DtTU7p4v.js";import{e}from"./custom-element-DPYutfhb.js";import{e as i}from"./property-D5hxO1nL.js";import"./query-assigned-elements-DqqHV3QO.js";let a=class extends s{constructor(){super(...arguments),this.rating=0,this.total=5,this.suffix=""}createRenderRoot(){return this}render(){const t=[];for(let s=0;s<this.total;s++){let e=0;this.rating>=s+1?e=100:this.rating>s&&(e=Math.round(100*(this.rating-s))),t.push(r`
