var k=Object.defineProperty;var y=(i,t,r)=>t in i?k(i,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):i[t]=r;var d=(i,t,r)=>(y(i,typeof t!="symbol"?t+"":t,r),r);import{i as x,s as z,y as M}from"./lit-element-cb538606.js";import{m as n}from"./mapbox-gl-68a469df.js";var p={},A={get exports(){return p},set exports(i){p=i}};(function(i){function t(a){if(a=Object.assign({},a),!(this instanceof t))throw new Error("MapboxLanguage needs to be called with the new keyword");this.setLanguage=this.setLanguage.bind(this),this._initialStyleUpdate=this._initialStyleUpdate.bind(this),this._defaultLanguage=a.defaultLanguage,this._isLanguageField=a.languageField||/^name_/,this._getLanguageField=a.getLanguageField||function(e){return e==="mul"?"name":`name_${e}`},this._languageSource=a.languageSource||null,this._languageTransform=a.languageTransform,this._excludedLayerIds=a.excludedLayerIds||[],this.supportedLanguages=a.supportedLanguages||["ar","de","en","es","fr","it","ja","ko","mul","pt","ru","vi","zh-Hans","zh-Hant"]}const r=/^\{name/;function s(a,o){const e=Array.isArray(o)&&o[0]==="get";return e&&r.test(o[1])&&console.warn("This plugin no longer supports the use of token syntax (e.g. {name}). Please use a get expression. See https://docs.mapbox.com/mapbox-gl-js/style-spec/expressions/ for more details."),e&&a.test(o[1])}function m(a,o,e){if(Array.isArray(o))for(let l=1;l<o.length;l++)Array.isArray(o[l])&&(s(a,o[l])&&(o[l][1]=e),m(a,o[l],e))}function u(a,o,e){if(s(a,o)&&(o[1]=e),m(a,o,e),o[0]==="get"&&o[1]==="name"){const l=o.slice();o=["coalesce",["get",e],l]}return o}function v(a,o,e,l){return o.layout&&o.layout["text-field"]&&l.indexOf(o.id)===-1?Object.assign({},o,{layout:Object.assign({},o.layout,{"text-field":u(a,o.layout["text-field"],e)})}):o}function f(a){const o=Object.keys(a.sources).filter(e=>{const l=a.sources[e].url;return l&&l.indexOf("mapbox.mapbox-streets-v8")>-1||/mapbox-streets-v[1-9][1-9]/.test(l)});if(!o.length)throw new Error('If using MapboxLanguage with a Mapbox style, the style must be based on vector tile version 8, e.g. "streets-v11"');return o[0]}t.prototype.setLanguage=function(a,o){if(this.supportedLanguages.indexOf(o)<0)throw new Error(`Language ${o} is not supported`);const e=this._languageSource||f(a);if(!e)return a;const l=this._getLanguageField(o),h=this._isLanguageField,C=this._excludedLayerIds,E=a.layers.map(c=>c.source===e?v(h,c,l,C):c),b=Object.assign({},a,{layers:E});return this._languageTransform?this._languageTransform(b,o):b},t.prototype._initialStyleUpdate=function(){const a=this._map.getStyle(),o=this._defaultLanguage||w(this.supportedLanguages);this._map.setStyle(this.setLanguage(a,o))};function w(a){const o=navigator.languages?navigator.languages[0]:navigator.language||navigator.userLanguage,e=o&&o.split("-");let l=o;return e.length>1&&(l=e[0]),a.indexOf(l)>-1?l:null}t.prototype.onAdd=function(a){return this._map=a,this._map.on("style.load",this._initialStyleUpdate),this._container=document.createElement("div"),this._container},t.prototype.onRemove=function(){this._map.off("style.load",this._initialStyleUpdate),this._map=void 0},i.exports=t})(A);const B=x`
  .mapboxgl-map {
