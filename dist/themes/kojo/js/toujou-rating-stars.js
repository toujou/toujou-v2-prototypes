import{_ as t}from"./tslib.es6-Br7-PHSQ.js";import{s as r,x as s}from"./lit-element-52TjfAhW.js";import{e}from"./custom-element-DPYutfhb.js";import{n as i}from"./property-BjK_DIN0.js";import"./query-assigned-elements-F9pHSIbK.js";let a=class extends r{constructor(){super(...arguments),this.rating=0,this.total=5,this.suffix=""}createRenderRoot(){return this}render(){const t=[];for(let r=0;r<this.total;r++){let e=0;this.rating>=r+1?e=100:this.rating>r&&(e=Math.round(100*(this.rating-r))),t.push(s`
